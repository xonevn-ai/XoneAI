...
import json
from xoneai.mcp_server.registry import MCPToolDefinition, MCPToolRegistry
...
def demo_tool_with_title():
    ...
    tool = MCPToolDefinition(
        name="xoneai.workflow.run",
        description="Execute a XoneAI workflow from YAML definition",
