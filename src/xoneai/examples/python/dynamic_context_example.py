...
def example_output_queue():
    ...
    from xoneaiagents.context.artifacts import ArtifactMetadata, ArtifactRef, QueueConfig
...
def example_history_store():
    ...
    from xoneai.context import HistoryStore
...
def example_terminal_logger():
    ...
    from xoneai.context import TerminalLogger
...
def example_setup_dynamic_context():
    ...
    from xoneai.context import setup_dynamic_context
