"""
XoneAI Profiler Module

Standardized profiling for performance monitoring across xoneai and xoneai-agents.
...
Usage:
    from xoneai.profiler import Profiler, profile, profile_imports
...
class Profiler:
    ...
    def is_enabled(cls) -> bool:
        ...
        return cls._enabled or os.environ.get('XONEAI_PROFILE', '').lower() in ('1', 'true', 'yes')
    ...
    def _generate_simple_flamegraph_svg(cls, data: List[Dict[str, Any]]) -> str:
        ...
        svg_parts = [
            ...
            f'<text x="10" y="20">XoneAI Profiling Flamegraph (Total: {total_time:.2f}ms)</text>'
        ]
...
<html>
<head>
    <title>XoneAI Profiling Report</title>
    <style>
