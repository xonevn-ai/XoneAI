"""
Configuration loader for XoneAI CLI.
...
def _get_env_overrides() -> Dict[str, Any]:
    ...
    for key, value in os.environ.items():
        ...
        # Convert XONEAI_OUTPUT_FORMAT to output.format
...
class ConfigLoader:
    ...
    2. Environment variables (XONEAI_*)
    3. Project config (.xone/config.toml)
    4. User config (~/.xone/config.toml)
    5. Defaults
    """
