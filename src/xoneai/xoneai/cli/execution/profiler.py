...
class InvocationInfo:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            "method": self.method,
            "flags": self.flags,
            "xoneai_version": self.xoneai_version,
...
class ProfileReport:
    ...
    def to_text(self) -> str:
        ...
        lines = []
        lines.append("=" * 70)
        lines.append("XoneAI Profile Report")
        lines.append("=" * 70)
        lines.append("")
        ...
        lines.append(f"Version:    {self.invocation.xoneai_version}")
        lines.append("")
...
class Profiler:
    ...
    def _extract_module_breakdown(self, functions: List[FunctionStat]) -> ModuleBreakdown:
        ...
        for func in functions:
            ...
            if "xoneai/cli" in file_path:
                cli_modules.add(func.file)
            elif "xoneai" in file_path and "execution" in file_path:
                execution_modules.add(func.file)
            elif "xoneaiagents" in file_path and "agent" in file_path:
                agent_modules.add(func.file)
            elif "xoneaiagents" in file_path and "tool" in file_path:
