"""
XoneAI CLI Profiling Commands

Provides CLI commands for profiling agent execution.

Usage:
    xoneai profile run "task" --output report.html
    xoneai profile report --format json
    xoneai profile benchmark --iterations 10
"""
...
def handle_profile_command(args) -> int:
    ...
    if subcommand == 'run':
        ...
        print("Usage: xoneai profile <run|report|benchmark|flamegraph|summary>")
        return 1
