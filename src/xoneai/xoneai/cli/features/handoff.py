...
Usage:
    xoneai "Complex task" --handoff "researcher,writer,editor"
    xoneai "Task" --handoff "a,b" --handoff-policy summary --handoff-timeout 60
"""
...
class HandoffHandler(FlagHandler):
    ...
    Example:
        xoneai "Research and write article" --handoff "researcher,writer"
        xoneai "Analyze data" --handoff "analyst,viz" --handoff-policy summary
        xoneai "Task" --handoff "a,b" --handoff-timeout 60 --handoff-max-depth 5
    """
    ...
    def check_dependencies(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            if importlib.util.find_spec("xoneaiagents") is not None:
                return True, ""
            return False, "xoneaiagents not installed"
        except ImportError:
    ...
    def create_agents_with_handoff(
        ...
        from xoneaiagents import Agent, handoff
