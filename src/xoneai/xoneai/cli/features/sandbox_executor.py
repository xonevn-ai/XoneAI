"""
Sandboxed Execution System for XoneAI CLI.
...
class SubprocessSandbox:
    ...
    def _setup_temp_dir(self) -> Path:
        ...
        if self._temp_dir is None:
            self._temp_dir = Path(tempfile.mkdtemp(prefix="xoneai_sandbox_"))
...
class SandboxExecutorHandler:
    """
    Handler for integrating Sandbox Execution with XoneAI CLI.
