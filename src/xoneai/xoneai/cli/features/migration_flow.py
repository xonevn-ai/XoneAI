...
agent frameworks to XoneAI format.
...
class MigrationFlow:
    ...
    code migration from various agent frameworks to XoneAI.
    ...
    def _create_agents(self):
        ...
        from .migration_spec import get_default_spec, XONEAI_REFERENCE
...
""",
        ...
        converter = Agent(
            name="Converter",
            role="Code Converter",
            goal="Convert source code to XoneAI format",
            instructions=f"""You are a code conversion expert. Convert the provided source code to XoneAI format.

Use this specification for conversion:
{spec_prompt}

Reference for XoneAI code:
{XONEAI_REFERENCE}

Rules:
1. Preserve all logic and behavior
2. Convert imports to xoneaiagents
...
"""
                ...
                # Step 2: Convert
                convert_prompt = f"""Convert this code to XoneAI format.
