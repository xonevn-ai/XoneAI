...
1. Image Description (Vision) - Analyze existing images using vision-capable LLMs
   Usage: xoneai "Describe this image" --image path/to/image.png

2. Image Generation - Generate new images from text prompts
   Usage: xoneai "A sunset over mountains" --image-generate
"""
...
class ImageHandler(FlagHandler):
    ...
    Example:
        xoneai "Describe this image" --image photo.png
        xoneai "What's in this image?" --image /path/to/image.jpg
        xoneai "Count the objects" --image image1.png,image2.png
    """
...
class ImageGenerateHandler(FlagHandler):
    ...
    Example:
        xoneai "A sunset over mountains" --image-generate
        xoneai "A cat wearing a hat" --image-generate --llm dall-e-3
    """
