...
All commands use the canonical `xoneai registry` prefix.
"""
...
class RegistryHandler:
    ...
    def _print_help(self):
        """Print help message."""
        print("""
XoneAI Registry Commands

Usage: xoneai registry <command> [options]
...
""")
    ...
    def cmd_serve(self, args: List[str]) -> int:
        ...
        try:
            from xoneai.recipe.server import run_server
            from xoneai.recipe.registry import DEFAULT_REGISTRY_PATH
    ...
    def cmd_status(self, args: List[str]) -> int:
        ...
        try:
            from xoneai.recipe.registry import HttpRegistry
