...
class DeployHandler:
    ...
    def handle_deploy(self, args):
        ...
        """
        try:
            from xoneai.deploy import Deploy, DeployConfig, DeployType, CloudProvider
            from xoneai.deploy.models import APIConfig, DockerConfig, CloudConfig
            ...
            if args.type:
                ...
                if deploy_type == DeployType.API:
                    ...
                    config = DeployConfig(
                        type=deploy_type,
                        docker=DockerConfig(
                            image_name=getattr(args, 'image_name', 'xoneai-app'),
                    ...
                    config = DeployConfig(
                        ...
                        cloud=CloudConfig(
                            ...
                            service_name=getattr(args, 'service_name', 'xoneai-service'),
    ...
    def handle_doctor(self, args):
        ...
        """
        try:
            from xoneai.deploy.doctor import (
    ...
    def handle_init(self, args):
        ...
        """
        try:
            from xoneai.deploy.schema import save_sample_yaml
            from xoneai.deploy.models import DeployType, CloudProvider
            ...
            console.print(f"  2. Run: xoneai deploy validate --file {args.file}")
            console.print(f"  3. Run: xoneai deploy --file {args.file}")
    ...
    def handle_validate(self, args):
        ...
        """
        try:
            from xoneai.deploy.schema import validate_agents_yaml
            ...
            if config is None:
                if args.json:
                    ...
                    console.print("\nRun: xoneai deploy init --file agents.yaml")
                sys.exit(1)
    ...
    def handle_plan(self, args):
        ...
        """
        try:
            from xoneai.deploy import Deploy
            ...
            if args.json:
                ...
                console.print(f"  xoneai deploy --file {args.file}")
