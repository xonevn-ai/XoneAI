...
def handle_output_command(args: list) -> int:
    ...
    if command == "status":
        ...
        if len(args) < 2:
            handler._print_error("Usage: xoneai output set <style>")
...
[cyan]xoneai output status[/cyan]
    Show current output style settings

[cyan]xoneai output set <style>[/cyan]
    Set output style
...
"""
        ...
        print("  xoneai output status       - Show current settings")
        print("  xoneai output set <style>  - Set output style")
        print("  xoneai output help         - Show this help")
        print("")
        print("Styles: concise, detailed, technical, conversational, structured, minimal")
