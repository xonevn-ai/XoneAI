...
Usage:
    xoneai "Refactor the code" --external-agent claude
    xoneai "Analyze codebase" --external-agent gemini
    xoneai "Fix bugs" --external-agent codex
    xoneai "Add tests" --external-agent cursor
"""
...
class ExternalAgentsHandler(FlagHandler):
    ...
    Example:
        ...
        xoneai "Analyze this codebase" --external-agent gemini
    """
    ...
    def check_dependencies(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            if importlib.util.find_spec("xoneai.integrations") is not None:
                return True, ""
    ...
    def get_integration(self, name: str, **options):
        ...
        import importlib
        module = importlib.import_module(f"xoneai.integrations.{module_name}")
