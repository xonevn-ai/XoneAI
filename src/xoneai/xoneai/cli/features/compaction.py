...
class CompactionHandler:
    ...
    CONFIG_FILE = ".xone/compaction.json"
...
def handle_compaction_command(args: list) -> int:
    ...
    if command == "status":
        ...
        if len(args) < 2:
            handler._print_error("Usage: xoneai compaction set <strategy>")
...
[cyan]xoneai compaction status[/cyan]
    Show current compaction settings

[cyan]xoneai compaction set <strategy>[/cyan]
    Set compaction strategy
...
[cyan]xoneai compaction stats[/cyan]
    Show compaction statistics

[cyan]xoneai compaction help[/cyan]
...
"""
        ...
        print("  xoneai compaction status         - Show current settings")
        print("  xoneai compaction set <strategy> - Set compaction strategy")
        print("  xoneai compaction stats          - Show statistics")
        print("  xoneai compaction help           - Show this help")
        print("")
        print("Strategies: truncate, sliding, summarize, smart")
