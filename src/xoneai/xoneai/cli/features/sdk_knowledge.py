...
Contains comprehensive documentation of XoneAI Agents SDK features
...
# XoneAI Agents SDK Reference

You are an expert at creating XoneAI agent recipes. Generate a complete agents.yaml file based on the user's goal.
...
## xoneai-tools Direct Usage

Tools from `xoneai-tools` package can be used directly in agents.yaml:
...
XoneAI provides specialized agent classes for different use cases:
