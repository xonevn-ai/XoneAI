...
class ObservabilityHandler(FlagHandler):
    ...
    Commands:
        xoneai obs list          - List available providers
        xoneai obs doctor        - Check provider connectivity
        xoneai obs init <name>   - Initialize a provider
    """
    ...
    def check_dependencies(self) -> Tuple[bool, str]:
        ...
        try:
            from xoneai_tools.observability import obs
            return True, ""
        except ImportError:
            return False, "Observability requires xoneai-tools. Install with: pip install xoneai-tools"
    ...
    def list_providers(self) -> Dict[str, Any]:
        ...
        try:
            from xoneai_tools.observability.manager import ObservabilityManager
            from xoneai_tools.observability.config import PROVIDER_ENV_KEYS
    ...
    def doctor(self, provider: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "error": "xoneai-tools not installed",
                "enabled": False,
            }
    ...
    def _execute_init(self, provider: str, **kwargs) -> bool:
        ...
        if not provider:
            self.print_status("Provider name required. Usage: xoneai obs init <provider>", "error")
            return False
    ...
    def apply_to_agent_config(self, config: Dict[str, Any], flag_value: Any) -> Dict[str, Any]:
        ...
        if flag_value:
            try:
                ...
                self.print_status("Observability requires xoneai-tools", "warning")
