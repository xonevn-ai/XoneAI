...
class OnboardingWizard:
    """Interactive onboarding wizard for XoneAI setup."""
    ...
    def run(self, output_dir: str = ".") -> bool:
        ...
        console.print(Panel.fit(
            "[bold blue]Welcome to XoneAI![/bold blue]\n\n"
        ...
        console.print("  2. pip install xoneaiagents")
    ...
    def _create_agent_yaml(self, project_dir: str) -> None:
        ...
        yaml_content = f"""# XoneAI Agent Configuration
# Generated by xoneai init
...
"""
    ...
    def _create_main_py(self, project_dir: str) -> None:
        """Create main.py file."""
        main_content = f'''"""
{self.config['project_name']} - XoneAI Agent
...
- [XoneAI Documentation](https://docs.xone.ai)
- [Agent Configuration](https://docs.xone.ai/agents)
- [Tools Reference](https://docs.xone.ai/tools)
"""
...
def add_init_parser(subparsers) -> None:
    ...
    init_parser = subparsers.add_parser(
        "init",
        help="Initialize a new XoneAI project",
    )
