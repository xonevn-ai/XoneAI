...
def _crawl_url_for_optimizer(url: str) -> str:
    ...
    try:
        ...
        from xoneaiagents.tools import web_crawl
...
class RecipeOptimizer:
    ...
    Usage:
        ...
        from xoneaiagents.eval import Judge, JudgeCriteriaConfig
    ...
    def run_iteration(
        ...
        from xoneai.replay import ContextTraceReader, ContextEffectivenessJudge
        ...
        try:
            ...
            from xoneai.replay.judge import JudgeReport
            return JudgeReport(
...
"""
        ...
        prompt = f"""You are an expert at optimizing XoneAI agent recipes. Your goal is to INCREASE the score from {overall_score}/10 to 8.0+/10.
{input_context_section}
...
"""
    ...
    def _validate_yaml_structure(self, yaml_content: str) -> Tuple[bool, List[str]]:
        """
        Validate YAML structure for XoneAI recipe requirements.
    ...
    def apply_improvements(
        ...
        prompt = f"""You are an expert at modifying XoneAI agent YAML files.
