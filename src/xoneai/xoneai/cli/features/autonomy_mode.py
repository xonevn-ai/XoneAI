...
try:
    from xoneaiagents.config.feature_configs import AutonomyLevel as _AutonomyLevel
except ImportError:
...
class AutonomyMode(Enum):
    ...
    Values are identical to xoneaiagents.config.feature_configs.AutonomyLevel.
...
class AutonomyManager:
    ...
    def _bridge_to_sdk_approval(mode: AutonomyMode) -> None:
        ...
        When FULL_AUTO, set XONEAI_AUTO_APPROVE=true so the SDK's
...
class AutonomyModeHandler:
    """
    Handler for integrating autonomy modes with XoneAI CLI.
    """
