...
from xoneai.auto import TOOL_CATEGORIES, TASK_KEYWORD_TO_TOOLS
...
'''
    ...
    def generate_tools_py(self, tools: List[str]) -> str:
        ...
        Notes:
            ...
            - search_web: Works with standard import from xoneaiagents.tools
            - tavily_*: Imported from xoneaiagents.tools (not xoneai_tools)
        """
...
Auto-generated by xoneai recipe create.
"""
...
cli:
  command: xoneai recipe run {name}
  examples:
    - xoneai recipe run {name}
    - xoneai recipe run {name} --input "custom input"
