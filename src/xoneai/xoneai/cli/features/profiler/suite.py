"""
Profile Suite Runner for XoneAI CLI.
...
class ProfileSuiteRunner:
    ...
    def __init__(
        ...
        self.output_dir = Path(output_dir) if output_dir else Path("/tmp/xoneai_profile_suite")
    ...
    def _collect_metadata(self) -> Dict[str, Any]:
        ...
        import platform
        try:
            from xoneai.version import __version__ as xoneai_version
        except ImportError:
    ...
    def _format_report(self, result: SuiteResult) -> str:
        ...
        lines = []
        lines.append("=" * 70)
        lines.append("XoneAI Profile Suite Report")
        lines.append("=" * 70)
        lines.append("")
        ...
        lines.append(f"  XoneAI:        {result.metadata.get('xoneai_version', 'N/A')}")
        lines.append("")
