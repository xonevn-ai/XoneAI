...
class DoctorEngine:
    ...
    def get_environment_summary(self) -> EnvironmentSummary:
        ...
        xoneaiagents_version = "unknown"
        
        try:
            from xoneai.version import __version__ as pai_version
            xoneai_version = pai_version
        except ImportError:
            pass
        
        try:
            import xoneaiagents
            xoneaiagents_version = getattr(xoneaiagents, "__version__", "unknown")
        except ImportError:
            pass
        ...
        return EnvironmentSummary(
            ...
            xoneaiagents_version=xoneaiagents_version,
