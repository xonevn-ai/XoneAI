...
class ThinkingHandler:
    ...
    CONFIG_FILE = ".xone/thinking.json"
...
def handle_thinking_command(args: list) -> int:
    ...
    if command == "status":
        ...
        if len(args) < 2:
            handler._print_error("Usage: xoneai thinking set <level>")
...
[cyan]xoneai thinking status[/cyan]
    Show current thinking budget settings

[cyan]xoneai thinking set <level>[/cyan]
...
[cyan]xoneai thinking stats[/cyan]
    Show usage statistics

[cyan]xoneai thinking help[/cyan]
...
"""
        ...
        print("  xoneai thinking status       - Show current settings")
        print("  xoneai thinking set <level>  - Set budget level")
        print("  xoneai thinking stats        - Show usage statistics")
        print("  xoneai thinking help         - Show this help")
        print("")
