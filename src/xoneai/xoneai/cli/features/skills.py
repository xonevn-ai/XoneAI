...
class SkillsHandler:
    ...
    def list_skills(
        ...
        """
        from xoneaiagents.skills import discover_skills
    ...
    def validate_skill(self, skill_path: str) -> dict:
        ...
        """
        from xoneaiagents.skills import validate
    ...
    def create_skill(
        ...
        compatibility = compatibility or "Works with XoneAI Agents"
...
description: {description}
license: Apache-2.0
compatibility: Works with XoneAI Agents, Claude Code, and other Agent Skills compatible tools
metadata:
  author: user
  version: "1.0"
---
