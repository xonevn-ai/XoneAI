...
class CapabilitiesHandler:
    ...
    def handle_audio(args, unknown_args):
        ...
        if not unknown_args:
            print("Usage: xoneai audio <transcribe|speech> [options]")
            print("\nSubcommands:")
    ...
    def _handle_audio_transcribe(args, remaining_args):
        """Handle: xoneai audio transcribe <file> [options]"""
        parser = argparse.ArgumentParser(prog="xoneai audio transcribe")
    ...
    def _handle_audio_speech(args, remaining_args):
        """Handle: xoneai audio speech <text> [options]"""
        parser = argparse.ArgumentParser(prog="xoneai audio speech")
    ...
    def handle_images(args, unknown_args):
        ...
        if not unknown_args:
            print("Usage: xoneai images <generate|edit> [options]")
            print("\nSubcommands:")
    ...
    def _handle_images_generate(args, remaining_args):
        """Handle: xoneai images generate <prompt> [options]"""
        parser = argparse.ArgumentParser(prog="xoneai images generate")
    ...
    def _handle_images_edit(args, remaining_args):
        """Handle: xoneai images edit <image> <prompt> [options]"""
        parser = argparse.ArgumentParser(prog="xoneai images edit")
        ...
        from xoneai.capabilities.images import image_edit
    ...
    def handle_files(args, unknown_args):
        ...
        if not unknown_args:
            print("Usage: xoneai files <upload|list|get|delete> [options]")
            print("\nSubcommands:")
    ...
    def _handle_files_upload(args, remaining_args):
        """Handle: xoneai files upload <file> [options]"""
        parser = argparse.ArgumentParser(prog="xoneai files upload")
    ...
    def _handle_files_list(args, remaining_args):
        """Handle: xoneai files list [options]"""
        parser = argparse.ArgumentParser(prog="xoneai files list")
        ...
        from xoneai.capabilities.files import file_list
    ...
    def _handle_files_get(args, remaining_args):
        """Handle: xoneai files get <file_id>"""
        parser = argparse.ArgumentParser(prog="xoneai files get")
        ...
        from xoneai.capabilities.files import file_retrieve
    ...
    def _handle_files_delete(args, remaining_args):
        """Handle: xoneai files delete <file_id>"""
        parser = argparse.ArgumentParser(prog="xoneai files delete")
        parser.add_argument("file_id", help="File ID")
        ...
        from xoneai.capabilities.files import file_delete
    ...
    def handle_embed(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="xoneai embed")
        ...
        from xoneaiagents.embedding import embedding
    ...
    def handle_rerank(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="xoneai rerank")
    ...
    def handle_moderate(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="xoneai moderate")
    ...
    def handle_ocr(args, unknown_args):
        """Handle ocr command."""
        parser = argparse.ArgumentParser(prog="xoneai ocr")
    ...
    def handle_batches(args, unknown_args):
        ...
        if not unknown_args:
            print("Usage: xoneai batches <create|list|get|cancel> [options]")
            print("\nSubcommands:")
    ...
    def _handle_batches_create(args, remaining_args):
        """Handle: xoneai batches create <file_id>"""
        parser = argparse.ArgumentParser(prog="xoneai batches create")
        ...
        from xoneai.capabilities.batches import batch_create
    ...
    def _handle_batches_list(args, remaining_args):
        """Handle: xoneai batches list"""
        from xoneai.capabilities.batches import batch_list
    ...
    def _handle_batches_get(args, remaining_args):
        """Handle: xoneai batches get <batch_id>"""
        parser = argparse.ArgumentParser(prog="xoneai batches get")
        ...
        from xoneai.capabilities.batches import batch_retrieve
    ...
    def _handle_batches_cancel(args, remaining_args):
        """Handle: xoneai batches cancel <batch_id>"""
        parser = argparse.ArgumentParser(prog="xoneai batches cancel")
        parser.add_argument("batch_id", help="Batch ID")
        ...
        from xoneai.capabilities.batches import batch_cancel
    ...
    def handle_vector_stores(args, unknown_args):
        ...
        if not unknown_args:
            print("Usage: xoneai vector-stores <create|search> [options]")
            print("\nSubcommands:")
    ...
    def _handle_vector_stores_create(args, remaining_args):
        """Handle: xoneai vector-stores create <name>"""
        parser = argparse.ArgumentParser(prog="xoneai vector-stores create")
        ...
        from xoneai.capabilities.vector_stores import vector_store_create
    ...
    def _handle_vector_stores_search(args, remaining_args):
        """Handle: xoneai vector-stores search <store_id> <query>"""
        parser = argparse.ArgumentParser(prog="xoneai vector-stores search")
        ...
        from xoneai.capabilities.vector_stores import vector_store_search
    ...
    def handle_assistants(args, unknown_args):
        ...
        if not unknown_args:
            print("Usage: xoneai assistants <create|list> [options]")
            print("\nSubcommands:")
    ...
    def _handle_assistants_create(args, remaining_args):
        """Handle: xoneai assistants create [options]"""
        parser = argparse.ArgumentParser(prog="xoneai assistants create")
        ...
        from xoneai.capabilities.assistants import assistant_create
    ...
    def _handle_assistants_list(args, remaining_args):
        """Handle: xoneai assistants list"""
        from xoneai.capabilities.assistants import assistant_list
    ...
    def handle_fine_tuning(args, unknown_args):
        ...
        if not unknown_args:
            print("Usage: xoneai fine-tuning <create|list> [options]")
            print("\nSubcommands:")
    ...
    def _handle_fine_tuning_create(args, remaining_args):
        """Handle: xoneai fine-tuning create <file_id>"""
        parser = argparse.ArgumentParser(prog="xoneai fine-tuning create")
        ...
        from xoneai.capabilities.fine_tuning import fine_tuning_create
    ...
    def _handle_fine_tuning_list(args, remaining_args):
        """Handle: xoneai fine-tuning list"""
        from xoneai.capabilities.fine_tuning import fine_tuning_list
    ...
    def handle_completions(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="xoneai completions")
        ...
        if not parsed.prompt:
            print("Usage: xoneai completions <prompt> [options]")
            return 1
        
        from xoneai.capabilities.completions import chat_completion
    ...
    def handle_messages(args, unknown_args):
        ...
        if not unknown_args:
            print("Usage: xoneai messages <create|count-tokens> [options]")
            return 1
    ...
    def _handle_messages_create(args, remaining_args):
        """Handle: xoneai messages create <prompt>"""
        parser = argparse.ArgumentParser(prog="xoneai messages create")
        ...
        from xoneai.capabilities.messages import messages_create
    ...
    def _handle_count_tokens(args, remaining_args):
        """Handle: xoneai messages count-tokens <text>"""
        parser = argparse.ArgumentParser(prog="xoneai messages count-tokens")
        ...
        from xoneai.capabilities.messages import count_tokens
    ...
    def handle_guardrails(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="xoneai guardrails")
        ...
        from xoneai.capabilities.guardrails import apply_guardrail
    ...
    def handle_rag(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="xoneai rag")
        ...
        from xoneai.capabilities.rag import rag_query
    ...
    def handle_realtime(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="xoneai realtime")
        ...
        from xoneai.capabilities.realtime import realtime_connect
    ...
    def handle_videos(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="xoneai videos")
        ...
        from xoneai.capabilities.videos import video_generate
    ...
    def handle_a2a(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="xoneai a2a")
        ...
        from xoneai.capabilities.a2a import a2a_send
    ...
    def handle_containers(args, unknown_args):
        ...
        if not unknown_args:
            print("Usage: xoneai containers <create|files> [options]")
            return 1
    ...
    def _handle_container_create(args, remaining_args):
        """Handle: xoneai containers create"""
        parser = argparse.ArgumentParser(prog="xoneai containers create")
        ...
        from xoneai.capabilities.containers import container_create
    ...
    def _handle_container_files(args, remaining_args):
        """Handle: xoneai containers files <action>"""
        if not remaining_args:
            print("Usage: xoneai containers files <read|write|list> [options]")
            return 1
        ...
        if action == "read":
            parser = argparse.ArgumentParser(prog="xoneai containers files read")
            ...
            from xoneai.capabilities.container_files import container_file_read
            ...
            parser = argparse.ArgumentParser(prog="xoneai containers files list")
            parser.add_argument("container_id", help="Container ID")
            ...
            from xoneai.capabilities.container_files import container_file_list
    ...
    def handle_passthrough(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="xoneai passthrough")
        ...
        from xoneai.capabilities.passthrough import passthrough
        import json
    ...
    def handle_responses(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="xoneai responses")
        ...
        from xoneai.capabilities.responses import responses_create
    ...
    def handle_search(args, unknown_args):
        ...
        parser = argparse.ArgumentParser(prog="xoneai search")
        parser.add_argument("query", help="Search query")
        ...
        from xoneai.capabilities.search import search
