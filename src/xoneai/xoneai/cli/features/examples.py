"""
Examples Execution System for XoneAI.
...
class RunReport:
    ...
    def __post_init__(self):
        ...
        try:
            ...
            self.xoneai_version = __version__
        except ImportError:
            self.xoneai_version = "unknown"
...
class ReportGenerator:
    ...
    def generate_json(self, report: RunReport) -> Path:
        ...
        data = {
            "metadata": {
                ...
                "xoneai_version": report.xoneai_version,
    ...
    def generate_markdown(self, report: RunReport) -> Path:
        ...
        lines = [
            ...
            f"**XoneAI**: {report.xoneai_version}",
        ]
...
class ExamplesExecutor:
    ...
    def _get_pythonpath(self) -> List[str]:
        ...
        for _ in range(5):  # Look up to 5 levels
            ...
            # Also check for xoneai-agents and xoneai directly
            for pkg in ["xoneai-agents", "xoneai"]:
