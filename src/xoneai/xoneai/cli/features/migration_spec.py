...
to convert code from various agent framework patterns to XoneAI format.
...
class PatternSpec:
    ...
    target_equivalent: str  # XoneAI equivalent
    parameter_mapping: Dict[str, str]  # source_param -> xoneai_param
    notes: str = ""
...
class MigrationSpec:
    ...
    def to_prompt(self) -> str:
        ...
        lines = [
            ...
            "",
            "Use this specification to convert agent code to XoneAI format.",
            "",
            "## Agent Patterns",
            ""
        ]
    ...
    return MigrationSpec(
        agent_patterns=[
            PatternSpec(
                ...
                target_equivalent="from xoneaiagents import Agent",
                parameter_mapping={
                    "role": "role",
                    "goal": "goal",
                    "backstory": "backstory",
        ...
        task_patterns=[
            PatternSpec(
                ...
                target_equivalent="from xoneaiagents import Task",
                parameter_mapping={
        ...
        team_patterns=[
            PatternSpec(
                ...
                target_equivalent="from xoneaiagents import AgentTeam",
                parameter_mapping={
                    "agents": "agents",
            ...
            PatternSpec(
                ...
                target_equivalent="from xoneaiagents import AgentFlow",
                parameter_mapping={
                    "name": "name",
                    "steps": "steps",
                    "description": "description",
        ...
        import_patterns={
            ...
            "from X.agent import Agent": "from xoneaiagents import Agent",
            "from X import Agent": "from xoneaiagents import Agent",
            "from X import Task": "from xoneaiagents import Task",
            "from X.team import Team": "from xoneaiagents import AgentTeam",
            "from X import Crew": "from xoneaiagents import AgentTeam",
            "from X.workflow import Workflow": "from xoneaiagents import AgentFlow",
...
# XoneAI reference code for the LLM to understand target format
XONEAI_REFERENCE = '''
# XoneAI Agent Framework Reference
