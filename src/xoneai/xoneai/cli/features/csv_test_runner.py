"""
CSV-driven Interactive Test Runner for XoneAI.
    ...
    def should_skip(self) -> Optional[str]:
        ...
        for condition in conditions:
            if condition == "no_openai_key":
                ...
                if os.environ.get("XONEAI_NO_NETWORK"):
...
class CSVTestRunner:
    ...
    def _run_single_test(self, test_case: TestCase) -> TestResult:
        ...
        if self.workspace:
            ...
            test_workspace = Path(tempfile.mkdtemp(prefix=f"xone_test_{test_case.id}_"))
