"""
ACP CLI handler for XoneAI.

Provides the `xoneai acp` command for IDE/editor integration.
"""
...
def setup_acp_subparser(subparsers) -> None:
    ...
    acp_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "to connect to XoneAI agents via JSON-RPC over stdio."
        ),
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  xoneai acp                    # Start with defaults
  xoneai acp --debug            # Enable debug logging
  xoneai acp --resume --last    # Resume last session
  xoneai acp --allow-write      # Enable file writes
  xoneai acp -m gpt-4o          # Use specific model
