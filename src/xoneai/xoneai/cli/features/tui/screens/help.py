...
if TEXTUAL_AVAILABLE:
    ...
    class HelpScreen(Screen):
        ...
        def compose(self):
            ...
            with Container(id="help-container"):
                yield Static("XoneAI TUI Help", id="help-title")
        ...
        def _build_help_content(self) -> Text:
            ...
            content.append("XONEAI_TUI_CTRL_KEYS=1\n", style="yellow")
            content.append("  Fn keys:   ", style="dim")
            content.append("XONEAI_TUI_FN_KEYS=1\n", style="yellow")
    ...
    class HelpScreen:
        ...
        def __init__(self, *args, **kwargs):
            raise ImportError(
                "Textual is required for TUI. Install with: pip install xoneai[tui]"
            )
