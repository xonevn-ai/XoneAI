"""
Interactive Runtime for XoneAI.
...
class InteractiveRuntime:
    ...
    def read_only(self) -> bool:
        ...
        import os as _os
        env_approval_mode = _os.environ.get("XONE_APPROVAL_MODE", "").lower()
    ...
    async def _start_lsp(self):
        ...
        try:
            ...
            from xoneaiagents.lsp import LSPClient
    ...
    async def _start_acp(self):
        ...
        try:
            # Lazy import ACP
            from xoneai.acp.session import ACPSession
            from pathlib import Path
    ...
    def save_trace(self, path: str = None):
        ...
        import json
        path = path or self.config.trace_file or "xoneai_trace.json"
