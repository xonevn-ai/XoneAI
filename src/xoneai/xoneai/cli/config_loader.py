"""
Shared configuration loader for XoneAI CLI commands.
...
class RAGCliConfig:
    ...
    def to_knowledge_config(self) -> Dict[str, Any]:
        ...
        path = self.vector_store_path or f"./.xone/knowledge/{self.collection}"
...
ENV_MAPPINGS = {
    "XONEAI_COLLECTION": "collection",
    "XONEAI_TOP_K": ("top_k", int),
    "XONEAI_HYBRID": ("hybrid", lambda x: x.lower() in ("true", "1", "yes")),
    "XONEAI_RERANK": ("rerank", lambda x: x.lower() in ("true", "1", "yes")),
    "XONEAI_MIN_SCORE": ("min_score", float),
    "XONEAI_CITATIONS": ("include_citations", lambda x: x.lower() in ("true", "1", "yes")),
    "XONEAI_MAX_CONTEXT_TOKENS": ("max_context_tokens", int),
    "XONEAI_VECTOR_STORE": "vector_store_provider",
    "XONEAI_VECTOR_STORE_PATH": "vector_store_path",
    "XONEAI_HOST": "host",
    "XONEAI_PORT": ("port", int),
    "XONEAI_OPENAI_COMPAT": ("openai_compat", lambda x: x.lower() in ("true", "1", "yes")),
    "XONEAI_MODEL": "model",
    "XONEAI_VERBOSE": ("verbose", lambda x: x.lower() in ("true", "1", "yes")),
}
...
def get_config_schema() -> Dict[str, Any]:
    ...
    return {
        "knowledge": {
            ...
            "vector_store_path": "Path to vector store (default: './.xone/knowledge/{collection}')",
        },
        "retrieval": {
