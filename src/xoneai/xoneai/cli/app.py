...
app = typer.Typer(
    name="xoneai",
    help="XoneAI - AI Agents Framework CLI",
...
def version_callback(value: bool):
    ...
    if value:
        ...
        typer.echo(f"XoneAI version {__version__}")
        raise typer.Exit()
...
def main_callback(
    ...
    """
    XoneAI - AI Agents Framework CLI.
...
def register_commands():
    ...
    app.add_typer(batch_app, name="batch", help="Run all XoneAI scripts in current folder")
    ...
    def app_cmd(
        ...
        name: str = typer.Option("XoneAI App", "--name", "-n", help="Application name"),
    ):
        """
        ...
        try:
            ...
            console.print("[yellow]Install with: pip install xoneai[api][/yellow]")
            raise typer.Abort()
