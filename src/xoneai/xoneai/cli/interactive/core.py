...
class InteractiveCore:
    ...
    - `xoneai run --interactive` → RichFrontend
    - `xoneai chat` → RichFrontend
    - `xoneai tui launch` → TextualFrontend
    """
    ...
    async def _execute_prompt(self, message: str, session_id: str) -> str:
        ...
        try:
            ...
            try:
                ...
                return "Error: xoneaiagents not available"
    ...
    def _get_basic_tools(self) -> List:
        ...
        tools = []
        try:
            from xoneaiagents.tools import read_file, write_file, list_files
    ...
    def _load_persistent_approvals(self) -> None:
        ...
        approvals_file = Path.home() / ".xone" / "approvals.json"
