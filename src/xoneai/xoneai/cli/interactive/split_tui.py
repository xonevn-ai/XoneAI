"""
XoneAI Split-Pane TUI Application.
        ...
        if self._agent is None:
            try:
                ...
                self._agent = Agent(
                    ...
                    instructions="You are Xone AI, a helpful assistant. Be concise and helpful.",
  ...
  /new           Start new conversation"""
    ...
    def _run_with_status(self, prompt: str) -> Optional[str]:
        ...
        while thread.is_alive():
            ...
            self._status_text = f"{spinner[idx]} Xone AI is thinking... ({elapsed:.1f}s)"
    ...
    def _run_with_prompt_toolkit(self) -> None:
        ...
        def handle_enter(event):
            ...
            self.messages.append(ChatMessage(role="status", content="Xone AI is thinking..."))
            output_text[0] = self._format_output()
