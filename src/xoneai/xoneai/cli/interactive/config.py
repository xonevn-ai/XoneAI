...
class InteractiveConfig:
    ...
    def from_env(cls) -> "InteractiveConfig":
        ...
        return cls(
            model=os.environ.get("XONE_MODEL"),
            workspace=os.environ.get("XONE_WORKSPACE", os.getcwd()),
            approval_mode=os.environ.get("XONE_APPROVAL_MODE", "prompt"),
            enable_acp=os.environ.get("XONE_DISABLE_ACP", "").lower() != "true",
            enable_lsp=os.environ.get("XONE_DISABLE_LSP", "").lower() != "true",
            verbose=os.environ.get("XONE_VERBOSE", "").lower() == "true",
            memory=os.environ.get("XONE_MEMORY", "").lower() == "true",
            autonomy=os.environ.get("XONE_AUTONOMY", "true").lower() != "false",
        )
