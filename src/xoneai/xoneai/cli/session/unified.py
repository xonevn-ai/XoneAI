"""
Unified Session for XoneAI CLI.
...
DEFAULT_SESSION_DIR = Path.home() / ".xone" / "sessions"
...
class UnifiedSessionStore:
    ...
    Stores sessions as JSON files in ~/.xone/sessions/
    """
    ...
    def __init__(self, session_dir: Optional[Path] = None):
        ...
        Args:
            session_dir: Directory to store sessions. Defaults to ~/.xone/sessions/
        """
