"""
Eval command group for XoneAI CLI.
...
def eval_judge(
    ...
    Examples:
        xoneai eval judge --output "4" --expected "4"
        xoneai eval judge --output "Hello!" --criteria "Response is helpful"
        xoneai eval judge --file output.txt --criteria "Code is correct"
    """
    try:
        from xoneaiagents.eval import Judge, JudgeConfig
    except ImportError:
        typer.echo("Error: xoneaiagents package required. Install with: pip install xoneaiagents")
        raise typer.Exit(1)
