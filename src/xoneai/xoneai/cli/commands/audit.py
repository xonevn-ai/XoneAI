...
Usage:
    xoneai audit agent-centric --scan /path/to/examples
    xoneai audit agent-centric --fix /path/to/examples
    xoneai audit agent-centric --check /path/to/examples
"""
...
def agent_centric(scan_path, fix_path, check_path, output_json, line_limit, only_examples, only_docs, verbose):
    ...
    Examples:
        xoneai audit agent-centric --scan ./examples
        xoneai audit agent-centric --fix ./examples --verbose
        xoneai audit agent-centric --check ./examples  # Fails if non-compliant
    """
    from xoneai.audit.agent_centric import AgentCentricAuditor, ComplianceStatus
