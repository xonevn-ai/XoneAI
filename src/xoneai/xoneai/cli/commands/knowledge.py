"""
Knowledge command group for XoneAI CLI.
...
For answering questions with citations, use `xoneai rag query`.
"""
...
def knowledge_index(
    ...
    Use `xoneai rag query` to answer questions using the indexed knowledge.
    
    Examples:
        xoneai knowledge index ./docs --user-id myuser
        xoneai knowledge index paper.pdf --collection research --agent-id research_agent
        xoneai knowledge index ./data --backend chroma --profile
    """
    from rich.console import Console
...
def knowledge_search(
    ...
    For answers with citations, use `xoneai rag query`.
    
    Examples:
        xoneai knowledge search "capital of France" --user-id myuser
        xoneai knowledge search "main findings" --collection research --top-k 10
        xoneai knowledge search "Python tutorial" --hybrid --backend chroma
    """
    from rich.console import Console
...
def knowledge_add(
    ...
    This is a backward-compatible alias for `xoneai knowledge index`.
    
    Examples:
        xoneai knowledge add ./docs
        xoneai knowledge add paper.pdf --collection research
    """
...
def knowledge_list(
    ...
    knowledge_dirs = ["./.xone/knowledge", "./.xone/rag", ".xone"]
    collections = set()
    ...
    if not collections:
        ...
        console.print("Create one with: xoneai knowledge index ./docs --collection myknowledge")
        return
