...
def loop_main(
    ...
    Examples:
        ...
        xoneai loop "Build a REST API" -n 5
        
        xoneai loop "Refactor auth module" -p DONE
        
        xoneai loop "Implement feature X" -p COMPLETE -c
    """
...
def _run_loop(
    ...
    try:
        ...
        typer.echo("Error: xoneaiagents not installed. Run: pip install xoneaiagents", err=True)
        raise typer.Exit(1)
...
USAGE:
  xoneai loop "Your task here" [OPTIONS]
...
EXAMPLES:
  # Basic loop
  xoneai loop "Build a calculator" -n 5

  # With completion promise
  xoneai loop "Refactor the auth module" -p DONE -v

  # With context clearing (forces file-based state)
  xoneai loop "Implement feature X" -p COMPLETE -c -n 20

  # With timeout
  xoneai loop "Debug the issue" -t 300 -v
""")
