...
Commands:
- xoneai standardise check      - Check for standardisation issues
- xoneai standardise report     - Generate detailed report
- xoneai standardise fix        - Fix issues (with --apply)
- xoneai standardise init       - Initialise a new feature
- xoneai standardise ai         - AI-powered generation
- xoneai standardise checkpoint - Create undo checkpoint
- xoneai standardise undo       - Undo to previous checkpoint
- xoneai standardise redo       - Redo after undo
"""
...
def _lazy_import_engine():
    ...
    from xoneai.standardise import StandardiseEngine, StandardiseConfig
...
def _run_ai(parsed) -> int:
    ...
    import asyncio
    from xoneai.standardise.ai_generator import AIGenerator
    from xoneai.standardise.models import ArtifactType, FeatureSlug
...
def _run_checkpoint(parsed) -> int:
    ...
    from xoneai.standardise.undo_redo import UndoRedoManager
