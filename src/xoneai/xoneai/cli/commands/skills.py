"""
Skills command group for XoneAI CLI.
...
def skills_info(
    ...
    try:
        from xoneaiagents.skills import discover_skills, SkillLoader
...
def skills_eligible(
    ...
    Examples:
        xoneai skills eligible
        xoneai skills eligible --json
    """
    try:
        from xoneaiagents.skills import discover_skills
        import os
