...
Usage:
    xoneai app                    # Start server with default config
    xoneai app --port 9000        # Start on custom port
    xoneai app --config app.yaml  # Load from config file
    xoneai app --reload           # Enable auto-reload for development
"""
...
@click.option("--name", "-n", type=str, default="XoneAI App", help="Application name")
def app_command(
    port: int,
    host: str,
    config: Optional[str],
    ...
    Examples:
        ...
        xoneai app --port 9000
        
        # Enable auto-reload for development
        xoneai app --reload
        
        # Load agents from config file
        xoneai app --config agents.yaml
    """
