"""
Tools command group for XoneAI CLI.
...
def tools_list(
    ...
    Shows tools from:
    - Built-in tools (xoneaiagents.tools)
    - Local tools.py (if present)
    - External tools (xoneai-tools package)
    """
...
def tools_validate(
    ...
    if not missing:
        ...
        console.print("\n[yellow]Hint: Run 'xoneai tools list' to see available tools.[/yellow]")
        raise typer.Exit(1)
...
def tools_info(
    ...
    if tool is None:
        ...
        console.print("[yellow]Hint: Run 'xoneai tools list' to see available tools.[/yellow]")
        raise typer.Exit(1)
    ...
    if name in available:
        ...
        if "Local tool" in desc:
            ...
            console.print("\n[blue]Source:[/blue] xoneai-tools package")
        else:
            console.print("\n[blue]Source:[/blue] xoneaiagents.tools (built-in)")
