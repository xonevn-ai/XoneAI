"""
Code command group for XoneAI CLI.
...
def code_main(
    ...
    For browser-based code UI, use: xoneai ui code
    
    Examples:
        xoneai code
        xoneai code "Refactor this function"
        xoneai code --model gpt-4o --workspace ./src
        xoneai code "Fix the bug" --file main.py
        xoneai code "What is 2+2?" --profile
    """
    import os
    import argparse
    ...
    if (profile or profile_deep) and not prompt:
        ...
        typer.echo("   Use: xoneai code \"your prompt\" --profile", err=True)
