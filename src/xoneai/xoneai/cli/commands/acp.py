"""
ACP command group for XoneAI CLI.
...
def acp_main(
    ...
    DEPRECATED: Use `xoneai serve acp` instead.
    """
    import sys
    
    # Print deprecation warning
    print("\n\033[93m⚠ DEPRECATION WARNING:\033[0m", file=sys.stderr)
    print("\033[93m'xoneai acp' is deprecated and will be removed in a future version.\033[0m", file=sys.stderr)
    print("\033[93mPlease use 'xoneai serve acp' instead.\033[0m\n", file=sys.stderr)
