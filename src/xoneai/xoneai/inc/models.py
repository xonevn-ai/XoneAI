...
class XoneAIModel:
    def __init__(self, model=None, api_key_var=None, base_url=None, api_key=None):
        """
        Initializes the XoneAIModel with the provided parameters or environment variables.
        ...
        logger.debug(f"Initialized XoneAIModel with model {self.model_name}, api_key_var {self.api_key_var}, and base_url {self.base_url}")
