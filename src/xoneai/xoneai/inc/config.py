def generate_config(
    ...
    """Generates the configuration for XoneAI with dynamic overrides."""
    ...
    config = {
        ...
        "hf_model_name": hf_model_name or "xonevn-ai/llama-3.1-tamilan-8B-test",
        "ollama_model": ollama_model_name or "xonevn-ai/llama3.1-tamilan-test",
