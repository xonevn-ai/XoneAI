...
This module provides the chat UI integration for XoneAI agents.
It uses the XoneAI Chat (based on Chainlit) for the frontend.
"""
...
class ChatConfig:
    """Configuration for the XoneAI Chat server."""
...
def start_chat_server(
    ...
    """
    Start the XoneAI Chat server.
    
    Args:
        agent: A single XoneAI agent to use in the chat.
        agents: A list of XoneAI agents for multi-agent chat.
    ...
    Example:
        ...
        >>> from xoneai.chat import start_chat_server
        >>> 
    ...
    try:
        ...
        raise ImportError(
            "XoneAI Chat requires the 'xoneai-chat' package. "
            "Install it with: pip install xoneai-chat"
        )
    ...
    import os
    os.environ["XONEAI_CHAT_MODE"] = "true"
