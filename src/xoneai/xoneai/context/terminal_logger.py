...
Usage:
    ...
    logger = TerminalLogger(base_dir="~/.xone/runs")
...
from xoneaiagents.context.artifacts import (
    ArtifactRef,
    GrepMatch,
    compute_checksum,
)
...
class TerminalLogger:
    ...
    Directory layout:
    ~/.xone/runs/{run_id}/terminal/{agent_id}.log
    ...
    def __init__(self, base_dir: str = "~/.xone/runs"):
        """
