...
Maps XoneAI knowledge operations to MCP tools.
"""
...
def register_knowledge_tools() -> None:
    ...
    @register_tool("xoneai.knowledge.add")
    def knowledge_add(
        source: str,
    ...
    @register_tool("xoneai.knowledge.query")
    def knowledge_query(
        query: str,
        limit: int = 5,
    ) -> str:
    ...
    @register_tool("xoneai.knowledge.list")
    ...
    @register_tool("xoneai.knowledge.clear")
    ...
    @register_tool("xoneai.knowledge.stats")
