...
Maps XoneAI memory operations to MCP tools.
"""
...
def register_memory_tools() -> None:
    ...
    @register_tool("xoneai.memory.show")
    ...
    @register_tool("xoneai.memory.add")
    def memory_add(
        content: str,
    ...
    @register_tool("xoneai.memory.search")
    def memory_search(
        query: str,
        limit: int = 10,
    ) -> str:
    ...
    @register_tool("xoneai.memory.clear")
    ...
    @register_tool("xoneai.memory.sessions")
