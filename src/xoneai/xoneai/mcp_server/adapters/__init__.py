...
Adapters that convert XoneAI capabilities, CLI features, and agent operations
...
def __getattr__(name):
    ...
    elif name == "register_xoneai_tools":
        from .tools_bridge import register_xoneai_tools
        return register_xoneai_tools
