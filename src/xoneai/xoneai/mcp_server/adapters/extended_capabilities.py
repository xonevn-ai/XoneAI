...
Maps additional XoneAI capabilities to MCP tools:
- Videos
- Files
- Batches
- Vector Stores
...
def register_extended_capability_tools() -> None:
    ...
    # Video tools
    @register_tool("xoneai.videos.generate")
    def videos_generate(
        prompt: str,
        ...
        try:
            from xoneai.capabilities import video_generate
    ...
    # File tools
    @register_tool("xoneai.files.create")
    def files_create(
        file_path: str,
        ...
        """Upload a file."""
        try:
            from xoneai.capabilities import file_create
    ...
    @register_tool("xoneai.files.list")
    def files_list(purpose: Optional[str] = None) -> str:
        """List uploaded files."""
        try:
            from xoneai.capabilities import file_list
    ...
    @register_tool("xoneai.files.retrieve")
    def files_retrieve(file_id: str) -> str:
        """Retrieve file metadata."""
        try:
            from xoneai.capabilities import file_retrieve
    ...
    @register_tool("xoneai.files.delete")
    def files_delete(file_id: str) -> str:
        """Delete a file."""
        try:
            from xoneai.capabilities import file_delete
    ...
    @register_tool("xoneai.files.content")
    def files_content(file_id: str) -> str:
        """Get file content."""
        try:
            from xoneai.capabilities import file_content
    ...
    # Batch tools
    @register_tool("xoneai.batches.create")
    def batches_create(
        input_file_id: str,
        ...
        try:
            from xoneai.capabilities import batch_create
            result = batch_create(
    ...
    @register_tool("xoneai.batches.list")
    ...
    @register_tool("xoneai.batches.retrieve")
    def batches_retrieve(batch_id: str) -> str:
        """Retrieve batch job status."""
        try:
            from xoneai.capabilities import batch_retrieve
    ...
    @register_tool("xoneai.batches.cancel")
    def batches_cancel(batch_id: str) -> str:
        """Cancel a batch job."""
        try:
            from xoneai.capabilities import batch_cancel
    ...
    # Vector Store tools
    @register_tool("xoneai.vector_stores.create")
    def vector_stores_create(
        ...
        try:
            from xoneai.capabilities import vector_store_create
    ...
    @register_tool("xoneai.vector_stores.search")
    def vector_stores_search(
        ...
        try:
            from xoneai.capabilities import vector_store_search
    ...
    @register_tool("xoneai.vector_stores.file_create")
    ...
    @register_tool("xoneai.vector_stores.file_list")
    def vector_stores_file_list(vector_store_id: str) -> str:
        """List files in a vector store."""
        try:
            from xoneai.capabilities import vector_store_file_list
    ...
    def ocr_extract(
        ...
        try:
            from xoneai.capabilities import ocr
    ...
    # Assistant tools
    @register_tool("xoneai.assistants.create")
    def assistants_create(
        ...
        try:
            from xoneai.capabilities import assistant_create
    ...
    @register_tool("xoneai.assistants.list")
    def assistants_list() -> str:
        """List assistants."""
        try:
            from xoneai.capabilities import assistant_list
    ...
    # Fine-tuning tools
    @register_tool("xoneai.fine_tuning.create")
    def fine_tuning_create(
        ...
        try:
            from xoneai.capabilities import fine_tuning_create
    ...
    @register_tool("xoneai.fine_tuning.list")
    def fine_tuning_list() -> str:
        """List fine-tuning jobs."""
        try:
            from xoneai.capabilities import fine_tuning_list
    ...
    def a2a_send(
        ...
        try:
            from xoneai.capabilities import a2a_send
            result = a2a_send(
                agent_url=agent_url,
                message=message,
                task_id=task_id,
    ...
    # Container tools
    @register_tool("xoneai.containers.create")
    def containers_create(
        ...
        try:
            from xoneai.capabilities import container_create
    ...
    @register_tool("xoneai.containers.file_read")
    ...
    @register_tool("xoneai.containers.file_write")
    def containers_file_write(
        ...
        try:
            from xoneai.capabilities import container_file_write
    ...
    # Skills tools
    @register_tool("xoneai.skills.list")
    def skills_list() -> str:
        """List available skills."""
        try:
            from xoneai.capabilities import skill_list
            result = skill_list()
            return str(result)
        except ImportError:
    ...
    @register_tool("xoneai.skills.load")
    def skills_load(skill_path: str) -> str:
        """Load a skill from path."""
        try:
            from xoneai.capabilities import skill_load
    ...
    # Realtime tools
    @register_tool("xoneai.realtime.connect")
    ...
    @register_tool("xoneai.realtime.send")
    def realtime_send(
        session_id: str,
        message: str,
    ) -> str:
        ...
        try:
            from xoneai.capabilities import realtime_send
