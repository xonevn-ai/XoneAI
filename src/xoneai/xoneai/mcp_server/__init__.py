"""
XoneAI MCP Server Module

Exposes XoneAI capabilities as an MCP server that any MCP client can connect to.
...
Usage:
    ...
    # Programmatic usage
    from xoneai.mcp_server import MCPServer, RecipeMCPAdapter
