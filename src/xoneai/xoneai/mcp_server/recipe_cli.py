...
class RecipeMCPCLI:
    ...
    def _print_help(self) -> None:
        """Print help message."""
        help_text = """
[bold cyan]XoneAI Recipe MCP Server (Protocol Version 2025-11-25)[/bold cyan]

Serve XoneAI recipes as MCP servers for Claude Desktop, Cursor, Windsurf, and other MCP clients.
...
[bold]Examples:[/bold]
  ...
  xoneai mcp list-recipes

  # Validate recipe MCP compatibility
  xoneai mcp validate-recipe support-reply

  # Inspect recipe tools/resources/prompts
  xoneai mcp inspect-recipe support-reply --tools
...
"""
    ...
    def cmd_serve_recipe(self, args: List[str]) -> int:
        ...
        parser = argparse.ArgumentParser(prog="xoneai mcp serve-recipe")
    ...
    def cmd_list_recipes(self, args: List[str]) -> int:
        """List available recipes."""
        parser = argparse.ArgumentParser(prog="xoneai mcp list-recipes")
    ...
    def cmd_validate_recipe(self, args: List[str]) -> int:
        """Validate recipe MCP compatibility."""
        parser = argparse.ArgumentParser(prog="xoneai mcp validate-recipe")
    ...
    def cmd_inspect_recipe(self, args: List[str]) -> int:
        ...
        parser = argparse.ArgumentParser(prog="xoneai mcp inspect-recipe")
    ...
    def cmd_config_generate_recipe(self, args: List[str]) -> int:
        ...
        parser = argparse.ArgumentParser(prog="xoneai mcp config-generate-recipe")
    ...
    def cmd_auth(self, args: List[str]) -> int:
        ...
        if not args:
            print("Usage: xoneai mcp auth <subcommand>")
    ...
    def _auth_generate_key(self, args: List[str]) -> int:
        """Generate API key."""
        parser = argparse.ArgumentParser(prog="xoneai mcp auth generate-key")
    ...
    def _auth_validate(self, args: List[str]) -> int:
        """Validate API key."""
        parser = argparse.ArgumentParser(prog="xoneai mcp auth validate")
    ...
    def _auth_oidc_discover(self, args: List[str]) -> int:
        ...
        parser = argparse.ArgumentParser(prog="xoneai mcp auth oidc-discover")
    ...
    def cmd_tasks(self, args: List[str]) -> int:
        ...
        if not args:
            print("Usage: xoneai mcp tasks <subcommand>")
    ...
    def _tasks_list(self, args: List[str]) -> int:
        """List tasks."""
        parser = argparse.ArgumentParser(prog="xoneai mcp tasks list")
    ...
    def _tasks_get(self, args: List[str]) -> int:
        """Get task details."""
        parser = argparse.ArgumentParser(prog="xoneai mcp tasks get")
    ...
    def _tasks_cancel(self, args: List[str]) -> int:
        """Cancel a task."""
        parser = argparse.ArgumentParser(prog="xoneai mcp tasks cancel")
        parser.add_argument("task_id", help="Task ID")
        parser.add_argument("--json", action="store_true")
