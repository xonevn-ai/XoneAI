...
Provides versioned discovery document format for all XoneAI serve features.
...
class DiscoveryDocument:
    """
    Unified discovery document for XoneAI servers.
    
    This document is served at /__xoneai__/discovery and provides
    a consistent interface for discovering endpoints across all provider types.
    """
    schema_version: str = SCHEMA_VERSION
    server_name: str = "xoneai"
