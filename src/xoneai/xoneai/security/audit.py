"""
Audit log hook for XoneAI agents.

Records every tool call to an append-only JSONL file.
Integrates with XoneAI's AFTER_TOOL hook event.
...
_DEFAULT_LOG_PATH = os.path.expanduser("~/.xoneai/audit.jsonl")
...
class AuditLogHook:
    ...
    Example:
        >>> audit = AuditLogHook(log_path="~/.xoneai/audit.jsonl")
    ...
    def _write(self, entry: dict) -> None:
        ...
        try:
            ...
            logger.error("[xoneai.security.audit] Failed to write audit log: %s", e)
