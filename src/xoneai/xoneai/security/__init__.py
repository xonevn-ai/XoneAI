"""
xoneai.security — Agent security utilities for XoneAI.
...
Usage (selective):
    from xoneai.security import enable_injection_defense, enable_audit_log
...
def enable_audit_log(
    ...
    Args:
        log_path: Path to the audit log file.
                  Defaults to ~/.xoneai/audit.jsonl.
    ...
    Example:
        >>> from xoneai.security import enable_audit_log
        >>> enable_audit_log()
    """
    from .audit import AuditLogHook
    from xoneaiagents.hooks import add_hook
...
def enable_security(
    ...
    Args:
        log_path: Audit log path (default: ~/.xoneai/audit.jsonl).
