...
Usage:
    from xoneai.recipe.server import create_app, run_server
    
    # Run server
    run_server(host="127.0.0.1", port=7777)
    
    # Or get ASGI app for custom deployment
    app = create_app(registry_path="~/.xone/registry")
"""
...
class RegistryServer:
    ...
    def _handle_publish(
        ...
        **kwargs,
        ...
        with tempfile.NamedTemporaryFile(suffix=".xone", delete=False) as tmp:
