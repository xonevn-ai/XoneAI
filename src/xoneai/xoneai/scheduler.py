"""
DEPRECATED: This module is deprecated. Use xoneai.scheduler instead.

This file is kept for backward compatibility only.
All new code should import from xoneai.scheduler.
"""
...
warnings.warn(
    "xoneai.scheduler module (root level) is deprecated. "
    "Use 'from xoneai.scheduler import ...' instead.",
    DeprecationWarning,
    stacklevel=2
)
