"""
Configuration handling for XoneAI persistence layer.
...
ENV_VARS = {
    # Conversation stores
    "conversation_store": "XONEAI_CONVERSATION_STORE",
    "conversation_url": "XONEAI_CONVERSATION_URL",
    # Knowledge stores
    "knowledge_store": "XONEAI_KNOWLEDGE_STORE",
    "knowledge_url": "XONEAI_KNOWLEDGE_URL",
    # State stores
    "state_store": "XONEAI_STATE_STORE",
    "state_url": "XONEAI_STATE_URL",
    # Common
    "session_id": "XONEAI_SESSION_ID",
    "user_id": "XONEAI_USER_ID",
    # PostgreSQL
...
class PersistenceConfig:
    """
    Configuration for XoneAI persistence layer.
    
    Example:
        config = PersistenceConfig(
            conversation_store="postgres",
            conversation_url="postgresql://localhost:5432/xoneai",
