...
Provides wrapper functions to add persistence capabilities to XoneAI agents
...
def wrap_agent_with_persistence(
    ...
    Example:
        from xoneai.persistence import PersistenceOrchestrator
        from xoneai.persistence.hooks import wrap_agent_with_persistence
...
class PersistentAgent:
    ...
    Example:
        from xoneai.persistence import PersistenceOrchestrator
        from xoneai.persistence.hooks import PersistentAgent
        from xoneaiagents import Agent
...
def create_persistent_session(
    ...
    Example:
        from xoneai.persistence import PersistenceOrchestrator
        from xoneai.persistence.hooks import create_persistent_session
        from xoneaiagents import Agent
