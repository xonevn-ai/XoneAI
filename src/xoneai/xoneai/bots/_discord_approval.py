"""
Discord Approval Backend for XoneAI Agents.
...
class DiscordApproval:
    ...
    Satisfies :class:`xoneaiagents.approval.protocols.ApprovalProtocol`.
    ...
    def __init__(
        ...
        # Optional: set XONEAI_DISCORD_SSL_VERIFY=false to skip SSL verify
        # (e.g. corporate proxy / CA issues)
        _v = os.environ.get("XONEAI_DISCORD_SSL_VERIFY", "true").lower()
