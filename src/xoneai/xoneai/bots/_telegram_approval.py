"""
Telegram Approval Backend for XoneAI Agents.
...
class TelegramApproval:
    ...
    def __init__(
        ...
        # Optional: set XONEAI_TELEGRAM_SSL_VERIFY=false to skip SSL verify
        # (e.g. corporate proxy / CA issues)
        _v = os.environ.get("XONEAI_TELEGRAM_SSL_VERIFY", "true").lower()
