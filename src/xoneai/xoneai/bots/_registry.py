"""
Platform registry for XoneAI BotOS.
...
_BUILTIN_PLATFORMS: Dict[str, tuple] = {
    "telegram": ("xoneai.bots.telegram", "TelegramBot"),
    "discord": ("xoneai.bots.discord", "DiscordBot"),
    "slack": ("xoneai.bots.slack", "SlackBot"),
    "whatsapp": ("xoneai.bots.whatsapp", "WhatsAppBot"),
}
