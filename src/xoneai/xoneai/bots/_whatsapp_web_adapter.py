...
DEFAULT_CREDS_DIR = os.path.join(str(Path.home()), ".xoneai", "whatsapp")
...
class WhatsAppWebAdapter:
    ...
    rest of XoneAI is shielded from neonize version changes.
    ...
    async def connect(self) -> None:
        ...
        try:
            ...
            raise ImportError(
                ...
                "Install with: pip install 'xoneai[bot-whatsapp-web]' "
