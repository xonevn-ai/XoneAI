"""
Telegram Bot implementation for XoneAI.
...
from xoneai.bots._protocol_mixin import ChatCommandMixin, MessageHookMixin
from xoneaiagents.bots import (
    BotConfig,
    BotMessage,
    BotUser,
    BotChannel,
...
class TelegramBot(ChatCommandMixin, MessageHookMixin):
    """Telegram bot runtime for XoneAI agents.
