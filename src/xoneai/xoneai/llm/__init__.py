"""
LLM Module for XoneAI CLI Wrapper.

This module provides LLM provider registry and utilities for the CLI wrapper.
The core LLM functionality is in xoneaiagents.llm.
"""
...
def embedding(text, model="text-embedding-3-small", **kwargs):
    ...
    .. deprecated::
        Use `from xoneai import embed` or `from xoneai.capabilities import embed` instead.
    ...
    Note:
        Requires litellm. Install with: pip install xoneai[llm]
    """
    import warnings
    warnings.warn(
        "xoneai.llm.embedding() is deprecated. "
        "Use 'from xoneai import embed' or 'from xoneai.capabilities import embed' instead. "
    ...
    try:
        ...
        raise ImportError(
            ...
            "Install with: pip install xoneai[llm] or pip install litellm"
        )
