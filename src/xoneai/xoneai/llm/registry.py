...
Example:
    from xoneai.llm import register_llm_provider, create_llm_provider
...
def _register_builtin_providers(registry: LLMProviderRegistry) -> None:
    ...
    """
    # Note: In Python, the actual LLM providers are in xoneaiagents.llm
...
def register_llm_provider(
    ...
    *,
    ...
    Example:
        from xoneai.llm import register_llm_provider
