"""
Agent Scheduler for XoneAI - Run agents periodically 24/7.

This module provides scheduling capabilities for running XoneAI agents
...
Example:
    ...
    from xoneai_agents import Agent
...
class XoneAgentExecutor(AgentExecutorInterface):
    """Executor for XoneAI agents."""
    
    def __init__(self, agent):
        """
        Initialize executor with a XoneAI agent.
...
class AgentScheduler:
    """
    Scheduler for running XoneAI agents periodically.
    ...
    def __init__(
        ...
        self._thread = None
        self._executor = XoneAgentExecutor(agent)
