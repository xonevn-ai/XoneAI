"""
Base components for XoneAI Scheduler.
...
- XoneAgentExecutor: Executor for XoneAI agents
"""
...
class XoneAgentExecutor(ExecutorInterface):
    ...
    def __init__(self, agent):
        ...
        Args:
            agent: XoneAI Agent instance (must have start() method)
        """
        self.agent = agent
