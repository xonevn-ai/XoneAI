"""
systemd service management for XoneAI bots (Linux).
...
def _generate_unit(config_path: str) -> str:
    ...
    return f"""[Unit]
Description=XoneAI Bot Service
After=network.target

[Service]
Type=simple
WorkingDirectory={working_dir}
ExecStart={python} -m xoneai bot start --config {abs_config}
Restart=always
RestartSec=5
