"""
Chainlit compatibility shim for XoneAI.
...
Usage:
    from xoneai.ui.chainlit_compat import get_expiry_seconds, BaseStorageClient
"""
...
class LocalFileStorageClient:
    ...
    def __init__(self, storage_dir: Optional[str] = None):
        ...
        if storage_dir:
            ...
            chainlit_root = os.environ.get("CHAINLIT_APP_ROOT", os.path.join(os.path.expanduser("~"), ".xone"))
