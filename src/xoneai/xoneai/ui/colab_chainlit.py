...
from xoneai.ui.colab import ui_run_xoneai, load_tools_from_tools_py
from xoneai.ui.callbacks import callback, trigger_callback
...
async def main(message: cl.Message):
    ...
    try:
        ...
        await cl.Message(
            content="Using Running XoneAI Agents...",
            author="System"
        ).send()

        # Run XoneAI with the message content as the topic
