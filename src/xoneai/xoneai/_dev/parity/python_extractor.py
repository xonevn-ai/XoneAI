"""
Python Feature Extractor for XoneAI SDK.

Extracts features from xoneaiagents package using AST analysis.
...
class PythonFeatureExtractor:
    ...
    def extract(self) -> PythonFeatures:
        ...
        # Extract from xoneaiagents __init__.py
    ...
    def _categorize(self, module_path: str) -> str:
        ...
        # Remove 'xoneaiagents.' prefix
        if module_path.startswith('xoneaiagents.'):
            module_path = module_path[len('xoneaiagents.'):]
