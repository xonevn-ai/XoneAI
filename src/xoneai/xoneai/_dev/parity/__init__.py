"""
Feature Parity Tracker for XoneAI SDKs.
...
Usage:
    python -m xoneai._dev.parity.generator --write
    python -m xoneai._dev.parity.generator --check
    
Documentation Parity:
    python -m xoneai._dev.parity.docs_generator --write
    python -m xoneai._dev.parity.docs_generator --check
"""
