"""
Rust Feature Extractor for XoneAI SDK.

Extracts features from xoneai-rust package using regex-based analysis.
"""
...
class RustFeatureExtractor:
    """
    Extracts features from xoneai-rust package using regex analysis.
    ...
    def __init__(self, repo_root: Optional[Path] = None):
        ...
        self.rust_pkg = self.repo_root / "src" / "xoneai-rust" / "xoneai"
