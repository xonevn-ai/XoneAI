...
DRY: Reuses BaseLLMGrader from xoneaiagents.eval for LLM-as-judge logic.
"""
...
"""
    ...
    def __init__(
        ...
        self.temperature = temperature
        self.max_tokens = max_tokens
        self.reports_dir = reports_dir or Path.home() / ".xone" / "judge_reports"
    ...
    def _judge_agent(
        ...
        if self.chunked:
            ...
            try:
                ...
                # Fallback to simple size check if xoneaiagents not available
                use_chunked = total_content_size > self.chunk_size
