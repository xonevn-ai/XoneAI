...
from xoneaiagents.storage.base import list_json_sessions, cleanup_old_sessions as _cleanup_old_sessions


DEFAULT_TRACES_DIR = "~/.xone/traces"
...
def list_traces(
    ...
    Args:
        traces_dir: Directory to search (default: ~/.xone/traces)
...
def get_trace_path(session_id: str, traces_dir: Optional[Path] = None) -> Path:
    ...
    Args:
        ...
        traces_dir: Directory for traces (default: ~/.xone/traces)
...
def cleanup_old_traces(
    ...
    Args:
        traces_dir: Directory to clean (default: ~/.xone/traces)
