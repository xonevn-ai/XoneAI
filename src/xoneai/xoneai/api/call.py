...
SYSTEM_MESSAGE = (
    ...
    "Start your conversation by saying 'Hi! I'm Xone AI. How can I help you today?'"
)
VOICE = 'alloy'
LOG_EVENT_TYPES = [
...
async def index_page():
    ...
    <html>
        <head>
            <title>Xone AI Call Server</title>
        </head>
        <body>
            <h1>Xone AI Call Server is running!</h1>
        </body>
    </html>
    """
...
def setup_public_url(port):
    ...
    print(f"Xone AI Voice URL: {public_url}")
    return public_url
...
def run_server(port: int, use_public: bool = False):
    ...
    if use_public:
        ...
        print(f"Starting Xone AI Call Server on http://localhost:{port}")
    uvicorn.run(app, host="0.0.0.0", port=port, log_level="warning")

def main(args=None):
    """Run the Xone AI Call Server."""
    parser = argparse.ArgumentParser(description="Run the Xone AI Call Server.")
