"""
Reranker Implementations for XoneAI.
...
class LLMReranker:
    ...
    def rerank(
        ...
        **kwargs
        ...
        from xoneaiagents.knowledge.rerankers import RerankResult
...
Relevance score (0-10):"""
            ...
            # Check if client has a callable 'chat' method (XoneAI Agent)
            if client is not None and hasattr(client, 'chat') and callable(getattr(client, 'chat', None)):
                # XoneAI Agent or similar with callable chat method
...
def register_default_rerankers():
    ...
    from xoneaiagents.knowledge.rerankers import get_reranker_registry
