"""
Vector Store Adapters for XoneAI.
...
class ChromaVectorStore:
    ...
    def __init__(
        ...
        self.persist_directory = persist_directory or self.config.get("path", ".xone/chroma")
    ...
    def add(
        ...
        if metadatas is None:
            metadatas = [{"_source": "xoneai"} for _ in texts]
        else:
            # Ensure no empty dicts - add placeholder if empty
            metadatas = [
                m if m else {"_source": "xoneai"} 
                for m in metadatas
            ]
    ...
    def query(
        ...
        from xoneaiagents.knowledge.vector_store import VectorRecord
...
class PineconeVectorStore:
    ...
    def __init__(
        ...
        self.index_name = index_name or self.config.get("index_name", "xoneai")
...
def register_default_vector_stores():
    ...
    from xoneaiagents.knowledge.vector_store import get_vector_store_registry
