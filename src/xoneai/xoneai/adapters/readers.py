...
class TextReader:
    ...
    def load(
        ...
        *, 
        ...
        """Load a text file."""
        from xoneaiagents.knowledge.readers import Document
...
class DirectoryReader:
    ...
    def load(
        ...
        *, 
        ...
        from xoneaiagents.knowledge.readers import get_reader_registry
...
class AutoReader:
    ...
    def load(
        ...
        *, 
        ...
        from xoneaiagents.knowledge.readers import get_reader_registry, detect_source_kind
