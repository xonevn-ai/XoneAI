...
class TemplateDiscovery:
    ...
    1. User custom directory (~/.xone/templates)
    2. XDG config directory (~/.config/xone/templates)
    3. Project local directory (./.xone/templates)
    ...
    DEFAULT_SEARCH_PATHS = [
        ("~/.xone/templates", "custom", 1),
        ("~/.config/xone/templates", "custom", 2),
        ("./.xone/templates", "project", 3),
    ]
