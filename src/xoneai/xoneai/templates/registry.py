...
class TemplateRegistry:
    ...
    def _make_request(
        ...
        all_headers["User-Agent"] = "XoneAI-Templates/1.0"
    ...
    def fetch_github_template(
        ...
        temp_dir = Path(tempfile.mkdtemp(prefix="xone_template_"))
    ...
    def list_remote_templates(
        ...
        Args:
            owner: Repository owner (default: xonevn-ai)
