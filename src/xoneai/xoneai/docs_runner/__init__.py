"""
Docs Code Execution System for XoneAI.
...
Usage:
    xoneai docs run                    # Run all Python blocks
    xoneai docs run --docs-path /path  # Custom docs path
    xoneai docs list                   # List discovered blocks
