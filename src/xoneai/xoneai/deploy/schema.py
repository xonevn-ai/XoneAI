...
"""
  ...
  cloud:
    provider: aws
    region: us-east-1
    service_name: xoneai-service
    cpu: "256"
    memory: "512"
    min_instances: 1
    max_instances: 10
    # image: your-registry/xoneai-app:latest
    # cluster_name: xoneai-cluster
"""
  ...
  cloud:
    ...
    region: eastus
    service_name: xoneai-service
    resource_group: xoneai-rg
    subscription_id: your-subscription-id
    cpu: "0.5"
    memory: "1.0"
    min_instances: 1
    max_instances: 10
    # image: your-registry.azurecr.io/xoneai-app:latest
"""
  ...
  cloud:
    ...
    min_instances: 1
    max_instances: 10
    # image: gcr.io/your-project-id/xoneai-app:latest
"""
        else:
            deploy_yaml = """deploy:
  type: cloud
