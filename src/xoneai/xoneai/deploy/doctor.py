    ...
    try:
        ...
        if config:
            ...
            return DoctorCheckResult(
                ...
                fix_suggestion="Add deploy configuration to agents.yaml or run: xoneai deploy init"
            )
    except FileNotFoundError:
        return DoctorCheckResult(
            name="agents.yaml",
            ...
            fix_suggestion="Create agents.yaml or run: xoneai deploy init"
        )
        ...
        return DoctorCheckResult(
            ...
            fix_suggestion="Fix deploy configuration in agents.yaml or run: xoneai deploy validate"
        )
    except Exception as e:
        return DoctorCheckResult(
            name="agents.yaml",
