...
DRY: Follows the same pattern as xoneaiagents.memory.learn.stores.BaseStore.
"""
...
# DRY: Import base classes from xoneaiagents.storage
from xoneaiagents.storage.models import BaseSessionInfo
from xoneaiagents.storage.base import BaseJSONStore, list_json_sessions, cleanup_old_sessions as _cleanup_old_sessions

if TYPE_CHECKING:
    from xoneaiagents.storage.protocols import StorageBackendProtocol

from .models import TrainingIteration, TrainingReport, TrainingScenario


DEFAULT_STORAGE_DIR = "~/.xone/train"
...
class TrainingStorage:
    ...
    def __init__(
        ...
        Args:
            ...
            storage_dir: Directory for storage files (default: ~/.xone/train)
...
def list_training_sessions(
    ...
    DRY: Uses list_json_sessions from xoneaiagents.storage.base.
    
    Args:
        storage_dir: Directory to search (default: ~/.xone/train)
...
def cleanup_old_sessions(
    ...
    DRY: Uses cleanup_old_sessions from xoneaiagents.storage.base.
    
    Args:
        storage_dir: Directory to clean (default: ~/.xone/train)
