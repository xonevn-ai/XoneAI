"""
Subprocess Sandbox implementation for XoneAI.
...
from xoneaiagents.sandbox import (
    SandboxConfig,
    SandboxResult,
    SandboxStatus,
    ResourceLimits,
...
class SubprocessSandbox:
    ...
    Example:
        from xoneai.sandbox import SubprocessSandbox
    ...
    async def start(self) -> None:
        ...
        self._temp_dir = tempfile.mkdtemp(prefix="xoneai_sandbox_")
