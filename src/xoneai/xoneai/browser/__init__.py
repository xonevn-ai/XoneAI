"""Browser automation package for XoneAI.

Provides a bridge server for Chrome Extension ↔ XoneAI Agent communication.

Example:
    # Start the browser server
    xoneai browser start --port 8765
    ...
    from xoneai.browser import CDPBrowserAgent, run_hybrid
