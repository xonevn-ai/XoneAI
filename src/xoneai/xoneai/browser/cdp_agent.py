...
without requiring the XoneAI Chrome extension. Useful for:
- Headless automation
- Environments where extensions can't be loaded
- Simpler deployment scenarios

Usage:
    xoneai browser run "Search for AI" --engine cdp
"""
...
logger = logging.getLogger("xoneai.browser.cdp_agent")
...
class CDPBrowserAgent:
    ...
    Example:
        ...
        await agent.run("Search for xoneai on Google")
