...
Bridges the Chrome Extension to XoneAI agents for browser automation.
"""
...
logger = logging.getLogger("xoneai.browser.server")
...
class BrowserServer:
    ...
    Handles communication between Chrome Extension and XoneAI agents.
    ...
    async def _handle_connection(self, websocket):
        ...
        await websocket.send_json({
            "type": "status",
            "status": "connected",
            "message": "Connected to XoneAI Browser Server",
            "session_id": "",
        })
    ...
    def start(self):
        ...
        logger.info(f"Starting XoneAI Browser Server on {self.host}:{self.port}")
        print(f"\n🌐 XoneAI Browser Server")
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="XoneAI Browser Server")
