...
CLI:
    xoneai browser launch "goal" --profile         # Timing summary
    xoneai browser launch "goal" --deep-profile    # cProfile trace
"""
...
logger = logging.getLogger("xoneai.browser.profiling")
