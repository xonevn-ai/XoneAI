...
Manifests are stored in .xone/features/{slug}.yaml
"""
...
class ManifestStorage:
    ...
    def __init__(self, manifest_dir: Optional[Path] = None):
        self.manifest_dir = manifest_dir or Path(".xone/features")
    ...
    def create_default(self, slug: FeatureSlug, 
        ...
        return FeatureManifest(
            slug=slug,
            name=name,
            description=f"{name} feature for XoneAI",
            status="stable",
...
MANIFEST_SCHEMA = {
    ...
    "properties": {
        ...
        "min_version": {
            "type": "string",
            "pattern": "^\\d+\\.\\d+\\.\\d+$",
            "description": "Minimum XoneAI version required",
        },
        "tags": {
            "type": "array",
            "items": {"type": "string"},
