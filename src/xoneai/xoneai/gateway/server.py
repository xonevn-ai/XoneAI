"""
WebSocket Gateway Server for XoneAI.
...
from xoneaiagents.gateway import (
    GatewayConfig,
    GatewayEvent,
    GatewayMessage,
    EventType,
...
class WebSocketGateway:
    ...
    Example:
        from xoneai.gateway import WebSocketGateway
        from xoneaiagents import Agent
    ...
    async def start(self) -> None:
        ...
        try:
            ...
            raise ImportError(
                ...
                "Install with: pip install xoneai[api]"
            )
    ...
    async def _start_telegram_bot_polling(self, name: str, bot: Any) -> None:
        ...
        from xoneaiagents.bots import BotUser
