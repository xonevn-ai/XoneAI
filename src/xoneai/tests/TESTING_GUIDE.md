# XoneAI Testing Guide

This guide explains the complete testing structure for XoneAI, including both mock and real tests.
...
```bash
# AutoGen with actual xoneai.run() execution
python tests/test_runner.py --pattern full-autogen

# CrewAI with actual xoneai.run() execution  
...
- **Full Execution Tests**: Complete workflow with xoneai.run()
