...
class TestClientConnection:
    ...
    def test_client_connection_creation(self):
        ...
        from xoneai.browser.server import ClientConnection
...
class TestMessageProcessing:
    ...
    async def test_process_ping_message(self):
        ...
        from xoneai.browser.server import BrowserServer, ClientConnection
...
class TestIntegration:
    ...
    def test_server_session_agent_integration(self):
        ...
        from xoneai.browser.agent import BrowserAgent
