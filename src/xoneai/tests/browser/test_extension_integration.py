...
from xoneai.browser.cli import app
...
class TestEngineSelectionLogic:
    ...
    async def test_auto_mode_checks_extension_availability(self):
        ...
        from xoneai.browser.server import run_browser_agent_with_progress
...
class TestCDPFallback:
    ...
    def test_cdp_agent_exists(self):
        ...
        from xoneai.browser.cdp_agent import CDPBrowserAgent, run_cdp_only
    ...
    def test_run_cdp_only_signature(self):
        ...
        import inspect
        from xoneai.browser.cdp_agent import run_cdp_only
...
class TestImportCompatibility:
    ...
    def test_run_browser_agent_still_exists(self):
        ...
        from xoneai.browser.server import run_browser_agent
    ...
    def test_browser_server_unchanged(self):
        ...
        from xoneai.browser.server import BrowserServer
    ...
    def test_cdp_agent_unchanged(self):
        ...
        from xoneai.browser.cdp_agent import CDPBrowserAgent
