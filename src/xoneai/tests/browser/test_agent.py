...
from xoneai.browser.agent import BrowserAgent, BROWSER_AGENT_SYSTEM_PROMPT
...
class TestBrowserAgentWithMock:
    """Tests for BrowserAgent with mocked XoneAI agent."""
    
    @patch("xoneai.browser.agent.BrowserAgent._ensure_agent")
