...
class TestRateLimiting:
    ...
    def test_rate_limit_middleware_returns_429(self):
        ...
        from xoneai.recipe.serve import create_app
...
class TestRequestSizeLimits:
    ...
    def test_default_size_limit_is_10mb(self):
        ...
        from xoneai.recipe.serve import DEFAULT_MAX_REQUEST_SIZE
...
class TestMetricsEndpoint:
    ...
    def test_metrics_prometheus_format(self):
        ...
        assert "xoneai_http_requests_total" in content
        assert "xoneai_http_request_duration_seconds" in content
...
class TestAgentRecipesIntegration:
    ...
    def test_template_discovery_precedence(self):
        ...
        assert any("xone" in str(p).lower() for p in paths)
