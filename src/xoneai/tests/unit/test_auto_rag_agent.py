...
class TestAutoRagConfig:
    ...
    def test_default_config(self):
        ...
        from xoneaiagents.agents.auto_rag_agent import AutoRagConfig, RetrievalPolicy
    ...
    def test_config_to_dict(self):
        ...
        from xoneaiagents.agents.auto_rag_agent import AutoRagConfig
...
class TestRetrievalPolicy:
    ...
    def test_policy_values(self):
        ...
        from xoneaiagents.agents.auto_rag_agent import RetrievalPolicy
...
class TestAutoRagAgentDecision:
    ...
    def test_needs_retrieval_with_question_mark(self):
        ...
        from xoneaiagents.agents.auto_rag_agent import AutoRagAgent
    ...
    def test_should_retrieve_always_policy(self):
        """Test ALWAYS policy."""
        from xoneaiagents.agents.auto_rag_agent import AutoRagAgent, RetrievalPolicy
...
class TestAutoRagAgentChat:
    ...
    def test_chat_with_retrieval(self):
        ...
        from xoneaiagents.agents.auto_rag_agent import AutoRagAgent
        from xoneaiagents.rag.models import ContextPack, Citation
...
class TestAutoRagAgentExports:
    ...
    def test_export_from_agents_module(self):
        ...
        from xoneaiagents.agents import AutoRagAgent, AutoRagConfig, RetrievalPolicy
    ...
    def test_export_from_top_level(self):
        ...
        from xoneaiagents import AutoRagAgent, AutoRagConfig
