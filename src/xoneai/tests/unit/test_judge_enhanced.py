...
# Add the xoneai package to path for imports
...
class TestRecipeGoalExtraction:
    ...
    def test_extract_recipe_goal_from_yaml(self):
        ...
        from xoneai.replay.judge import _detect_yaml_structure
...
class TestPreviousStepQualityContext:
    ...
    def test_empty_previous_steps(self):
        ...
        from xoneai.replay.judge import ContextEffectivenessJudge
...
class TestEnhancedJudgeReport:
    ...
    def test_report_includes_failure_summary(self):
        ...
        from xoneai.replay.judge import JudgeReport, ContextEffectivenessScore
