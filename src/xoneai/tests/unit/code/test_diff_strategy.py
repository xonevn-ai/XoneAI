"""
Tests for xoneai.code.diff.diff_strategy module.
"""
...
class TestValidateDiffFormat:
    ...
    def test_valid_single_block(self):
        ...
        from xoneai.code.diff.diff_strategy import validate_diff_format
...
class TestParseDiffBlocks:
    ...
    def test_parse_single_block(self):
        ...
        from xoneai.code.diff.diff_strategy import parse_diff_blocks
...
class TestApplySearchReplaceDiff:
    ...
    def test_exact_match_replacement(self):
        ...
        from xoneai.code.diff.diff_strategy import apply_search_replace_diff
...
class TestDiffIntegration:
    ...
    def test_apply_diff_to_file(self):
        ...
        from xoneai.code.tools.apply_diff import apply_diff
