"""
Tests for xoneai.code.utils.file_utils module.
"""
...
class TestAddLineNumbers:
    ...
    def test_add_line_numbers_basic(self):
        ...
        from xoneai.code.utils.file_utils import add_line_numbers
...
class TestStripLineNumbers:
    ...
    def test_strip_line_numbers_basic(self):
        ...
        from xoneai.code.utils.file_utils import strip_line_numbers
...
class TestEveryLineHasLineNumbers:
    ...
    def test_all_lines_have_numbers(self):
        ...
        from xoneai.code.utils.file_utils import every_line_has_line_numbers
...
class TestNormalizeLineEndings:
    ...
    def test_normalize_crlf_to_lf(self):
        ...
        from xoneai.code.utils.file_utils import normalize_line_endings
...
class TestIsBinaryFile:
    ...
    def test_text_file(self):
        ...
        from xoneai.code.utils.file_utils import is_binary_file
...
class TestFileExists:
    ...
    def test_existing_file(self):
        ...
        from xoneai.code.utils.file_utils import file_exists
...
class TestIsPathWithinDirectory:
    ...
    def test_path_within(self):
        ...
        from xoneai.code.utils.file_utils import is_path_within_directory
...
class TestCreateDirectoriesForFile:
    ...
    def test_create_directories(self):
        ...
        from xoneai.code.utils.file_utils import create_directories_for_file
