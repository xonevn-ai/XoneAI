...
from xoneai.mcp_server.cli import MCPServerCLI
...
class TestMCPToolsCLI:
    ...
    @patch("xoneai.mcp_server.cli.MCPServerCLI.cmd_tools_search")
    ...
    @patch("xoneai.mcp_server.cli.MCPServerCLI.cmd_tools_info")
    ...
    @patch("xoneai.mcp_server.cli.MCPServerCLI.cmd_tools_schema")
...
class TestToolsSearchCLI:
    ...
    @patch("xoneai.mcp_server.adapters.register_all_tools")
