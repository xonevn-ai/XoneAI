...
class TestToolResolver:
    ...
    def test_import_tool_resolver(self):
        """ToolResolver should be importable from xoneai."""
    ...
    def test_resolve_builtin_tool_tavily_search(self):
        """Should resolve 'tavily_search' from xoneaiagents.tools."""
        from xoneai.tool_resolver import ToolResolver
        resolver = ToolResolver()
    ...
    def test_resolve_builtin_tool_internet_search(self):
        """Should resolve 'internet_search' from xoneaiagents.tools."""
        from xoneai.tool_resolver import ToolResolver
        resolver = ToolResolver()
    ...
    def test_resolve_builtin_tool_execute_command(self):
        """Should resolve 'execute_command' from xoneaiagents.tools."""
        from xoneai.tool_resolver import ToolResolver
        resolver = ToolResolver()
...
class TestToolResolverXoneAITools:
    """Test xoneai-tools package resolution."""
    
    def test_resolve_from_xoneai_tools_if_installed(self):
        """Should resolve tools from xoneai-tools if installed."""
        from xoneai.tool_resolver import ToolResolver
        resolver = ToolResolver()
        
        # Try to resolve EmailTool (from xoneai-tools)
...
class TestToolResolverPerformance:
    ...
    def test_lazy_loading_no_import_overhead(self):
        ...
        start = time.time()
        from xoneai.tool_resolver import ToolResolver  # noqa: F401
...
class TestConvenienceFunctions:
    ...
    def test_resolve_tool_function(self):
        ...
        from xoneai.tool_resolver import resolve_tool
    ...
    def test_resolve_tools_function(self):
        ...
        from xoneai.tool_resolver import resolve_tools
    ...
    def test_list_available_tools_function(self):
        ...
        from xoneai.tool_resolver import list_available_tools
    ...
    def test_has_tool_function(self):
        ...
        from xoneai.tool_resolver import has_tool
