...
class TestAgentTrainer:
    ...
    def test_create_trainer_with_agent(self):
        ...
        from xoneai.train.agents.orchestrator import AgentTrainer
    ...
    @patch("xoneai.train.agents.orchestrator.TrainingGrader")
    def test_run_llm_mode_single_iteration(self, mock_grader_class):
        """Test running single iteration in LLM mode."""
        from xoneai.train.agents.orchestrator import AgentTrainer
        from xoneai.train.agents.models import TrainingScenario
        from xoneai.train.agents.grader import GradeResult
