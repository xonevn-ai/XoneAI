...
class TestTrainingProfile:
    ...
    def test_training_profile_creation(self):
        ...
        from xoneai.train.agents.models import TrainingProfile
...
class TestGetBestIteration:
    ...
    def test_get_best_iteration_returns_highest_score(self):
        ...
        from xoneai.train.agents.models import TrainingReport, TrainingIteration
    ...
    def test_get_best_iteration_empty_returns_none(self):
        ...
        from xoneai.train.agents.models import TrainingReport
...
class TestApplyTraining:
    ...
    def test_apply_training_registers_hook(self):
        ...
        from xoneai.train.agents.hook import apply_training
        from xoneai.train.agents.models import TrainingProfile
    ...
    def test_apply_training_from_session(self):
        ...
        # Mock storage
        with patch('xoneai.train.agents.hook.TrainingStorage') as MockStorage:
            mock_storage = Mock()
            mock_report = Mock()
            mock_iteration = Mock()
...
class TestRemoveTraining:
    ...
    def test_remove_training_unregisters_hook(self):
        ...
        from xoneai.train.agents.hook import apply_training, remove_training
        from xoneai.train.agents.models import TrainingProfile
...
class TestTrainingHook:
    ...
    def test_training_hook_modifies_prompt(self):
        ...
        from xoneai.train.agents.hook import TrainingHook
        from xoneai.train.agents.models import TrainingProfile
        from xoneaiagents.hooks import BeforeAgentInput
...
class TestCLIApplyCommand:
    ...
    def test_cli_apply_command_exists(self):
        ...
        from xoneai.cli.commands.train import app
...
class TestCLIShowEnhanced:
    ...
    def test_cli_show_displays_iterations(self):
        ...
        # Mock storage
        with patch('xoneai.train.agents.storage.TrainingStorage') as MockStorage:
            mock_storage = Mock()
