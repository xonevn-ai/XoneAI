...
class TestTrainingStorage:
    ...
    def test_save_iteration(self):
        ...
        from xoneai.train.agents.storage import TrainingStorage
        from xoneai.train.agents.models import TrainingIteration
    ...
    def test_save_scenario(self):
        ...
        from xoneai.train.agents.storage import TrainingStorage
        from xoneai.train.agents.models import TrainingScenario
    ...
    def test_list_sessions(self):
        ...
        from xoneai.train.agents.storage import TrainingStorage, list_training_sessions
        from xoneai.train.agents.models import TrainingIteration
