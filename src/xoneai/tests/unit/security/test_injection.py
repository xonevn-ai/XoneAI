"""
TDD tests for xoneai.security.injection module.
...
class TestDetectInstructionPatterns:
    def _detect(self, text):
        from xoneai.security.injection import detect_instruction_patterns
...
class TestDetectAuthorityClaims:
    def _detect(self, text):
        from xoneai.security.injection import detect_authority_claims
...
class TestDetectBoundaryManipulation:
    def _detect(self, text):
        from xoneai.security.injection import detect_boundary_manipulation
...
class TestDetectObfuscation:
    def _detect(self, text):
        from xoneai.security.injection import detect_obfuscation
...
class TestDetectFinancialManipulation:
    def _detect(self, text):
        from xoneai.security.injection import detect_financial_manipulation
...
class TestDetectSelfHarm:
    def _detect(self, text):
        from xoneai.security.injection import detect_self_harm_instructions
...
class TestInjectionDefense:
    def _make(self, **kwargs):
        from xoneai.security.injection import InjectionDefense
    ...
    def test_hook_allows_clean_input(self):
        from xoneaiagents.hooks import BeforeToolInput
        d = self._make()
        hook = d.create_hook()
...
class TestEnableInjectionDefense:
    def test_enable_returns_hook_id(self):
        from xoneai.security import enable_injection_defense
...
class TestEnableSecurity:
    def test_enable_security_returns_dict(self):
        from xoneai.security import enable_security
