...
class TestExternalAgentsHandler:
    ...
    def test_import_external_agents_handler(self):
        ...
        from xoneai.cli.features.external_agents import ExternalAgentsHandler
    ...
    def test_get_integration_claude(self):
        ...
        from xoneai.cli.features.external_agents import ExternalAgentsHandler
        from xoneai.integrations.claude_code import ClaudeCodeIntegration
    ...
    def test_get_integration_gemini(self):
        ...
        from xoneai.cli.features.external_agents import ExternalAgentsHandler
        from xoneai.integrations.gemini_cli import GeminiCLIIntegration
    ...
    def test_get_integration_codex(self):
        ...
        from xoneai.cli.features.external_agents import ExternalAgentsHandler
        from xoneai.integrations.codex_cli import CodexCLIIntegration
    ...
    def test_get_integration_cursor(self):
        ...
        from xoneai.cli.features.external_agents import ExternalAgentsHandler
        from xoneai.integrations.cursor_cli import CursorCLIIntegration
