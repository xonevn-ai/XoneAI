...
class TestContextPack:
    ...
    def test_context_pack_from_dict(self):
        ...
        from xoneaiagents.rag.models import ContextPack
...
class TestRAGRetrieve:
    ...
    def test_retrieve_returns_context_pack(self):
        ...
        from xoneaiagents.rag.models import RAGConfig
...
class TestKnowledgeAddAlias:
    ...
    def test_add_command_exists(self):
        ...
        from xoneai.cli.commands.knowledge import app
    ...
    def test_add_delegates_to_index(self):
        ...
        from xoneai.cli.commands.knowledge import knowledge_add, knowledge_index
