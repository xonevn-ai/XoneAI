...
class TestTelegramApprovalProtocol:
    def test_conforms_to_approval_protocol(self):
        ...
        from xoneai.bots._telegram_approval import TelegramApproval
...
class TestTelegramApprovalInit:
    ...
    def test_ssl_verify_default_true(self, monkeypatch):
        monkeypatch.delenv("XONEAI_TELEGRAM_SSL_VERIFY", raising=False)
        from xoneai.bots._telegram_approval import TelegramApproval
    ...
    def test_ssl_verify_env_false(self, monkeypatch):
        monkeypatch.setenv("XONEAI_TELEGRAM_SSL_VERIFY", "false")
        from xoneai.bots._telegram_approval import TelegramApproval
