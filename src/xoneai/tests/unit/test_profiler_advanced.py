"""
Unit tests for XoneAI Advanced Profiler features.
...
class TestAPICallProfiler:
    ...
    def test_api_call_record(self):
        ...
        from xoneai.profiler import Profiler, APICallRecord
    ...
    def test_api_call_decorator(self):
        ...
        from xoneai.profiler import Profiler, profile_api
...
class TestStreamingProfiler:
    ...
    def test_streaming_record(self):
        ...
        from xoneai.profiler import Profiler, StreamingRecord
    ...
    def test_streaming_tracker(self):
        ...
        from xoneai.profiler import Profiler, StreamingTracker
...
class TestMemoryProfiler:
    ...
    def test_memory_record(self):
        ...
        from xoneai.profiler import Profiler, MemoryRecord
...
class TestCProfileIntegration:
    ...
    def test_cprofile_decorator(self):
        ...
        from xoneai.profiler import profile_detailed
...
class TestLineProfiler:
    ...
    def test_line_profile_decorator(self):
        ...
        from xoneai.profiler import profile_lines, Profiler
...
class TestZeroPerformanceImpact:
    ...
    def test_disabled_no_overhead(self):
        ...
        from xoneai.profiler import Profiler, profile
...
class TestAsyncProfiling:
    ...
    async def test_async_api_call(self):
        ...
        from xoneai.profiler import Profiler, profile_api_async
