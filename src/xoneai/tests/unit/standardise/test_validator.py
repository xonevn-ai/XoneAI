...
from xoneai.standardise.config import StandardiseConfig
from xoneai.standardise.discovery import FeatureDiscovery
from xoneai.standardise.validator import ArtifactValidator
...
class TestArtifactValidator:
    ...
    def test_validate_feature_all_present(self, tmp_path):
        ...
        sdk_docs = docs_root / "sdk" / "xoneaiagents" / "guardrails"
