...
class TestExecutionRequest:
    ...
    def test_create_basic_request(self):
        ...
        from xoneai.cli.execution import ExecutionRequest
...
class TestExecutionResult:
    ...
    def test_create_basic_result(self):
        ...
        from xoneai.cli.execution.result import ExecutionResult
...
class TestProfilerConfig:
    ...
    def test_default_config(self):
        ...
        from xoneai.cli.execution.profiler import ProfilerConfig
...
class TestTimingBreakdown:
    ...
    def test_timing_to_dict(self):
        ...
        from xoneai.cli.execution.profiler import TimingBreakdown
...
class TestProfileReport:
    ...
    def test_report_schema_version(self):
        ...
        from xoneai.cli.execution.profiler import ProfileReport, SCHEMA_VERSION
    ...
    def test_report_timestamp(self):
        ...
        from xoneai.cli.execution.profiler import ProfileReport
    ...
    def test_report_to_dict(self):
        ...
        from xoneai.cli.execution.profiler import (
...
class TestInvocationInfo:
    ...
    def test_version_auto_populated(self):
        ...
        from xoneai.cli.execution.profiler import InvocationInfo
...
class TestCallGraph:
    ...
    def test_edges_property(self):
        """Test edges property."""
        from xoneai.cli.execution.profiler import CallGraph
...
class TestRequestTiming:
    ...
    def test_ttfb_calculation(self):
        ...
        from xoneai.cli.execution.profiler import RequestTiming
...
class TestProfilerIntegration:
    ...
    def test_profiler_creates_report(self):
        ...
        from xoneai.cli.execution.profiler import Profiler, ProfilerConfig
        from xoneai.cli.execution.request import ExecutionRequest
        from xoneai.cli.execution.result import ExecutionResult
        
        # Mock at the profiler level by patching the imported _execute_core
        with patch('xoneai.cli.execution.profiler._execute_core') as mock_exec:
