...
def test_deploy_type_enum():
    ...
    from xoneai.deploy.models import DeployType
...
def test_cloud_provider_enum():
    ...
    from xoneai.deploy.models import CloudProvider
...
def test_api_config_defaults():
    ...
    from xoneai.deploy.models import APIConfig
...
def test_docker_config_defaults():
    ...
    from xoneai.deploy.models import DockerConfig
    
    config = DockerConfig()
    assert config.image_name == "xoneai-app"
...
def test_cloud_config_aws():
    ...
    from xoneai.deploy.models import CloudConfig, CloudProvider
...
def test_deploy_config_api_type():
    ...
    from xoneai.deploy.models import DeployConfig, DeployType, APIConfig
...
def test_deploy_config_docker_type():
    ...
    from xoneai.deploy.models import DeployConfig, DeployType, DockerConfig
...
def test_deploy_config_cloud_type():
    ...
    from xoneai.deploy.models import DeployConfig, DeployType, CloudConfig, CloudProvider
...
def test_deploy_config_validation_docker_auto_defaults():
    ...
    assert config.docker.image_name == "xoneai-app"
...
def test_deploy_result_success():
    ...
    from xoneai.deploy.models import DeployResult
...
def test_agent_config_minimal():
    ...
    from xoneai.deploy.models import AgentConfig
