...
def test_deploy_command_cloud_aws(mock_deploy_class):
    ...
    args.service_name = "xoneai-service"
    args.resource_group = ""
...
@patch('xoneai.deploy.doctor.run_all_checks')
...
@patch('xoneai.deploy.schema.validate_agents_yaml')
