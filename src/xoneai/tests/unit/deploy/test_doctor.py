...
def test_doctor_check_result_success():
    ...
    from xoneai.deploy.doctor import DoctorCheckResult
...
def test_doctor_report():
    ...
    from xoneai.deploy.doctor import DoctorReport, DoctorCheckResult
...
def test_check_python_version_success(mock_run):
    ...
    from xoneai.deploy.doctor import check_python_version
...
def test_check_docker_available_success(mock_run):
    ...
    from xoneai.deploy.doctor import check_docker_available
...
def test_check_port_available_success(mock_socket):
    ...
    from xoneai.deploy.doctor import check_port_available
...
def test_check_aws_cli_success(mock_run):
    ...
    from xoneai.deploy.doctor import check_aws_cli
...
def test_check_azure_cli_success(mock_run):
    ...
    from xoneai.deploy.doctor import check_azure_cli
...
def test_check_gcp_cli_success(mock_run):
    ...
    from xoneai.deploy.doctor import check_gcp_cli
...
@patch('xoneai.deploy.doctor.check_python_version')
@patch('xoneai.deploy.doctor.check_port_available')
def test_run_local_checks(mock_port, mock_python):
    """Test running local checks."""
    from xoneai.deploy.doctor import run_local_checks, DoctorCheckResult
...
@patch('xoneai.deploy.doctor.check_aws_cli')
def test_run_aws_checks(mock_aws):
    """Test running AWS checks."""
    from xoneai.deploy.doctor import run_aws_checks, DoctorCheckResult
...
@patch('xoneai.deploy.doctor.check_azure_cli')
def test_run_azure_checks(mock_azure):
    """Test running Azure checks."""
    from xoneai.deploy.doctor import run_azure_checks, DoctorCheckResult
...
@patch('xoneai.deploy.doctor.check_gcp_cli')
def test_run_gcp_checks(mock_gcp):
    """Test running GCP checks."""
    from xoneai.deploy.doctor import run_gcp_checks, DoctorCheckResult
...
@patch('xoneai.deploy.doctor.run_local_checks')
@patch('xoneai.deploy.doctor.run_aws_checks')
@patch('xoneai.deploy.doctor.run_azure_checks')
@patch('xoneai.deploy.doctor.run_gcp_checks')
def test_run_all_checks(mock_gcp, mock_azure, mock_aws, mock_local):
    """Test running all checks."""
    from xoneai.deploy.doctor import run_all_checks, DoctorReport, DoctorCheckResult
...
@patch('xoneai.deploy.doctor.validate_agents_yaml')
def test_check_agents_yaml_valid(mock_validate):
    """Test agents.yaml validation check success."""
    from xoneai.deploy.doctor import check_agents_yaml
    from xoneai.deploy.models import DeployConfig, DeployType
