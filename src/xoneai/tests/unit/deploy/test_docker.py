...
def test_generate_dockerfile_basic():
    ...
    from xoneai.deploy.docker import generate_dockerfile
    ...
    assert "pip install" in dockerfile and "xoneai" in dockerfile
...
def test_build_docker_image_success(mock_run):
    ...
    from xoneai.deploy.docker import build_docker_image
    from xoneai.deploy.models import DockerConfig
...
def test_run_docker_container_success(mock_run):
    ...
    from xoneai.deploy.docker import run_docker_container
    from xoneai.deploy.models import DockerConfig
...
def test_push_docker_image_success(mock_run):
    ...
    from xoneai.deploy.docker import push_docker_image
    from xoneai.deploy.models import DockerConfig
...
def test_stop_docker_container(mock_run):
    ...
    from xoneai.deploy.docker import stop_docker_container
...
def test_check_docker_installed_success(mock_run):
    ...
    from xoneai.deploy.docker import check_docker_installed
