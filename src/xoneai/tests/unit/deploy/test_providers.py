...
def test_base_provider_interface():
    ...
    from xoneai.deploy.providers.base import BaseProvider
...
def test_aws_provider_doctor_success(mock_run):
    ...
    from xoneai.deploy.providers.aws import AWSProvider
    from xoneai.deploy.models import CloudConfig, CloudProvider
...
def test_azure_provider_doctor_success(mock_run):
    ...
    from xoneai.deploy.providers.azure import AzureProvider
    from xoneai.deploy.models import CloudConfig, CloudProvider
...
def test_gcp_provider_doctor_success(mock_run):
    ...
    from xoneai.deploy.providers.gcp import GCPProvider
    from xoneai.deploy.models import CloudConfig, CloudProvider
...
def test_get_provider_aws():
    ...
    from xoneai.deploy.providers import get_provider
    from xoneai.deploy.providers.aws import AWSProvider
    from xoneai.deploy.models import CloudConfig, CloudProvider
