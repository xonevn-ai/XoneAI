...
def test_start_api_server_success(mock_popen):
    ...
    from xoneai.deploy.api import start_api_server
...
def test_generate_api_server_code():
    ...
    from xoneai.deploy.api import generate_api_server_code
...
def test_check_api_health_success(mock_urlopen):
    ...
    from xoneai.deploy.api import check_api_health
...
def test_stop_api_server():
    ...
    from xoneai.deploy.api import stop_api_server
