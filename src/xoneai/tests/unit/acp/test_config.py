...
class TestACPConfig:
    ...
    def test_allowed_paths_default(self):
        ...
        assert Path.home() / ".xone" in config.allowed_paths
    ...
    def test_from_env(self, monkeypatch):
        ...
        monkeypatch.setenv("XONEAI_WORKSPACE", "/tmp/env_workspace")
        monkeypatch.setenv("XONEAI_AGENT", "test_agent")
        monkeypatch.setenv("XONEAI_MODEL", "gpt-4")
        monkeypatch.setenv("XONEAI_DEBUG", "true")
        monkeypatch.setenv("XONEAI_READ_ONLY", "false")
        monkeypatch.setenv("XONEAI_APPROVAL_MODE", "auto")
