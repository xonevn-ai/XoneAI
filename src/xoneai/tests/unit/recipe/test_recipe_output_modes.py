...
class TestRecipeCoreOutputModes:
    ...
    def test_execute_xoneai_workflow_uses_output(self):
        """_execute_xoneai_workflow should pass output= to Agent."""
        # This test verifies the code structure
        # The actual execution would require mocking
        from xoneai.recipe.core import _execute_xoneai_workflow
        
        # Verify function exists
        assert callable(_execute_xoneai_workflow)
    
    def test_execute_simple_agent_uses_output(self):
        """_execute_simple_agent should pass output= to Agent."""
        from xoneai.recipe.core import _execute_simple_agent
...
class TestRecipeOutputPresets:
    ...
    def test_output_presets_available(self):
        """OUTPUT_PRESETS should be importable from xoneaiagents."""
