...
under the `xoneai serve` namespace.
"""
...
class TestDeprecationWarnings:
    ...
    def test_gateway_deprecation_message_in_docstring(self):
        ...
        from xoneai.cli.features.gateway import handle_gateway_command
    ...
    def test_acp_deprecation_message_in_docstring(self):
        ...
        from xoneai.cli.commands.acp import acp_main
    ...
    def test_ui_deprecation_message_in_docstring(self):
        ...
        from xoneai.cli.commands.ui import ui_main
