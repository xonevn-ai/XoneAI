...
class TestToolGroups:
    ...
    def test_tool_groups_defined(self):
        ...
        from xoneai.cli.features.interactive_tools import TOOL_GROUPS
...
class TestToolConfig:
    ...
    def test_config_from_env_disable_acp(self):
        ...
        with patch.dict(os.environ, {"XONE_TOOLS_DISABLE": "acp"}):
    ...
    def test_config_from_env_disable_lsp(self):
        ...
        with patch.dict(os.environ, {"XONE_TOOLS_DISABLE": "lsp"}):
            config = ToolConfig.from_env()
            assert config.enable_acp is True
    ...
    def test_config_from_env_disable_multiple(self):
        ...
        with patch.dict(os.environ, {"XONE_TOOLS_DISABLE": "acp,lsp"}):
            config = ToolConfig.from_env()
            assert config.enable_acp is False
            assert config.enable_lsp is False
            assert config.enable_basic is True
    ...
    def test_config_from_env_workspace(self):
        ...
        with patch.dict(os.environ, {"XONE_WORKSPACE": "/custom/path"}):
            config = ToolConfig.from_env()
...
class TestResolveToolGroups:
    ...
    def test_resolve_all_enabled(self):
        ...
        from xoneai.cli.features.interactive_tools import resolve_tool_groups, ToolConfig, TOOL_GROUPS
    ...
    def test_resolve_specific_groups(self):
        ...
        from xoneai.cli.features.interactive_tools import resolve_tool_groups, TOOL_GROUPS
...
class TestGetInteractiveTools:
    ...
    def test_get_tools_returns_list(self):
        ...
        from xoneai.cli.features.interactive_tools import get_interactive_tools, ToolConfig
...
class TestMergeToolOverrides:
    ...
    def test_merge_add_tools(self):
        ...
        from xoneai.cli.features.interactive_tools import merge_tool_overrides
...
class TestLazyImports:
    ...
    def test_import_time_fast(self):
        ...
        # Force reimport
        import importlib
        import xoneai.cli.features.interactive_tools as module
