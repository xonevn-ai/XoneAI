"""
Tests for XoneIO - Interactive CLI I/O handler.
"""
...
class TestIOConfig:
    ...
    def test_default_values(self):
        ...
        from xoneai.cli.interactive.xone_io import IOConfig
...
class TestXoneCompleter:
    """Tests for XoneCompleter."""
    
    def test_init_empty(self):
        """Test initialization with no commands."""
        from xoneai.cli.interactive.xone_io import XoneCompleter
    ...
    def test_init_with_commands(self):
        ...
        completer = XoneCompleter(commands=commands)
...
class TestMarkdownStream:
    ...
    def test_init(self):
        """Test initialization."""
        from xoneai.cli.interactive.xone_io import MarkdownStream
...
class TestXoneIO:
    ...
    def test_init_default(self):
        ...
        from xoneai.cli.interactive.xone_io import XoneIO
    ...
    def test_init_with_config(self):
        ...
        from xoneai.cli.interactive.xone_io import XoneIO, IOConfig
        
        config = IOConfig(pretty=False)
        io = XoneIO(config=config)
...
class TestREPLConfig:
    ...
    def test_default_values(self):
        """Test default configuration values."""
        from xoneai.cli.interactive.repl import REPLConfig
...
class TestInteractiveREPL:
    ...
    def test_init_default(self):
        """Test default initialization."""
        from xoneai.cli.interactive.repl import InteractiveREPL
    ...
    def test_init_with_config(self):
        """Test initialization with config."""
        from xoneai.cli.interactive.repl import InteractiveREPL, REPLConfig
...
class TestStartInteractive:
    ...
    def test_function_exists(self):
        ...
        from xoneai.cli.interactive.repl import start_interactive
