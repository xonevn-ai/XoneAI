...
def reset_global_state():
    ...
    from xoneai.cli.app import state, GlobalState
...
class TestTyperApp:
    ...
    def test_app_import(self):
        ...
        from xoneai.cli.app import app
    ...
    def test_help_output(self):
        ...
        assert "XoneAI" in result.output
    ...
    def test_version_flag(self):
        ...
        assert result.exit_code == 0
        assert "XoneAI version" in result.output
...
class TestConfigCommand:
    ...
    def test_config_list(self):
        ...
        from xoneai.cli.commands.config import app
...
class TestTracesCommand:
    ...
    def test_traces_status(self):
        ...
        from xoneai.cli.commands.traces import app
...
class TestEnvCommand:
    ...
    def test_env_view(self):
        ...
        from xoneai.cli.commands.environment import app
...
class TestSessionCommand:
    ...
    def test_session_list(self):
        ...
        from xoneai.cli.commands.session import app
        result = runner.invoke(app, ["list"])
        assert result.exit_code == 0
...
class TestCompletionCommand:
    ...
    def test_completion_bash(self):
        ...
        from xoneai.cli.commands.completion import app
    ...
    def test_completion_zsh(self):
        ...
        assert result.exit_code == 0
        assert "xoneai" in result.output
        assert "compdef" in result.output or "_xoneai" in result.output
...
class TestVersionCommand:
    ...
    def test_version_show(self):
        ...
        from xoneai.cli.commands.version import app
        result = runner.invoke(app, ["show"])
        assert result.exit_code == 0
        assert "XoneAI" in result.output or "xoneai" in result.output.lower()
...
class TestMCPCommand:
    ...
    def test_mcp_list(self):
        ...
        from xoneai.cli.commands.mcp import app
        result = runner.invoke(app, ["list"])
        assert result.exit_code == 0
...
class TestOutputController:
    ...
    def test_output_modes(self):
        ...
        from xoneai.cli.output.console import OutputMode
    ...
    def test_output_controller_creation(self):
        ...
        from xoneai.cli.output.console import OutputController, OutputMode
    ...
    def test_stream_event(self):
        ...
        from xoneai.cli.output.console import StreamEvent
...
class TestConfigurationSystem:
    ...
    def test_config_schema(self):
        ...
        from xoneai.cli.configuration.schema import ConfigSchema, DEFAULT_CONFIG
    ...
    def test_config_to_dict(self):
        ...
        from xoneai.cli.configuration.schema import ConfigSchema
    ...
    def test_config_paths(self):
        """Test config paths."""
        from xoneai.cli.configuration.paths import (
...
class TestStateManagement:
    ...
    def test_run_id_generation(self):
        ...
        from xoneai.cli.state.identifiers import generate_run_id
    ...
    def test_trace_id_generation(self):
        ...
        from xoneai.cli.state.identifiers import generate_trace_id
    ...
    def test_agent_id_generation(self):
        ...
        from xoneai.cli.state.identifiers import generate_agent_id
    ...
    def test_run_context(self):
        ...
        from xoneai.cli.state.identifiers import RunContext
...
class TestSessionManager:
    ...
    def test_session_metadata(self):
        ...
        from xoneai.cli.state.sessions import SessionMetadata
...
class TestLegacyCompatibility:
    ...
    def test_is_legacy_invocation(self):
        ...
        from xoneai.cli.legacy import is_legacy_invocation
    ...
    def test_typer_commands_set(self):
        ...
        from xoneai.cli.legacy import TYPER_COMMANDS
