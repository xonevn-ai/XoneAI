"""
Tests for XoneAI Async TUI Application.
"""
...
class TestChatMessage:
    ...
    def test_message_creation(self):
        ...
        from xoneai.cli.interactive.async_tui import ChatMessage
...
class TestGetLogo:
    ...
    def test_logo_contains_xone_ai(self):
        """Test that logo contains 'Xone AI' branding."""
        from xoneai.cli.branding import LOGO_SMALL
        
        assert "Xone AI" in LOGO_SMALL
...
class TestAsyncTUI:
    ...
    def test_init_default(self):
        ...
        from xoneai.cli.interactive.async_tui import AsyncTUI
    ...
    def test_format_output_with_messages(self):
        ...
        from xoneai.cli.interactive.async_tui import AsyncTUI, ChatMessage
...
class TestStartAsyncTUI:
    ...
    def test_function_exists(self):
        ...
        from xoneai.cli.interactive.async_tui import start_async_tui
...
class TestLogoDisplay:
    ...
    def test_logo_always_shows_when_enabled(self):
        ...
        from xoneai.cli.interactive.async_tui import AsyncTUI, AsyncTUIConfig, ChatMessage
        ...
        output = tui._format_output()
        assert "Xone" in output or "██" in output  # Logo contains these
...
class TestInteractiveRuntimeReadOnly:
    ...
    def test_read_only_false_when_config_approval_auto(self):
        ...
        from xoneai.cli.features.interactive_runtime import InteractiveRuntime, RuntimeConfig
    ...
    def test_read_only_false_when_env_approval_auto(self):
        """Test read_only is False when XONE_APPROVAL_MODE env is 'auto'."""
        import os
        from xoneai.cli.features.interactive_runtime import InteractiveRuntime, RuntimeConfig
        
        # Set env var
        old_val = os.environ.get("XONE_APPROVAL_MODE")
        os.environ["XONE_APPROVAL_MODE"] = "auto"
        ...
        try:
            ...
            if old_val is None:
                os.environ.pop("XONE_APPROVAL_MODE", None)
            else:
                os.environ["XONE_APPROVAL_MODE"] = old_val
