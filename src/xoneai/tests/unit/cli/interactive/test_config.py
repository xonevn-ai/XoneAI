...
class TestInteractiveConfig:
    ...
    def test_config_from_env(self):
        ...
        # Set env vars
        os.environ["XONE_MODEL"] = "claude-3-opus"
        os.environ["XONE_WORKSPACE"] = "/custom/workspace"
        ...
        try:
            ...
            # Cleanup
            os.environ.pop("XONE_MODEL", None)
            os.environ.pop("XONE_WORKSPACE", None)
    ...
    def test_approval_modes(self):
        ...
        from xoneai.cli.interactive.config import InteractiveConfig, ApprovalMode
