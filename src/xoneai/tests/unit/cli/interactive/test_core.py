...
class TestInteractiveCoreInit:
    ...
    def test_core_creation_default_config(self):
        ...
        from xoneai.cli.interactive.core import InteractiveCore
...
class TestInteractiveCoreSubscription:
    ...
    def test_subscribe_handler(self):
        ...
        from xoneai.cli.interactive.core import InteractiveCore
        from xoneai.cli.interactive.events import InteractiveEventType
    ...
    def test_emit_calls_handlers(self):
        ...
        from xoneai.cli.interactive.core import InteractiveCore
        from xoneai.cli.interactive.events import InteractiveEvent, InteractiveEventType
...
class TestInteractiveCoreSession:
    ...
    def test_continue_session_none_available(self):
        ...
        from xoneai.cli.interactive.core import InteractiveCore
        from xoneai.cli.interactive.config import InteractiveConfig
        from xoneai.cli.session.unified import UnifiedSessionStore
...
class TestInteractiveCoreApproval:
    ...
    def test_ask_permission_emits_event(self):
        ...
        from xoneai.cli.interactive.core import InteractiveCore
        from xoneai.cli.interactive.events import InteractiveEventType, ApprovalRequest
    ...
    def test_respond_permission_emits_event(self):
        ...
        from xoneai.cli.interactive.core import InteractiveCore
        from xoneai.cli.interactive.events import (
    ...
    def test_auto_approval_mode(self):
        ...
        from xoneai.cli.interactive.core import InteractiveCore
        from xoneai.cli.interactive.config import InteractiveConfig
        from xoneai.cli.interactive.events import ApprovalRequest, ApprovalDecision
