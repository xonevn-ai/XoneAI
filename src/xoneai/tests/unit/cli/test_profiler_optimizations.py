...
class TestProviderCache:
    ...
    def test_singleton_pattern(self):
        ...
        from xoneai.cli.features.profiler import ProviderCache
    ...
    def test_get_set(self):
        ...
        from xoneai.cli.features.profiler import get_provider_cache
...
class TestResolveModelProvider:
    ...
    def test_openai_models(self):
        ...
        from xoneai.cli.features.profiler import resolve_model_provider
...
class TestLazyImporter:
    ...
    def test_import_module(self):
        ...
        from xoneai.cli.features.profiler import LazyImporter
...
class TestClientPool:
    ...
    def test_get_or_create(self):
        ...
        from xoneai.cli.features.profiler import ClientPool
...
class TestPrewarmManager:
    ...
    def test_enable_disable(self):
        ...
        from xoneai.cli.features.profiler import PrewarmManager
...
class TestLiteModeConfig:
    ...
    def test_default_disabled(self):
        ...
        from xoneai.cli.features.profiler import LiteModeConfig
    ...
    def test_from_env(self):
        ...
        with patch.dict(os.environ, {
            'XONEAI_LITE_MODE': '1',
            'XONEAI_SKIP_TYPE_VALIDATION': 'true',
        }):
    ...
    def test_is_lite_mode(self):
        ...
        from xoneai.cli.features.profiler import is_lite_mode
        
        # Reset global config
        import xoneai.cli.features.profiler.optimizations as opt
        opt._lite_mode_config = None
        
        with patch.dict(os.environ, {'XONEAI_LITE_MODE': ''}, clear=False):
            # Force reload
            opt._lite_mode_config = None
...
class TestPerfSnapshot:
    ...
    def test_to_dict(self):
        ...
        from xoneai.cli.features.profiler import PerfSnapshot
...
class TestPerfComparison:
    ...
    def test_diff_calculation(self):
        ...
        from xoneai.cli.features.profiler import PerfSnapshot, PerfComparison
...
class TestPerfSnapshotManager:
    ...
    def test_save_and_load(self):
        ...
        from xoneai.cli.features.profiler import PerfSnapshot, PerfSnapshotManager
...
class TestFormatComparisonReport:
    ...
    def test_format_report(self):
        ...
        from xoneai.cli.features.profiler import (
...
class TestModuleImports:
    ...
    def test_all_exports_available(self):
        ...
        from xoneai.cli.features.profiler import __all__
        import xoneai.cli.features.profiler as profiler
