...
class TestMessageQueue:
    ...
    def test_create_empty_queue(self):
        ...
        from xoneai.cli.features.message_queue import MessageQueue
        queue = MessageQueue()
...
class TestProcessingState:
    ...
    def test_state_manager_initial_state(self):
        ...
        from xoneai.cli.features.message_queue import StateManager, ProcessingState
...
class TestQueuedMessage:
    ...
    def test_create_queued_message(self):
        ...
        from xoneai.cli.features.message_queue import QueuedMessage
    ...
    def test_message_priority(self):
        ...
        from xoneai.cli.features.message_queue import QueuedMessage, MessagePriority
...
class TestMessageQueueHandler:
    ...
    def test_handler_creation(self):
        ...
        from xoneai.cli.features.message_queue import MessageQueueHandler
    ...
    def test_queue_when_processing(self):
        ...
        from xoneai.cli.features.message_queue import MessageQueueHandler, ProcessingState
...
class TestQueueDisplay:
    ...
    def test_format_empty_queue(self):
        ...
        from xoneai.cli.features.message_queue import QueueDisplay, MessageQueue
        queue = MessageQueue()
    ...
    def test_format_status_idle(self):
        ...
        from xoneai.cli.features.message_queue import QueueDisplay, MessageQueue, StateManager
        queue = MessageQueue()
        state = StateManager()
    ...
    def test_format_queue_count(self):
        ...
        from xoneai.cli.features.message_queue import QueueDisplay, MessageQueue, ProcessingState, StateManager
        queue = MessageQueue()
        queue.add("First")
        queue.add("Second")
        state = StateManager()
...
class TestAsyncProcessor:
    ...
    def test_processor_creation(self):
        ...
        from xoneai.cli.features.message_queue import AsyncProcessor
...
class TestLiveStatusDisplay:
    ...
    def test_display_creation(self):
        ...
        from xoneai.cli.features.message_queue import LiveStatusDisplay
...
class TestNonBlockingInput:
    ...
    def test_input_handler_creation(self):
        ...
        from xoneai.cli.features.message_queue import NonBlockingInput
