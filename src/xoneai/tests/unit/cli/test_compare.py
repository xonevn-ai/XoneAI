...
class TestCompareHandler:
    ...
    def test_init_default_values(self):
        ...
        from xoneai.cli.features.compare import CompareHandler
...
class TestCompareModes:
    ...
    def test_get_mode_config_basic(self):
        ...
        from xoneai.cli.features.compare import get_mode_config
    ...
    def test_list_available_modes(self):
        ...
        from xoneai.cli.features.compare import list_available_modes
...
class TestModeResult:
    ...
    def test_mode_result_creation(self):
        ...
        from xoneai.cli.features.compare import ModeResult
...
class TestCompareResult:
    ...
    def test_compare_result_creation(self):
        ...
        from xoneai.cli.features.compare import CompareResult, ModeResult
...
class TestCompareExecution:
    ...
    @patch('xoneai.cli.features.compare.CompareHandler._run_mode')
    def test_compare_single_mode(self, mock_run_mode):
        """Test comparing with single mode."""
        from xoneai.cli.features.compare import CompareHandler, ModeResult
...
class TestCompareOutput:
    ...
    def test_save_result_to_file(self):
        ...
        from xoneai.cli.features.compare import CompareResult, ModeResult, save_compare_result
    ...
    def test_format_comparison_table(self):
        ...
        from xoneai.cli.features.compare import CompareResult, ModeResult, format_comparison_table
...
class TestParseModes:
    ...
    def test_parse_modes_comma_separated(self):
        ...
        from xoneai.cli.features.compare import parse_modes
