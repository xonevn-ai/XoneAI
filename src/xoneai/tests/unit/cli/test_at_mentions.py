...
class TestAtMentionContext:
    ...
    def test_detect_at_start(self):
        ...
        from xoneai.cli.features.at_mentions import detect_at_mention
...
class TestFileSuggestion:
    ...
    def test_create_file_suggestion(self):
        ...
        from xoneai.cli.features.at_mentions import FileSuggestion
...
class TestAtMentionCompleter:
    ...
    def test_completer_creation(self):
        ...
        from xoneai.cli.features.at_mentions import AtMentionCompleter
