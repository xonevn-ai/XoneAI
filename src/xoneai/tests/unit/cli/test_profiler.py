...
class TestProfilerConfig:
    ...
    def test_default_config(self):
        ...
        from xoneai.cli.features.profiler import ProfilerConfig
...
class TestTimingBreakdown:
    ...
    def test_default_timing(self):
        ...
        from xoneai.cli.features.profiler.core import TimingBreakdown
...
class TestFunctionStats:
    ...
    def test_to_dict(self):
        ...
        from xoneai.cli.features.profiler.core import FunctionStats
...
class TestFileStats:
    ...
    def test_to_dict(self):
        """Test conversion to dictionary."""
        from xoneai.cli.features.profiler.core import FileStats, FunctionStats
...
class TestProfilerResult:
    ...
    def test_to_dict(self):
        """Test conversion to dictionary."""
        from xoneai.cli.features.profiler.core import (
            ProfilerResult,
            TimingBreakdown,
            FunctionStats,
            FileStats,
...
class TestQueryProfiler:
    ...
    def test_init_default_config(self):
        ...
        from xoneai.cli.features.profiler import QueryProfiler, ProfilerConfig
    ...
    def test_collect_metadata(self):
        ...
        from xoneai.cli.features.profiler import QueryProfiler
        ...
        assert "xoneai_version" in metadata
...
class TestFormatProfileReport:
    ...
    def test_basic_report(self):
        ...
        result = ProfilerResult(
            ...
            function_stats=func_stats,
            file_stats=file_stats,
            metadata={"python_version": "3.12", "platform": "test", "xoneai_version": "1.0", "model": "test"},
        )
        
        report = format_profile_report(result)
        
        assert "XoneAI Profile Report" in report
...
class TestRedactSecrets:
    ...
    def test_redact_openai_key(self):
        ...
        from xoneai.cli.features.profiler.core import redact_secrets
...
class TestCLIImports:
    ...
    def test_output_module_imports(self):
        ...
        from xoneai.cli.output import OutputController, OutputMode
