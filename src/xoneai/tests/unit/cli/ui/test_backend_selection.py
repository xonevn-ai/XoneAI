...
4. XONEAI_UI_SAFE=1 forces PlainBackend
...
class TestBackendSelection:
    ...
    def test_select_backend_returns_plain_for_non_tty(self):
        ...
        from xoneai.cli.ui import select_backend, UIConfig
    ...
    def test_select_backend_returns_plain_for_safe_mode(self):
        """XONEAI_UI_SAFE=1 should force PlainBackend."""
        from xoneai.cli.ui import select_backend, UIConfig
        
        with patch.dict(os.environ, {'XONEAI_UI_SAFE': '1'}):
            config = UIConfig()
            backend = select_backend(config)
            assert backend.__class__.__name__ == 'PlainBackend'
    ...
    def test_select_backend_auto_with_deps(self):
        ...
        with patch.object(sys.stdout, 'isatty', return_value=True):
            with patch.dict(os.environ, {}, clear=False):
                # Remove XONEAI_UI_SAFE if present
                os.environ.pop('XONEAI_UI_SAFE', None)
                config = UIConfig()
                backend = select_backend(config)
...
class TestUIConfig:
    ...
    def test_ui_config_defaults(self):
        ...
        from xoneai.cli.ui import UIConfig
...
class TestBackendProtocol:
    ...
    def test_plain_backend_has_required_methods(self):
        ...
        from xoneai.cli.ui.plain import PlainBackend
    ...
    def test_plain_backend_emit_writes_to_stdout(self, capsys):
        ...
        from xoneai.cli.ui.plain import PlainBackend
        from xoneai.cli.ui.events import UIEventType
