...
class TestRuntimeConfigApprovalMode:
    ...
    def test_default_approval_mode(self):
        ...
        from xoneai.cli.features.interactive_runtime import RuntimeConfig
...
class TestInteractiveRuntimeReadOnly:
    ...
    def test_auto_mode_not_read_only(self):
        ...
        from xoneai.cli.features.interactive_runtime import (
            InteractiveRuntime,
            RuntimeConfig,
        )
    ...
    def test_env_var_auto_mode_override(self):
        """Test that XONE_APPROVAL_MODE env var can override to auto mode."""
        from xoneai.cli.features.interactive_runtime import (
            InteractiveRuntime,
            RuntimeConfig,
        )
        ...
        original = os.environ.get("XONE_APPROVAL_MODE")
        if "XONE_APPROVAL_MODE" in os.environ:
            del os.environ["XONE_APPROVAL_MODE"]
        ...
        try:
            ...
            if original:
                os.environ["XONE_APPROVAL_MODE"] = original
            elif "XONE_APPROVAL_MODE" in os.environ:
                del os.environ["XONE_APPROVAL_MODE"]
...
class TestToolConfigApprovalMode:
    ...
    def test_from_env_approval_mode(self):
        ...
        original = os.environ.get("XONE_APPROVAL_MODE")
        os.environ["XONE_APPROVAL_MODE"] = "manual"
...
class TestHeadlessConfigApprovalMode:
    ...
    def test_default_approval_mode(self):
        ...
        from xoneai.cli.features.interactive_core_headless import HeadlessConfig
...
class TestApprovalModeIntegration:
    ...
    def test_auto_mode_allows_file_creation_via_tools(self):
        ...
        from xoneai.cli.features.interactive_tools import (
