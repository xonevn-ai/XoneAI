...
class TestExampleMetadata:
    ...
    def test_parse_skip_directive(self, tmp_path):
        """Test parsing # xoneai: skip=true directive."""
        from xoneai.cli.features.examples import ExampleMetadata
        
        example = tmp_path / "test_skip.py"
        example.write_text("# xoneai: skip=true\nprint('hello')")
    ...
    def test_parse_timeout_directive(self, tmp_path):
        """Test parsing # xoneai: timeout=120 directive."""
        from xoneai.cli.features.examples import ExampleMetadata
        
        example = tmp_path / "test_timeout.py"
        example.write_text("# xoneai: timeout=120\nprint('hello')")
        
        meta = ExampleMetadata.from_file(example)
        assert meta.timeout == 120
    
    def test_parse_require_env_directive(self, tmp_path):
        """Test parsing # xoneai: require_env=KEY1,KEY2 directive."""
        from xoneai.cli.features.examples import ExampleMetadata
        
        example = tmp_path / "test_env.py"
        example.write_text("# xoneai: require_env=OPENAI_API_KEY,ANTHROPIC_API_KEY\nprint('hello')")
        
        meta = ExampleMetadata.from_file(example)
        assert meta.require_env == ["OPENAI_API_KEY", "ANTHROPIC_API_KEY"]
    
    def test_parse_xfail_directive(self, tmp_path):
        """Test parsing # xoneai: xfail=reason directive."""
        from xoneai.cli.features.examples import ExampleMetadata
        
        example = tmp_path / "test_xfail.py"
        example.write_text("# xoneai: xfail=known_flaky\nprint('hello')")
    ...
    def test_parse_multiple_directives(self, tmp_path):
        ...
        example.write_text(
            "#!/usr/bin/env python3\n"
            "# xoneai: timeout=300\n"
            "# xoneai: require_env=OPENAI_API_KEY\n"
            "# xoneai: xfail=slow_network\n"
            "print('hello')"
        )
...
class TestExampleDiscovery:
    ...
    def test_discover_python_files(self, tmp_path):
        ...
        from xoneai.cli.features.examples import ExampleDiscovery
...
class TestExampleRunner:
    ...
    def test_run_passing_example(self, tmp_path):
        ...
        from xoneai.cli.features.examples import ExampleRunner, ExampleResult
    ...
    def test_run_failing_example(self, tmp_path):
        ...
        from xoneai.cli.features.examples import ExampleRunner
    ...
    def test_skip_missing_env(self, tmp_path):
        ...
        from xoneai.cli.features.examples import ExampleRunner, ExampleMetadata
        
        example = tmp_path / "needs_key.py"
        example.write_text("# xoneai: require_env=NONEXISTENT_KEY_12345\nprint('hello')")
    ...
    def test_xfail_expected_failure(self, tmp_path):
        ...
        example.write_text("# xoneai: xfail=expected\nraise Exception('expected')")
...
class TestReportGenerator:
    ...
    def test_generate_json_report(self, tmp_path):
        ...
        from xoneai.cli.features.examples import ReportGenerator, ExampleResult, RunReport
...
class TestCLIIntegration:
    ...
    def test_examples_list_command(self, tmp_path):
        """Test 'xoneai examples list' command."""
        ...
        from xoneai.cli.commands.examples import app
    ...
    def test_examples_run_command_passing(self, tmp_path):
        """Test 'xoneai examples run' with passing examples."""
        from typer.testing import CliRunner
    ...
    def test_examples_run_command_failing(self, tmp_path):
        """Test 'xoneai examples run' with failing examples."""
        from typer.testing import CliRunner
