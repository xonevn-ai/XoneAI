...
class TestBrandingConstants:
    ...
    def test_product_name(self):
        ...
        from xoneai.cli.branding import PRODUCT_NAME
        assert PRODUCT_NAME == "Xone AI"
...
class TestGetVersion:
    ...
    def test_get_version_returns_string(self):
        ...
        from xoneai.cli.branding import get_version
        version = get_version()
...
class TestGetBanner:
    ...
    def test_get_banner_includes_logo(self):
        ...
        from xoneai.cli.branding import get_banner
        banner = get_banner(100)
        assert "██" in banner or "Xone" in banner
    
    def test_get_banner_includes_version(self):
        """Test get_banner includes version when requested."""
        from xoneai.cli.branding import get_banner, get_version
...
class TestGetWelcomeTips:
    ...
    def test_get_welcome_tips_content(self):
        ...
        from xoneai.cli.branding import get_welcome_tips
