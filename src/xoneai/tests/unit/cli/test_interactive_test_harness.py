...
class TestWorkspaceFixture:
    ...
    def test_empty_fixture(self):
        ...
        from xoneai.cli.features.interactive_test_harness import WorkspaceFixture
...
class TestBuiltinFixtures:
    ...
    def test_all_fixtures_registered(self):
        ...
        from xoneai.cli.features.interactive_test_harness import BUILTIN_FIXTURES
...
class TestTestArtifacts:
    ...
    def test_save_creates_files(self):
        ...
        from xoneai.cli.features.interactive_test_harness import TestArtifacts
...
class TestInteractiveTestHarness:
    ...
    def test_initialization_creates_workspace(self):
        ...
        from xoneai.cli.features.interactive_test_harness import InteractiveTestHarness
...
class TestCreateTestHarness:
    ...
    def test_creates_harness_with_fixture(self):
        ...
        from xoneai.cli.features.interactive_test_harness import create_test_harness
