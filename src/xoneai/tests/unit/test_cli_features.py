...
class TestGuardrailHandler:
    ...
    def test_guardrail_check_dependencies_available(self):
        """Test dependency check when xoneaiagents is available."""
        from xoneai.cli.features.guardrail import GuardrailHandler
        handler = GuardrailHandler()
        available, msg = handler.check_dependencies()
        # Should be available if xoneaiagents is installed
    ...
    @patch('xoneai.cli.features.guardrail.XONEAI_AVAILABLE', True)
    def test_guardrail_execute_with_string(self):
        ...
        with patch('xoneai.cli.features.guardrail.LLMGuardrail') as mock_guardrail:
            mock_instance = Mock()
...
class TestTelemetryHandler:
    ...
    def test_telemetry_enable(self):
        ...
        with patch('xoneai.cli.features.telemetry.enable_telemetry'):
            handler.enable()
...
class TestFastContextHandler:
    ...
    def test_fast_context_handler_import(self):
        ...
        from xoneai.cli.features import FastContextHandler
    ...
    def test_fast_context_handler_initialization(self):
        ...
        from xoneai.cli.features.fast_context import FastContextHandler
...
class TestToolsHandler:
    ...
    def test_tools_handler_import(self):
        ...
        from xoneai.cli.features import ToolsHandler
...
class TestAutoMemoryHandler:
    ...
    def test_auto_memory_handler_import(self):
        ...
        from xoneai.cli.features import AutoMemoryHandler
    ...
    def test_auto_memory_handler_initialization(self):
        ...
        from xoneai.cli.features.auto_memory import AutoMemoryHandler
...
class TestFlowDisplayHandler:
    ...
    def test_flow_display_handler_import(self):
        ...
        from xoneai.cli.features import FlowDisplayHandler
    ...
    def test_flow_display_handler_initialization(self):
        ...
        from xoneai.cli.features.flow_display import FlowDisplayHandler
...
class TestCLIArgumentParsing:
    ...
    def test_guardrail_argument_parsed(self):
        ...
        with patch.object(sys, 'argv', ['xoneai', '--guardrail', 'Check output']):
            XoneAI()  # Just verify no exception is raised
    
    def test_metrics_argument_parsed(self):
        """Test that --metrics argument is parsed correctly."""
        from xoneai.cli import XoneAI
        
        with patch.object(sys, 'argv', ['xoneai', '--metrics']):
            XoneAI()  # Just verify no exception is raised
    ...
    def test_image_argument_parsed(self):
        ...
        with patch.object(sys, 'argv', ['xoneai', '--image', '/path/to/image.png']):
            XoneAI()  # Just verify no exception is raised
