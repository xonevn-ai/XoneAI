...
class TestAPIKeyAuth:
    ...
    def test_generate_key(self):
        ...
        from xoneai.mcp_server.auth.api_key import APIKeyAuth
    ...
    def test_key_expiration(self, monkeypatch):
        ...
        import xoneai.mcp_server.auth.api_key as api_key_module
...
class TestScopeManager:
    ...
    def test_validate_scopes_success(self):
        ...
        from xoneai.mcp_server.auth.scopes import ScopeManager
    ...
    def test_scope_challenge_to_www_authenticate(self):
        ...
        from xoneai.mcp_server.auth.scopes import ScopeChallenge
...
class TestScopeRequirement:
    ...
    def test_all_scopes_required(self):
        ...
        from xoneai.mcp_server.auth.scopes import ScopeRequirement, ScopeManager
...
class TestOAuthConfig:
    ...
    def test_oauth_config_creation(self):
        ...
        from xoneai.mcp_server.auth.oauth import OAuthConfig
...
class TestTokenResponse:
    ...
    def test_token_response(self):
        ...
        from xoneai.mcp_server.auth.oauth import TokenResponse
...
class TestOAuthManager:
    ...
    def test_create_authorization_url(self):
        ...
        from xoneai.mcp_server.auth.oauth import OAuthConfig, OAuthManager
...
class TestOIDCConfig:
    ...
    def test_oidc_config_creation(self):
        ...
        from xoneai.mcp_server.auth.oidc import OIDCConfig
...
class TestClientMetadata:
    ...
    def test_client_metadata_creation(self):
        ...
        from xoneai.mcp_server.auth.oidc import ClientMetadata
