...
class TestTaskState:
    ...
    def test_task_states(self):
        ...
        from xoneai.mcp_server.tasks import TaskState
...
class TestTaskProgress:
    ...
    def test_progress_basic(self):
        ...
        from xoneai.mcp_server.tasks import TaskProgress
...
class TestTask:
    ...
    def test_task_creation(self):
        """Test task creation."""
        from xoneai.mcp_server.tasks import Task, TaskState
...
class TestTaskStore:
    ...
    def test_create_task(self):
        """Test task creation."""
        from xoneai.mcp_server.tasks import TaskStore, TaskState
    ...
    def test_get_task(self):
        """Test getting a task."""
        from xoneai.mcp_server.tasks import TaskStore
    ...
    def test_update_task(self):
        ...
        from xoneai.mcp_server.tasks import TaskStore, TaskState, TaskProgress
...
class TestTaskManager:
    ...
    def test_create_task(self):
        ...
        from xoneai.mcp_server.tasks import TaskManager
    ...
    def test_cancel_task(self):
        ...
        from xoneai.mcp_server.tasks import TaskManager, TaskState
...
class TestGlobalTaskManager:
    ...
    def test_get_task_manager(self):
        ...
        from xoneai.mcp_server.tasks import get_task_manager, TaskManager
    ...
    def test_set_task_manager(self):
        ...
        from xoneai.mcp_server.tasks import get_task_manager, set_task_manager, TaskManager
