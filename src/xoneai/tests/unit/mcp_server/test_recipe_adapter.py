...
class TestRecipeMCPConfig:
    ...
    def test_default_config(self):
        ...
        from xoneai.mcp_server.recipe_adapter import RecipeMCPConfig
...
class TestRecipeMCPAdapter:
    ...
    def test_init(self):
        ...
        from xoneai.mcp_server.recipe_adapter import RecipeMCPAdapter
    ...
    def test_init_with_config(self):
        ...
        from xoneai.mcp_server.recipe_adapter import RecipeMCPAdapter, RecipeMCPConfig
    ...
    def test_get_registries(self):
        ...
        from xoneai.mcp_server.recipe_adapter import RecipeMCPAdapter
        from xoneai.mcp_server.registry import MCPToolRegistry, MCPResourceRegistry, MCPPromptRegistry
...
class TestRecipeToolWrapper:
    ...
    def test_tool_wrapper(self):
        ...
        from xoneai.mcp_server.recipe_adapter import RecipeToolWrapper
...
class TestCreateRecipeMCPServer:
    ...
    @patch('xoneai.mcp_server.recipe_adapter.RecipeMCPAdapter')
    def test_create_server(self, mock_adapter_class):
        """Test creating MCP server from recipe."""
        from xoneai.mcp_server.recipe_adapter import create_recipe_mcp_server
