...
1. Framework imports (crewai, autogen, xoneaiagents) are lazy-loaded
...
class TestAutoLazyLoading:
    ...
    def test_auto_module_import_does_not_import_crewai(self):
        ...
        if 'xoneai.auto' in sys.modules:
            del sys.modules['xoneai.auto']
        
        # Import auto module
        from xoneai import auto
    ...
    def test_litellm_lazy_check_available(self):
        ...
        from xoneai.auto import _check_litellm_available
    ...
    def test_openai_lazy_check_available(self):
        ...
        from xoneai.auto import _check_openai_available
    ...
    def test_framework_availability_functions_exist(self):
        ...
        assert hasattr(auto, '_check_xoneai_available')
        assert hasattr(auto, '_get_crewai')
        assert hasattr(auto, '_get_autogen')
        assert hasattr(auto, '_get_xoneai')
...
class TestSafeStringSubstitution:
    ...
    def test_safe_substitute_with_curly_braces(self):
        ...
        from xoneai.agents_generator import safe_format
