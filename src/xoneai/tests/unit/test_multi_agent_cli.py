...
Tests for:
- xoneai agents command with multiple --agent flags
...
class TestMultiAgentCLIArguments:
    ...
    def test_agents_command_recognized(self):
        ...
        from xoneai.cli.features.agents import MultiAgentHandler, parse_agent_definition
    ...
    def test_agent_argument_parsing(self):
        ...
        from xoneai.cli.features.agents import add_agents_parser
...
class TestAgentDefinitionParsing:
    ...
    def test_parse_agent_definition_basic(self):
        ...
        from xoneai.cli.features.agents import parse_agent_definition
...
class TestMultiAgentHandler:
    ...
    def test_handler_initialization(self):
        ...
        from xoneai.cli.features.agents import MultiAgentHandler
