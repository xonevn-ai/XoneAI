...
class TestArtifactRef:
    ...
    def test_create_artifact_ref(self):
        ...
        from xoneaiagents.context.artifacts import ArtifactRef
...
class TestQueueConfig:
    ...
    def test_default_config(self):
        ...
        from xoneaiagents.context.artifacts import QueueConfig
...
class TestFileSystemArtifactStore:
    ...
    def temp_store(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            from xoneai.context import FileSystemArtifactStore
            store = FileSystemArtifactStore(base_dir=tmpdir)
            yield store
    
    def test_store_json(self, temp_store):
        """Test storing JSON content."""
        from xoneaiagents.context.artifacts import ArtifactMetadata
...
class TestHelperFunctions:
    ...
    def test_compute_checksum(self):
        ...
        from xoneaiagents.context.artifacts import compute_checksum
    ...
    def test_generate_summary_dict(self):
        ...
        from xoneaiagents.context.artifacts import generate_summary
