...
from xoneai.scheduler.base import ScheduleParser, ExecutorInterface, XoneAgentExecutor
...
class TestXoneAgentExecutor:
    """Test XoneAgentExecutor implementation."""
    
    def test_init_with_agent(self):
        """Test initialization with agent."""
        mock_agent = Mock()
        executor = XoneAgentExecutor(mock_agent)
