...
class TestTTSTool:
    ...
    def test_tts_tool_success(self):
        ...
        with patch('xoneai.tools.audio._get_audio_agent') as mock_get_agent:
            mock_agent = Mock()
            mock_get_agent.return_value = mock_agent
            
            from xoneai.tools.audio import tts_tool
...
class TestSTTTool:
    ...
    def test_stt_tool_success(self):
        ...
        with patch('xoneai.tools.audio._get_audio_agent') as mock_get_agent:
            ...
            from xoneai.tools.audio import stt_tool
...
class TestCreateToolFunctions:
    ...
    def test_create_tts_tool(self):
        ...
        with patch('xoneai.tools.audio._get_audio_agent'):
