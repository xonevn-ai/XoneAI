...
class TestLLMProviderRegistry:
    ...
    def test_create_empty_registry(self):
        ...
        from xoneai.llm.registry import LLMProviderRegistry
...
class TestDefaultRegistry:
    ...
    def test_get_default_registry_singleton(self):
        ...
        from xoneai.llm.registry import get_default_llm_registry
    ...
    def test_register_provider_global(self):
        ...
        from xoneai.llm.registry import (
...
class TestCreateLLMProvider:
    ...
    def test_create_from_instance(self):
        ...
        from xoneai.llm.registry import create_llm_provider
    ...
    def test_create_with_custom_registry(self):
        ...
        from xoneai.llm.registry import create_llm_provider, LLMProviderRegistry
...
class TestParseModelString:
    ...
    def test_parse_provider_model_format(self):
        ...
        from xoneai.llm.registry import parse_model_string
...
class TestLiteLLMIsolation:
    ...
    def test_registry_does_not_import_litellm(self):
        ...
        # Import registry
        from xoneai.llm import registry
