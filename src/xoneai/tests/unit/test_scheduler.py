...
def test_scheduler_creation():
    ...
    from xoneai.scheduler import create_scheduler, DeploymentScheduler
...
def test_cli_argument_parsing():
    ...
    xone = XoneAI()
    assert xone is not None
    print("  ✓ XoneAI CLI instance created")
    
    print("CLI argument parsing tests passed!")

def main():
    """Run all tests."""
    print("Running XoneAI Scheduler Tests")
    print("=" * 40)
