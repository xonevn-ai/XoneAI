...
class TestUIIntegration:
    ...
    def test_gradio_app_config(self):
        ...
        assert gradio_config["title"] == "XoneAI Agent Chat"
        assert gradio_config["server_port"] == 7860
    
    def test_streamlit_app_config(self):
        """Test Streamlit app configuration."""
        streamlit_config = {
            "page_title": "XoneAI Agents",
            "page_icon": "🤖",
            "layout": "wide",
            "initial_sidebar_state": "expanded",
            "menu_items": {
                'Get Help': 'https://docs.xoneai.com',
                'Report a bug': 'https://github.com/xonevn-ai/XoneAI/issues',
                'About': "XoneAI Agents Framework"
            }
        }
        
        assert streamlit_config["page_title"] == "XoneAI Agents"
    ...
    def test_chainlit_app_config(self):
        ...
        chainlit_config = {
            "name": "XoneAI Agent",
            "description": "Interact with XoneAI agents",
            "author": "XoneAI Team",
            "tags": ["ai", "agents", "chat"],
            "public": False,
            "authentication": True
        ...
        assert chainlit_config["name"] == "XoneAI Agent"
