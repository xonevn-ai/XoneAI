...
# Add the xoneai package to the path
...
class TestToolDiscovery:
    ...
    def test_get_all_available_tools_returns_dict(self):
        ...
        from xoneai.auto import get_all_available_tools
    ...
    def test_get_tools_for_task_returns_list(self):
        ...
        from xoneai.auto import get_tools_for_task
...
class TestEnhancedAutoGenerator:
    ...
    def test_enhanced_generator_has_tool_discovery(self):
        ...
        generator = AutoGenerator(topic="Test task", framework="xoneai")
    ...
    def test_recommend_agent_count(self):
        ...
        from xoneai.auto import recommend_agent_count
...
class TestToolCategoryMapping:
    ...
    def test_tool_categories_defined(self):
        ...
        from xoneai.auto import TOOL_CATEGORIES
    ...
    def test_task_keywords_mapping(self):
        ...
        from xoneai.auto import TASK_KEYWORD_TO_TOOLS
...
class TestIntegrationWithAgentsTools:
    """Tests for integration with xoneaiagents.tools."""
    
    def test_can_import_xoneaiagents_tools(self):
        """Test that we can import tools from xoneaiagents."""
        try:
            from xoneaiagents.tools import TOOL_MAPPINGS
            assert isinstance(TOOL_MAPPINGS, dict)
            assert len(TOOL_MAPPINGS) > 0
        except ImportError:
            pytest.skip("xoneaiagents not installed")
