...
# Add the xoneai package to path
# repo_root should be the actual repository root (xoneai-package), not the xoneai src dir
repo_root = Path(__file__).parent.parent.parent.parent.parent.parent
sys.path.insert(0, str(repo_root / "src" / "xoneai"))

from xoneai._dev.api_md import ApiMdGenerator, generate_api_md
...
class TestApiMdGenerator:
    ...
    def test_discover_all_finds_symbols(self, generator):
        ...
        # Should find symbols from xoneaiagents
...
class TestMarkdownGeneration:
    ...
    def test_generate_has_plugins_section(self, generator):
        ...
        assert "xoneai-tools" in content
...
class TestGenerateApiMdFunction:
    ...
    def test_generate_to_stdout(self, capsys):
        ...
        assert "# XoneAI API Reference" in captured.out
