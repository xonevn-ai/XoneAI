...
"""
            ...
            try:
                # Initialize XoneAI with AutoGen
                xoneai = XoneAI(
                ...
                assert xoneai.framework == "autogen"
    ...
    @pytest.mark.skipif(not os.getenv("XONEAI_RUN_FULL_TESTS"), 
                        reason="Full execution test requires XONEAI_RUN_FULL_TESTS=true")
    def test_autogen_full_execution(self):
        """
        💰 EXPENSIVE TEST: Actually runs xoneai.run() with real API calls!
        
        Set XONEAI_RUN_FULL_TESTS=true to enable this test.
...
"""
            ...
            try:
                ...
                print(f"📋 Framework: {xoneai.framework}")
...
if __name__ == "__main__":
    ...
    os.environ["XONEAI_RUN_FULL_TESTS"] = "true"
