#!/usr/bin/env python3
"""
Simple test runner for XoneAI Agents
...
def run_tests_with_subprocess():
    ...
    print("🧪 XoneAI Agents - Simple Test Runner")
    print("=" * 50)
...
def run_fast_tests():
    ...
    try:
        result = subprocess.run([
            sys.executable, "-c", 
            "import sys; sys.path.insert(0, 'src'); import xoneaiagents; print('✅ Import successful')"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Simple XoneAI Test Runner")
