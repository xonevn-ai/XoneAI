...
class TestApprovalFlags:
    ...
    def test_trust_flag_in_xoneai_parser(self):
        """Test that --trust flag is in XoneAI's actual parser."""
        ...
        result = xone.parse_args()
        args = result[0] if isinstance(result, tuple) else result
        
        # The args should have trust attribute after parse_args
        assert hasattr(args, 'trust'), "XoneAI.args should have 'trust' attribute"
        # Cleanup
        del xone
    
    def test_approve_level_flag_in_xoneai_parser(self):
        """Test that --approve-level flag is in XoneAI's actual parser."""
        from xoneai.cli.main import XoneAI
        ...
        assert hasattr(args, 'approve_level'), "XoneAI.args should have 'approve_level' attribute"
...
class TestApprovalCallback:
    ...
    def test_set_approval_callback(self):
        ...
        from xoneaiagents.approval import approval_callback
...
class TestApprovalRequirements:
    ...
    def test_default_dangerous_tools(self):
        ...
        from xoneaiagents.approval import APPROVAL_REQUIRED_TOOLS, TOOL_RISK_LEVELS
