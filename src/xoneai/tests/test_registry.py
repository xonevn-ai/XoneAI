...
class TestLocalRegistry:
    ...
    def test_publish_duplicate_fails(self, temp_registry, sample_bundle):
        ...
        from xoneai.recipe.registry import RecipeExistsError
...
class TestRunHistory:
    ...
    def test_export_run(self, temp_history, sample_result, tmp_path):
        ...
        assert export_data["format"] == "xone-run-export"
...
class TestLockfileValidation:
    ...
    def test_validate_with_lockfile(self, tmp_path):
        ...
        from xoneai.recipe.security import validate_lockfile
...
class TestPIIRedaction:
    ...
    def test_redact_email(self):
        ...
        from xoneai.recipe.security import redact_pii
    ...
    def test_detect_pii(self):
        ...
        from xoneai.recipe.security import detect_pii
...
class TestPolicyPack:
    ...
    def test_default_policy(self):
        """Test default policy."""
        from xoneai.recipe.policy import get_default_policy
    ...
    def test_check_tool_allowed(self):
        ...
        from xoneai.recipe.policy import PolicyPack
    ...
    def test_check_tool_denied(self):
        ...
        from xoneai.recipe.policy import PolicyPack, PolicyDeniedError
...
class TestRegistryIntegration:
    ...
    def test_full_publish_pull_workflow(self, tmp_path):
        ...
        # Pack the recipe
        bundle_path = tmp_path / "my-recipe-1.0.0.xone"
        with tarfile.open(bundle_path, "w:gz") as tar:
            manifest = {
                "name": "my-recipe",
                "version": "1.0.0",
