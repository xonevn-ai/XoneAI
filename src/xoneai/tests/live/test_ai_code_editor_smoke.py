...
These tests verify that XoneAI behaves as a real AI code editor:
- Edits files on disk
- Runs terminal commands (pytest, ruff, etc.)
- Observes failures and fixes them
- Converges to green tests

Run with: XONEAI_LIVE_SMOKE=1 pytest tests/live/test_ai_code_editor_smoke.py -v
"""
...
pytestmark = pytest.mark.skipif(
    ...
    reason="Live smoke tests disabled (set XONEAI_LIVE_SMOKE=1 and OPENAI_API_KEY)"
)
