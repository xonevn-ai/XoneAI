...
Run with: XONEAI_LIVE_INTERACTIVE=1 pytest tests/live/interactive/test_smoke.py -v
"""
...
pytestmark = pytest.mark.skipif(
    ...
    reason="Live interactive tests disabled (set XONEAI_LIVE_INTERACTIVE=1 and OPENAI_API_KEY)"
)
