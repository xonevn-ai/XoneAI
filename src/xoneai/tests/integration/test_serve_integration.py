...
"""
    ...
    def test_serve_agents_help(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "xoneai.cli.commands.serve", "agents", "--help"],
            capture_output=True,
            text=True,
...
class TestServeA2AIntegration:
    ...
    def test_serve_a2a_help(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "xoneai.cli.commands.serve", "a2a", "--help"],
            capture_output=True,
            text=True,
            cwd="/Users/xonevn/xoneai-package/src/xoneai"
        )
...
class TestServeUnifiedIntegration:
    ...
    def test_serve_unified_help(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "xoneai.cli.commands.serve", "unified", "--help"],
            capture_output=True,
            text=True,
            cwd="/Users/xonevn/xoneai-package/src/xoneai"
        )
...
class TestServeGatewayIntegration:
    ...
    def test_serve_gateway_help(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "xoneai.cli.commands.serve", "gateway", "--help"],
            capture_output=True,
            text=True,
            cwd="/Users/xonevn/xoneai-package/src/xoneai"
        )
...
class TestServeMCPIntegration:
    ...
    def test_serve_mcp_help(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "xoneai.cli.commands.serve", "mcp", "--help"],
            capture_output=True,
            text=True,
            cwd="/Users/xonevn/xoneai-package/src/xoneai"
        )
...
class TestServeRecipeIntegration:
    ...
    def test_serve_recipe_help(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "xoneai.cli.commands.serve", "recipe", "--help"],
            capture_output=True,
            text=True,
            cwd="/Users/xonevn/xoneai-package/src/xoneai"
        )
...
class TestAllServeCommandsHelp:
    ...
    def test_serve_command_help(self, command):
        ...
        from xoneai.cli.commands.serve import app
