...
class TestDoctorCLI:
    """Integration tests for xoneai doctor CLI."""
    
    def test_doctor_help(self):
        """Test doctor --help output."""
        result = subprocess.run(
            [sys.executable, "-m", "xoneai", "doctor", "--help"],
            capture_output=True,
            text=True,
            timeout=30,
        )
    ...
    def test_doctor_version(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "xoneai", "doctor", "--version"],
            capture_output=True,
            text=True,
            timeout=30,
        )
    ...
    def test_doctor_db_subcommand(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "xoneai", "doctor", "db"],
            capture_output=True,
            text=True,
            timeout=30,
        )
    ...
    def test_doctor_fast_mode(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "xoneai", "doctor"],
            capture_output=True,
            text=True,
            timeout=60,
        )
    ...
    def test_doctor_json_output(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "xoneai", "doctor", "--json"],
            capture_output=True,
            text=True,
            timeout=60,
        )
    ...
    def test_doctor_env_subcommand(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "xoneai", "doctor", "env"],
            capture_output=True,
            text=True,
            timeout=60,
        )
    ...
    def test_doctor_config_subcommand(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "xoneai", "doctor", "config"],
            capture_output=True,
            text=True,
            timeout=60,
        )
    ...
    def test_doctor_mcp_subcommand(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "xoneai", "doctor", "mcp"],
            capture_output=True,
            text=True,
            timeout=60,
        )
    ...
    def test_doctor_quiet_mode(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "xoneai", "doctor", "--quiet"],
            capture_output=True,
            text=True,
            timeout=60,
        )
    ...
    def test_doctor_ci_subcommand(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "xoneai", "doctor", "ci"],
            capture_output=True,
            text=True,
            timeout=60,
        )
    ...
    def test_doctor_selftest(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "xoneai", "doctor", "selftest"],
            capture_output=True,
            text=True,
            timeout=60,
        )
    ...
    def test_doctor_deep_mode(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "xoneai", "doctor", "--deep"],
            capture_output=True,
            text=True,
            timeout=60,
        )
    ...
    def test_doctor_tools_subcommand(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "xoneai", "doctor", "tools"],
            capture_output=True,
            text=True,
            timeout=60,
        )
    ...
    def test_doctor_network_subcommand(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "xoneai", "doctor", "network"],
            capture_output=True,
            text=True,
            timeout=60,
        )
    ...
    def test_doctor_strict_mode(self):
        ...
        result = subprocess.run(
            [sys.executable, "-m", "xoneai", "doctor", "--strict"],
            capture_output=True,
            text=True,
            timeout=60,
        )
