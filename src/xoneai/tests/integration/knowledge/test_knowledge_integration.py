...
class TestVectorStoreIntegration:
    ...
    def test_chroma_vector_store(self):
        ...
        try:
            from xoneai.adapters.vector_stores import ChromaVectorStore
        except ImportError:
    ...
    def test_pinecone_vector_store(self):
        ...
        try:
            from xoneai.adapters.vector_stores import PineconeVectorStore
        except ImportError:
...
class TestRerankerIntegration:
    ...
    def test_llm_reranker(self):
        ...
        try:
            from xoneai.adapters.rerankers import LLMReranker
        except ImportError:
    ...
    def test_cohere_reranker(self):
        ...
        try:
            from xoneai.adapters.rerankers import CohereReranker
        except ImportError:
...
class TestRetrieverIntegration:
    ...
    def test_basic_retriever(self):
        ...
        from xoneaiagents.knowledge.vector_store import InMemoryVectorStore
        try:
            from xoneai.adapters.retrievers import BasicRetriever
        except ImportError:
    ...
    def test_fusion_retriever(self):
        ...
        from xoneaiagents.knowledge.vector_store import InMemoryVectorStore
        try:
            from xoneai.adapters.retrievers import FusionRetriever
        except ImportError:
            pytest.skip("Retriever not available")
