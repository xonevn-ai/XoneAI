...
from xoneai.recipe.server import RegistryServer, create_wsgi_app
...
class TestRegistryServer:
    ...
    def test_publish_with_auth(self, registry_path, sample_bundle):
        ...
        body_parts = [
            ...
            b"false",
            f"--{boundary}".encode(),
            f'Content-Disposition: form-data; name="bundle"; filename="test.xone"'.encode(),
