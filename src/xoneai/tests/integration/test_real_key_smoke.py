"""
Real API Key Smoke Tests for XoneAI.
...
'''
    ...
    def test_cli_xoneai_class(self):
        """Test XoneAI class instantiation."""
        code = '''
import os
os.environ['LOGLEVEL'] = 'WARNING'
from xoneai.cli.main import XoneAI
pai = XoneAI(agent_file="agents.yaml", framework="xoneai")
print("CLASS_OK")
'''
        result = run_python_code(code, timeout=30)
...
os.environ['LOGLEVEL'] = 'WARNING'
from xoneai.cli.main import XoneAI
heavy = ['litellm', 'instructor', 'xoneai.auto']
