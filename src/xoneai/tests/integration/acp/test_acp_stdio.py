...
import sys
import asyncio
from xoneai.acp.server import ACPServer
from xoneai.acp.config import ACPConfig
...
"""
    ...
    def test_initialize(self, acp_process):
        ...
        assert result["agentInfo"]["name"] == "xoneai"
...
class TestACPNoStdoutPollution:
    ...
    def test_no_print_statements(self):
        ...
        acp_dir = Path(__file__).parent.parent.parent.parent / "xoneai" / "acp"
    ...
    def test_logging_to_stderr(self):
        ...
        from xoneai.acp.server import _setup_stderr_logging
        import logging
        import sys
        
        _setup_stderr_logging(debug=True)
        
        logger = logging.getLogger("xoneai.acp")
...
class TestACPInteractiveModeCompatibility:
    ...
    def test_acp_import_does_not_break_interactive(self):
        ...
        from xoneai.acp import ACPConfig
        
        # Interactive mode imports should still work
        from xoneai.cli.features.interactive_tui import InteractiveConfig
    ...
    def test_acp_lazy_import(self):
        ...
        start = time.time()
        import xoneai.acp as acp_module  # noqa: F401
    ...
    def test_interactive_mode_without_acp_sdk(self):
        ...
        try:
            ...
            from xoneai.cli.features.interactive_tui import InteractiveSession
...
class TestACPSessionPersistence:
    ...
    def test_session_save_and_load(self):
        ...
        from xoneai.acp.session import ACPSession, SessionStore
