...
This directory contains integration tests for XoneAI that verify functionality across different frameworks and external dependencies.
...
- ✅ Basic agent creation through XoneAI
...
def test_basic_autogen_agent_creation(self, mock_completion, mock_autogen_completion):
    """Test creating basic AutoGen agents through XoneAI"""
    yaml_content = """
framework: autogen
...
- ✅ Basic crew creation through XoneAI
...
### Framework Integration Tests
- **AutoGen**: Tests XoneAI integration with Microsoft AutoGen framework
- **CrewAI**: Tests XoneAI integration with CrewAI framework
...
**Path Issues:**
```
ModuleNotFoundError: No module named 'xoneai'
```
