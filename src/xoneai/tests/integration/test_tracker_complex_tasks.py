...
COMPLEX_TASKS = [
    ...
    {
        "id": 6,
        "description": "Search for the latest AI agent frameworks, compare XoneAI with alternatives, and write a comparison report",
        "expected_tools": ["search_web", "write_file"],
        "min_steps": 4,
    },
    {
...
def run_single_task(task: Dict[str, Any], max_iterations: int = 15) -> TaskResult:
    ...
    from xoneai.cli.commands.tracker import (
        _run_tracked_task,
        _get_tools,
        DEFAULT_TOOLS,
    )
