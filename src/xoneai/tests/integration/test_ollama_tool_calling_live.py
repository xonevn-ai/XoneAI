...
3. Environment variable: XONEAI_TEST_OLLAMA=1

Run with:
    XONEAI_TEST_OLLAMA=1 LOGLEVEL=debug python -m pytest tests/integration/test_ollama_tool_calling_live.py -v
"""
...
# Skip all tests in this module if XONEAI_TEST_OLLAMA is not set
pytestmark = pytest.mark.skipif(
    not os.getenv("XONEAI_TEST_OLLAMA"),
    reason="Ollama live tests disabled. Set XONEAI_TEST_OLLAMA=1 to enable."
)
