...
def read_system_instructions():
    try:
        with open("/Users/xonevn/xoneai-package/.cursorrules", "r") as file:
            return file.read()
...
def read_current_file():
    try:
        with open("/Users/xonevn/xoneai-package/xoneai/test.py", "r") as file:
            return file.read()
    except Exception as e:
...
if __name__ == "__main__":
    ...
    if not os.path.exists("/Users/xonevn/xoneai-package/.cursorrules"):
        print("Warning: .cursorrules file not found")
    if not os.path.exists("/Users/xonevn/xoneai-package/xoneai/test.py"):
