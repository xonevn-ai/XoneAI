...
for var in ['XONEAI_TELEMETRY_DISABLED', 'XONEAI_DISABLE_TELEMETRY', 'DO_NOT_TRACK']:
...
from xoneaiagents.telemetry.integration import instrument_agent
...
from xoneaiagents.telemetry.integration import auto_instrument_all
