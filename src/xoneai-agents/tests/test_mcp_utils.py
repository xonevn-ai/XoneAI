...
class TestFunctionToMCPSchema:
    ...
    def test_simple_function_with_string_param(self):
        ...
        from xoneaiagents.mcp.mcp_utils import function_to_mcp_schema
...
class TestGetToolMetadata:
    ...
    def test_extracts_name(self):
        ...
        from xoneaiagents.mcp.mcp_utils import get_tool_metadata
...
class TestPythonTypeToJsonSchema:
    ...
    def test_basic_types(self):
        ...
        from xoneaiagents.mcp.mcp_utils import python_type_to_json_schema
