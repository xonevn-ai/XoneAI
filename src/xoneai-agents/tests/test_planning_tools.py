...
class TestAgentsPlanningTools:
    ...
    def test_xoneaiagents_accepts_planning_tools(self):
    ...
    def test_xoneaiagents_planning_tools_default_none(self):
    ...
    def test_xoneaiagents_passes_tools_to_planning_agent(self):
...
class TestAgentsPlanningReasoning:
    ...
    def test_xoneaiagents_accepts_planning_reasoning(self):
    ...
    def test_xoneaiagents_planning_reasoning_default_false(self):
    ...
    def test_xoneaiagents_passes_reasoning_to_planning_agent(self):
...
class TestResearchToolsList:
    ...
    def test_research_tools_list_exists(self):
        ...
        from xoneaiagents.planning import RESEARCH_TOOLS
