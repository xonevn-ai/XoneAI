...
- Integration with existing XoneAI structure
"""
...
def test_agent_inheritance():
    ...
    try:
        from xoneaiagents import ContextAgent, Agent
...
def test_context_engineering_methods():
    ...
    try:
        from xoneaiagents import create_context_agent
...
def test_protocol_compliance():
    ...
    try:
        from xoneaiagents import ContextAgent, create_context_agent
        from xoneaiagents.agent import ContextEngineerProtocol
...
def test_backward_compatibility():
    """Test that existing XoneAI functionality still works."""
    print("\\n🧪 Testing Backward Compatibility...")
    
    try:
        # Test that we can still import and use existing agents
        from xoneaiagents import Agent, ImageAgent
        ...
        # Test that we can import other XoneAI components
        from xoneaiagents import Task, AgentTeam
        ...
        for export in expected_exports:
            assert hasattr(xoneaiagents, export), f"Missing export: {export}"
...
def test_syntax_validation():
    ...
    try:
        ...
        context_agent_file = project_root / "xoneaiagents" / "agent" / "context_agent.py"
