...
class TestAgentDictParamsResolver:
    ...
    def test_agent_output_dict_resolution(self):
        ...
        from xoneaiagents.config.param_resolver import resolve, ArrayMode
        from xoneaiagents.config.feature_configs import OutputConfig
        from xoneaiagents.config.presets import OUTPUT_PRESETS
    ...
    def test_agent_execution_dict_resolution(self):
        ...
        from xoneaiagents.config.param_resolver import resolve, ArrayMode
        from xoneaiagents.config.feature_configs import ExecutionConfig
        from xoneaiagents.config.presets import EXECUTION_PRESETS
...
class TestAgentsDictParamsResolver:
    ...
    def test_agents_output_dict_resolution(self):
        ...
        from xoneaiagents.config.param_resolver import resolve, ArrayMode
        from xoneaiagents.config.feature_configs import MultiAgentOutputConfig
        from xoneaiagents.config.presets import MULTI_AGENT_OUTPUT_PRESETS
    ...
    def test_agents_execution_dict_resolution(self):
        ...
        from xoneaiagents.config.param_resolver import resolve, ArrayMode
        from xoneaiagents.config.feature_configs import MultiAgentExecutionConfig
        from xoneaiagents.config.presets import MULTI_AGENT_EXECUTION_PRESETS
    ...
    def test_agents_hooks_dict_resolution(self):
        ...
        from xoneaiagents.config.param_resolver import resolve, ArrayMode
        from xoneaiagents.config.feature_configs import MultiAgentHooksConfig
...
class TestWorkflowDictParams:
    ...
    def test_workflow_output_dict(self):
        ...
        from xoneaiagents.workflows.workflows import Workflow
    ...
    def test_workflowstep_context_dict(self):
        ...
        from xoneaiagents.workflows.workflows import Task
        from xoneaiagents.workflows.workflow_configs import TaskContextConfig
...
class TestBackwardCompatibility:
    ...
    def test_bool_true_creates_default_config(self):
        ...
        from xoneaiagents.config.param_resolver import resolve
        from xoneaiagents.config.feature_configs import PlanningConfig
    ...
    def test_bool_false_returns_none(self):
        ...
        from xoneaiagents.config.param_resolver import resolve
        from xoneaiagents.config.feature_configs import ReflectionConfig
...
class TestBaseUrlApiKeySeparation:
    ...
    def test_agent_base_url_separate(self):
        ...
        from xoneaiagents.agent.agent import Agent
        import inspect
