...
class TestEvaluationLoopIntegration:
    ...
    def test_evaluation_loop_with_agent_and_judge(self):
        ...
        from xoneaiagents.eval import EvaluationLoop, EvaluationLoopResult
        
        with patch('xoneaiagents.agent.agent.Agent.chat') as mock_chat, \
...
class TestEvaluationLoopResultSerialization:
    ...
    def test_result_to_json(self):
        ...
        from xoneaiagents.eval.results import IterationResult, EvaluationLoopResult
        import json
