"""
WebSocket integration tests for the XoneAI Gateway.
...
class TestWebSocketIntegration:
    ...
    async def test_gateway_health_endpoint(self):
        ...
        try:
            from xoneai.gateway.server import WebSocketGateway, GatewayConfig
        except ImportError:
            pytest.skip("xoneai.gateway not available")
    ...
    async def test_websocket_connect_and_message(self):
        ...
        try:
            ...
            pytest.skip("websockets or xoneai.gateway not available")
...
class TestChannelCommandFiltering:
    ...
    def test_register_command_with_channels(self):
        ...
        try:
            from xoneai.bots._protocol_mixin import ChatCommandMixin
        except ImportError:
            pytest.skip("xoneai.bots not available")
