...
from xoneaiagents.bots import ChatCommandInfo, ChatCommandProtocol
...
class TestChatCommandProtocolTelegram:
    ...
    def _make_bot(self):
        from xoneai.bots.telegram import TelegramBot
...
class TestChatCommandProtocolDiscord:
    ...
    def _make_bot(self):
        from xoneai.bots.discord import DiscordBot
...
class TestChatCommandProtocolSlack:
    ...
    def _make_bot(self):
        from xoneai.bots.slack import SlackBot
