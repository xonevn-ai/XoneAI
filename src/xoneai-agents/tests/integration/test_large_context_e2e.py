...
class TestLargeContextE2E:
    ...
    def test_full_indexing_pipeline(self):
        ...
        from xoneaiagents.knowledge.indexing import CorpusStats, IndexResult
    ...
    def test_strategy_selection_by_corpus_size(self):
        ...
        from xoneaiagents.rag.strategy import select_strategy, RetrievalStrategy
    ...
    def test_token_budget_enforcement(self):
        ...
        from xoneaiagents.rag.budget import TokenBudget, DefaultBudgetEnforcer
    ...
    def test_compression_pipeline(self):
        ...
        from xoneaiagents.rag.compressor import ContextCompressor
    ...
    def test_smart_retriever_filtering(self):
        ...
        from xoneaiagents.rag.retriever import SmartRetriever
    ...
    def test_hierarchical_summarizer(self):
        ...
        from xoneaiagents.rag.summarizer import HierarchicalSummarizer
    ...
    def test_retrieval_config_integration(self):
        ...
        from xoneaiagents.rag.retrieval_config import RetrievalConfig
        from xoneaiagents.knowledge.indexing import CorpusStats
...
class TestPerformance:
    ...
    def test_import_time_acceptable(self):
        ...
        cmd = [
            sys.executable, "-c",
            "import time; start=time.time(); import xoneaiagents; print(time.time()-start)"
        ]
    ...
    def test_no_heavy_deps_at_import(self):
        ...
        cmd = [
            sys.executable, "-c",
            "import sys; import xoneaiagents; print('mem0' in sys.modules)"
        ]
        result = subprocess.run(cmd, capture_output=True, text=True, timeout=30)
