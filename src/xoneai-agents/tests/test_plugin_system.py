...
class TestBaseTool:
    ...
    def test_import_from_main_package(self):
        """BaseTool should be importable from xoneaiagents."""
...
class TestToolDecorator:
    ...
    def test_import_from_main_package(self):
        """tool decorator should be importable from xoneaiagents."""
    ...
    def test_decorated_function_is_basetool(self):
        ...
        from xoneaiagents import tool, BaseTool
...
class TestToolRegistry:
    ...
    def test_import_from_main_package(self):
        """Registry functions should be importable from xoneaiagents."""
        from xoneaiagents import get_registry, register_tool, get_tool, ToolRegistry
    ...
    def test_register_and_get_basetool(self):
        ...
        from xoneaiagents import BaseTool, ToolRegistry
    ...
    def test_register_and_get_function(self):
        ...
        from xoneaiagents import ToolRegistry
    ...
    def test_list_tools(self):
        ...
        from xoneaiagents import ToolRegistry, BaseTool
    ...
    def test_global_registry_singleton(self):
        ...
        from xoneaiagents import get_registry
...
class TestToolResult:
    ...
    def test_import_from_main_package(self):
        """ToolResult should be importable from xoneaiagents."""
        from xoneaiagents import ToolResult
...
class TestFunctionTool:
    ...
    def test_import_from_main_package(self):
        """FunctionTool should be importable from xoneaiagents."""
        from xoneaiagents import FunctionTool
...
class TestAgentIntegration:
    ...
    def test_agent_with_tool_names_from_registry(self):
        ...
        from xoneaiagents import Agent, BaseTool, register_tool, get_registry
...
class TestPluginDiscovery:
    ...
    def test_discover_plugins_with_mock_entry_point(self, mocker):
        ...
        import xoneaiagents.tools.registry as registry_module
...
class TestToolValidation:
    ...
    def test_tool_with_manually_cleared_name_fails(self):
        ...
        from xoneaiagents import BaseTool, ToolValidationError
    ...
    def test_validate_tool_function_with_basetool(self):
        ...
        from xoneaiagents import BaseTool, validate_tool
    ...
    def test_validate_tool_rejects_invalid_type(self):
        ...
        from xoneaiagents import validate_tool, ToolValidationError
    ...
    def test_decorated_tool_passes_validation(self):
        ...
        from xoneaiagents import tool, validate_tool
