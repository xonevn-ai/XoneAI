...
class TestAsyncFileOps:
    ...
    def test_aiofiles_availability_check(self):
        ...
        from xoneaiagents.context.fast.async_file_ops import is_aiofiles_available
    ...
    async def test_async_read_file(self, temp_file):
        ...
        from xoneaiagents.context.fast.async_file_ops import async_read_file
    ...
    async def test_async_read_lines(self, temp_file):
        ...
        from xoneaiagents.context.fast.async_file_ops import async_read_lines
    ...
    async def test_fallback_works_without_aiofiles(self, temp_file, monkeypatch):
        ...
        from xoneaiagents.context.fast import async_file_ops
