...
class TestFileMatch:
    ...
    def test_add_line_range(self):
        ...
        from xoneaiagents.context.fast.result import FileMatch, LineRange
...
class TestFastContextResult:
    ...
    def test_add_file(self):
        """Test adding files."""
        from xoneaiagents.context.fast.result import FastContextResult, FileMatch
    ...
    def test_add_duplicate_file_merges(self):
        ...
        from xoneaiagents.context.fast.result import (
