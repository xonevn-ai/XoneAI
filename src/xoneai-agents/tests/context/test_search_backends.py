...
class TestRipgrepBackend:
    ...
    def test_ripgrep_fallback_to_python(self, temp_workspace, monkeypatch):
        ...
        from xoneaiagents.context.fast.search_backends import RipgrepBackend, get_search_backend
...
class TestSmartBackend:
    ...
    def test_smart_backend_available(self):
        ...
        from xoneaiagents.context.fast.search_backends import SmartBackend
    ...
    def test_count_files_fast(self, temp_workspace):
        ...
        from xoneaiagents.context.fast.search_backends import _count_files_fast
    ...
    def test_threshold_constant(self):
        ...
        from xoneaiagents.context.fast.search_backends import RIPGREP_FILE_THRESHOLD
