...
pytest.importorskip("mcp", reason="MCP module not installed. Install with: pip install xoneaiagents[mcp]")
...
class TestHTTPStreamTransportInit:
    ...
    def test_transport_has_protocol_version_header(self):
        ...
        from xoneaiagents.mcp.mcp_http_stream import HTTPStreamTransport
...
class TestHTTPStreamTransportAutoDetection:
    ...
    def test_http_url_uses_http_stream_transport(self):
        ...
        from xoneaiagents.mcp.mcp_transport import get_transport_type
...
class TestSSEEventParsing:
    ...
    def test_parse_sse_event_with_id(self):
        ...
        from xoneaiagents.mcp.mcp_session import parse_sse_event
...
class TestResumabilityManager:
    ...
    def test_manager_tracks_event_ids(self):
        ...
        from xoneaiagents.mcp.mcp_session import ResumabilityManager
...
class TestEventStore:
    ...
    def test_store_events(self):
        """Test storing events."""
        from xoneaiagents.mcp.mcp_session import EventStore
