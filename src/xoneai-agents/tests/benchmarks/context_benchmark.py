"""
Context Management Benchmarks for XoneAI Agents.
...
def benchmark_context_disabled():
    ...
    from xoneaiagents.context import ContextManager, ManagerConfig
...
def benchmark_token_estimation():
    ...
    from xoneaiagents.context import estimate_messages_tokens
...
def benchmark_optimization_small():
    ...
    from xoneaiagents.context import get_optimizer, OptimizerStrategy
...
def benchmark_store_operations():
    ...
    from xoneaiagents.context import ContextStoreImpl, reset_global_store
...
def benchmark_effective_history_filter():
    ...
    from xoneaiagents.context import get_effective_history
