"""
Test AG-UI Event Streaming - TDD Tests for Streaming XoneAI Responses
...
class TestTextMessageStreaming:
    ...
    def test_stream_simple_text(self):
        ...
        from xoneaiagents.ui.agui.streaming import create_text_message_events
    ...
    def test_stream_chunked_text(self):
        ...
        from xoneaiagents.ui.agui.streaming import stream_text_chunks
...
class TestToolCallStreaming:
    ...
    def test_stream_tool_call(self):
        ...
        from xoneaiagents.ui.agui.streaming import create_tool_call_events
    ...
    def test_stream_tool_result(self):
        ...
        from xoneaiagents.ui.agui.streaming import create_tool_result_event
...
class TestRunLifecycleEvents:
    ...
    def test_create_run_started_event(self):
        ...
        from xoneaiagents.ui.agui.streaming import create_run_started_event
    ...
    def test_create_run_finished_event(self):
        ...
        from xoneaiagents.ui.agui.streaming import create_run_finished_event
    ...
    def test_create_run_error_event(self):
        ...
        from xoneaiagents.ui.agui.streaming import create_run_error_event
...
class TestStepEvents:
    ...
    def test_create_step_started_event(self):
        ...
        from xoneaiagents.ui.agui.streaming import create_step_started_event
    ...
    def test_create_step_finished_event(self):
        ...
        from xoneaiagents.ui.agui.streaming import create_step_finished_event
...
class TestEventBuffer:
    ...
    def test_event_buffer_creation(self):
        ...
        from xoneaiagents.ui.agui.streaming import EventBuffer
...
class TestAsyncStreaming:
    ...
    def test_async_stream_response(self):
        ...
        async def run_test():
            from xoneaiagents.ui.agui.streaming import async_stream_response
...
class TestStateSnapshotEvents:
    ...
    def test_create_state_snapshot_event(self):
        ...
        from xoneaiagents.ui.agui.streaming import create_state_snapshot_event
