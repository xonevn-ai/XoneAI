...
class TestEventType:
    ...
    def test_event_type_text_message_start(self):
        ...
        from xoneaiagents.ui.agui.types import EventType
...
class TestBaseEvent:
    ...
    def test_base_event_creation(self):
        ...
        from xoneaiagents.ui.agui.types import BaseEvent, EventType
...
class TestTextMessageEvents:
    ...
    def test_text_message_start_event(self):
        ...
        from xoneaiagents.ui.agui.types import TextMessageStartEvent
    ...
    def test_text_message_content_event(self):
        ...
        from xoneaiagents.ui.agui.types import TextMessageContentEvent
    ...
    def test_text_message_end_event(self):
        ...
        from xoneaiagents.ui.agui.types import TextMessageEndEvent
...
class TestToolCallEvents:
    ...
    def test_tool_call_start_event(self):
        ...
        from xoneaiagents.ui.agui.types import ToolCallStartEvent
    ...
    def test_tool_call_args_event(self):
        ...
        from xoneaiagents.ui.agui.types import ToolCallArgsEvent
    ...
    def test_tool_call_end_event(self):
        ...
        from xoneaiagents.ui.agui.types import ToolCallEndEvent
    ...
    def test_tool_call_result_event(self):
        ...
        from xoneaiagents.ui.agui.types import ToolCallResultEvent
...
class TestRunEvents:
    ...
    def test_run_started_event(self):
        ...
        from xoneaiagents.ui.agui.types import RunStartedEvent
    ...
    def test_run_finished_event(self):
        ...
        from xoneaiagents.ui.agui.types import RunFinishedEvent
    ...
    def test_run_error_event(self):
        ...
        from xoneaiagents.ui.agui.types import RunErrorEvent
...
class TestStepEvents:
    ...
    def test_step_started_event(self):
        ...
        from xoneaiagents.ui.agui.types import StepStartedEvent
    ...
    def test_step_finished_event(self):
        ...
        from xoneaiagents.ui.agui.types import StepFinishedEvent
...
class TestStateEvents:
    ...
    def test_state_snapshot_event(self):
        ...
        from xoneaiagents.ui.agui.types import StateSnapshotEvent
...
class TestMessageTypes:
    ...
    def test_user_message(self):
        ...
        from xoneaiagents.ui.agui.types import Message
...
class TestToolCall:
    ...
    def test_tool_call_creation(self):
        ...
        from xoneaiagents.ui.agui.types import ToolCall, FunctionCall
        tc = ToolCall(
            id="tc-123",
...
class TestRunAgentInput:
    ...
    def test_run_agent_input_creation(self):
        ...
        from xoneaiagents.ui.agui.types import RunAgentInput, Message
    ...
    def test_run_agent_input_optional_fields(self):
        ...
        from xoneaiagents.ui.agui.types import RunAgentInput
...
class TestEventSerialization:
    ...
    def test_event_sse_format(self):
        ...
        from xoneaiagents.ui.agui.types import TextMessageStartEvent
        from xoneaiagents.ui.agui.encoder import EventEncoder
