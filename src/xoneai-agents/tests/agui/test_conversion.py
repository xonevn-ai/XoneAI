...
- Test converting AG-UI messages to XoneAI format
- Test converting XoneAI messages to AG-UI format
- Test handling of tool calls
- Test handling of tool results
- Test edge cases (empty messages, missing fields)
"""

class TestAGUIToXoneAIConversion:
    """Test converting AG-UI messages to XoneAI format."""
    
    def test_convert_user_message(self):
        """Test converting a user message."""
        from xoneaiagents.ui.agui.conversion import agui_messages_to_xoneai
        from xoneaiagents.ui.agui.types import Message
        
        agui_messages = [Message(role="user", content="Hello")]
        result = agui_messages_to_xoneai(agui_messages)
    ...
    def test_convert_assistant_with_tool_calls(self):
        ...
        from xoneaiagents.ui.agui.conversion import agui_messages_to_xoneai
        from xoneaiagents.ui.agui.types import Message, ToolCall, FunctionCall
    ...
    def test_convert_empty_messages(self):
        ...
        result = agui_messages_to_xoneai([])
        assert result == []
...
class TestXoneAIToAGUIConversion:
    """Test converting XoneAI messages to AG-UI format."""
    
    def test_convert_user_message(self):
        """Test converting a user message."""
        from xoneaiagents.ui.agui.conversion import xoneai_messages_to_agui
        
        xone_messages = [{"role": "user", "content": "Hello"}]
        result = xoneai_messages_to_agui(xone_messages)
    ...
    def test_convert_assistant_message(self):
        ...
        xone_messages = [{"role": "assistant", "content": "Hi there!"}]
        result = xoneai_messages_to_agui(xone_messages)
    ...
    def test_convert_empty_messages(self):
        ...
        result = xoneai_messages_to_agui([])
        assert result == []
...
class TestStateConversion:
    ...
    def test_validate_dict_state(self):
        ...
        from xoneaiagents.ui.agui.conversion import validate_state
...
class TestExtractUserInput:
    ...
    def test_extract_last_user_message(self):
        ...
        from xoneaiagents.ui.agui.conversion import extract_user_input
        from xoneaiagents.ui.agui.types import Message
