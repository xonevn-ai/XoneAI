...
class TestAgentScheduleToolIntegration:
    ...
    def test_agent_accepts_schedule_tools_as_functions(self):
        ...
        from xoneaiagents.tools.schedule_tools import schedule_add, schedule_list, schedule_remove
    ...
    def test_schedule_tool_schema_generation(self):
        ...
        from xoneaiagents.tools.schedule_tools import schedule_add, schedule_list, schedule_remove
        from xoneaiagents.tools.decorator import get_tool_schema
