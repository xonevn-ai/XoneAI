...
class TestProfilerBasics:
    ...
    def test_profiler_disabled_by_default(self):
        ...
        from xoneaiagents.profiling import Profiler
    ...
    def test_profiler_env_var_enable(self):
        ...
        with patch.dict('os.environ', {'XONEAI_PROFILE': '1'}):
            assert Profiler.is_enabled()
        
        with patch.dict('os.environ', {'XONEAI_PROFILE': 'true'}):
            assert Profiler.is_enabled()
        
        with patch.dict('os.environ', {'XONEAI_PROFILE': 'yes'}):
            assert Profiler.is_enabled()
...
class TestStreamingTracker:
    ...
    def test_streaming_ttft(self):
        ...
        from xoneaiagents.profiling import Profiler, StreamingTracker
...
class TestProfileDecorators:
    ...
    def test_profile_func_decorator(self):
        ...
        from xoneaiagents.profiling import Profiler, profile_func
...
class TestProfileBlock:
    ...
    def test_profile_block(self):
        ...
        from xoneaiagents.profiling import Profiler, profile_block
