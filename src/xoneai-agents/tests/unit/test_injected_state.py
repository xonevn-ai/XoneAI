...
class TestInjectedTypeExists:
    ...
    def test_injected_type_exists(self):
        """Injected type should exist in xoneaiagents.tools."""
        from xoneaiagents.tools import Injected
    ...
    def test_injected_with_agent_state(self):
        ...
        from xoneaiagents.tools import Injected
        from xoneaiagents.tools.injected import AgentState
...
class TestToolExecutionInjection:
    ...
    def test_injected_state_provided_at_runtime(self):
        ...
        from xoneaiagents.tools.injected import with_injection_context
    ...
    def test_injected_dict_state(self):
        ...
        from xoneaiagents import tool
        from xoneaiagents.tools import Injected
        from xoneaiagents.tools.injected import with_injection_context, AgentState
...
class TestInjectionContextManager:
    ...
    def test_context_manager_sets_state(self):
        ...
        from xoneaiagents.tools.injected import (
