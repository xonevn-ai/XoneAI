...
class TestF1_AgentManagerAutonomyPropagation:
    ...
    def test_autonomy_bool_propagated(self):
        ...
        from xoneaiagents.agents.agents import AgentManager
...
class TestF4_AutonomyConfigLevel:
    ...
    def test_autonomy_level_reexported(self):
        """AutonomyLevel should be importable from xoneaiagents."""
        from xoneaiagents import AutonomyLevel
        assert AutonomyLevel.SUGGEST.value == "suggest"

    def test_autonomy_config_reexported(self):
        """AutonomyConfig should be importable from xoneaiagents."""
        from xoneaiagents import AutonomyConfig
        cfg = AutonomyConfig()
...
class TestDRY_Exports:
    ...
    def test_autonomy_level_in_all(self):
        """AutonomyLevel should be in xoneaiagents.__all__."""
        import xoneaiagents
        assert "AutonomyLevel" in xoneaiagents.__all__

    def test_autonomy_config_in_all(self):
        """AutonomyConfig should be in xoneaiagents.__all__."""
        import xoneaiagents
        assert "AutonomyConfig" in xoneaiagents.__all__

    def test_autonomy_result_importable(self):
        """AutonomyResult should be importable."""
        from xoneaiagents.agent.autonomy import AutonomyResult
    ...
    def test_autonomy_stage_importable(self):
        ...
        from xoneaiagents.agent.autonomy import AutonomyStage
        from xoneaiagents.escalation.types import EscalationStage
...
class TestIntegration_AutonomyWiring:
    ...
    def test_autoagents_propagates_autonomy(self):
        ...
        from xoneaiagents.agents.autoagents import AutoAgents
