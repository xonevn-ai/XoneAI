...
class TestToPrompt:
    ...
    def test_to_prompt_empty_list(self):
        ...
        from xoneaiagents.skills.prompt import to_prompt
...
class TestGenerateSkillsXml:
    ...
    def test_generate_skills_xml_from_metadata_list(self):
        ...
        from xoneaiagents.skills.prompt import generate_skills_xml
...
class TestFormatSkillForPrompt:
    ...
    def test_format_single_skill(self):
        ...
        from xoneaiagents.skills.prompt import format_skill_for_prompt
        from xoneaiagents.skills.models import SkillMetadata
