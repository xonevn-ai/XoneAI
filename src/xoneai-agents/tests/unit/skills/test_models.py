...
class TestSkillProperties:
    ...
    def test_skill_properties_required_fields(self):
        ...
        from xoneaiagents.skills.models import SkillProperties
...
class TestSkillMetadata:
    ...
    def test_skill_metadata_required_fields(self):
        ...
        from xoneaiagents.skills.models import SkillMetadata
    ...
    def test_skill_metadata_from_properties(self):
        ...
        from xoneaiagents.skills.models import SkillProperties, SkillMetadata
...
class TestParseError:
    ...
    def test_parse_error_message(self):
        ...
        from xoneaiagents.skills.models import ParseError
...
class TestValidationError:
    ...
    def test_validation_error_message(self):
        ...
        from xoneaiagents.skills.models import ValidationError
