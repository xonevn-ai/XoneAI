...
class TestParseFrontmatter:
    ...
    def test_parse_valid_frontmatter(self):
        ...
        from xoneaiagents.skills.parser import parse_frontmatter
...
class TestFindSkillMd:
    ...
    def test_find_skill_md_uppercase(self):
        ...
        from xoneaiagents.skills.parser import find_skill_md
...
class TestReadProperties:
    ...
    def test_read_properties_valid_skill(self):
        ...
        from xoneaiagents.skills.parser import read_properties
