...
class TestEmbeddingAgentInit:
    ...
    def test_import_embedding_agent(self):
        """EmbeddingAgent should be importable from xoneaiagents."""
        from xoneaiagents import EmbeddingAgent
        assert EmbeddingAgent is not None
    
    def test_import_embedding_config(self):
        """EmbeddingConfig should be importable."""
        from xoneaiagents import EmbeddingConfig
...
class TestEmbeddingConfig:
    ...
    def test_default_config(self):
        ...
        from xoneaiagents.agent.embedding_agent import EmbeddingConfig
