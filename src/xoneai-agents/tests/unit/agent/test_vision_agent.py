...
class TestVisionAgentInit:
    ...
    def test_import_vision_agent(self):
        """VisionAgent should be importable from xoneaiagents."""
        from xoneaiagents import VisionAgent
        assert VisionAgent is not None
    
    def test_import_vision_config(self):
        """VisionConfig should be importable."""
        from xoneaiagents import VisionConfig
...
class TestVisionConfig:
    ...
    def test_default_config(self):
        ...
        from xoneaiagents.agent.vision_agent import VisionConfig
        config = VisionConfig()
