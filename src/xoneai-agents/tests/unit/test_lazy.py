...
class TestLazyImport:
    ...
    def test_lazy_import_returns_attribute(self):
        ...
        from xoneaiagents._lazy import lazy_import
        
        # Import a known module attribute
        result = lazy_import('xoneaiagents.hooks.types', 'HookEvent')
    ...
    def test_lazy_import_caches_result(self):
        ...
        # First call
        result1 = lazy_import('xoneaiagents.hooks.types', 'HookEvent', cache=cache)
        
        # Second call should use cache
        result2 = lazy_import('xoneaiagents.hooks.types', 'HookEvent', cache=cache)
        
        assert result1 is result2
        assert 'xoneaiagents.hooks.types.HookEvent' in cache
    ...
    def test_lazy_import_thread_safe(self):
        ...
        def import_in_thread():
            try:
                result = lazy_import('xoneaiagents.hooks.types', 'HookEvent', cache=cache)
    ...
    def test_lazy_import_raises_on_invalid_attribute(self):
        ...
        with pytest.raises(AttributeError):
            lazy_import('xoneaiagents.hooks.types', 'NonexistentAttr')
...
class TestLazyModule:
    ...
    def test_lazy_module_defers_import(self):
        ...
        from xoneaiagents._lazy import LazyModule
        
        # Create a lazy module
        lazy = LazyModule('xoneaiagents.hooks.types')
...
class TestCreateLazyGetattr:
    ...
    def test_create_lazy_getattr_returns_function(self):
        ...
        from xoneaiagents._lazy import create_lazy_getattr
...
class TestLazyImportPerformance:
    ...
    def test_lazy_import_is_fast(self):
        ...
        # Prime the cache
        lazy_import('xoneaiagents.hooks.types', 'HookEvent', cache=cache)
