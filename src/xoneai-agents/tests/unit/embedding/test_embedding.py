"""
Unit tests for xoneaiagents.embedding module.
...
class TestAsyncEmbedding:
    ...
    async def test_aembedding_single_text(self, mock_aembedding):
        ...
        from xoneaiagents.embedding import aembedding
...
class TestGetDimensions:
    ...
    def test_get_dimensions_known_models(self):
        ...
        from xoneaiagents.embedding import get_dimensions
...
class TestAliases:
    ...
    def test_embed_alias(self):
        ...
        from xoneaiagents.embedding.embed import embedding, embed
        
        assert embed is embedding
    
    def test_aembed_alias(self):
        """Test that aembed is an alias for aembedding."""
        from xoneaiagents.embedding.embed import aembedding, aembed
...
class TestBackwardsCompatibility:
    ...
    def test_import_embedding_function_from_embedding_module(self):
        """Test importing embedding function from xoneaiagents.embedding."""
        from xoneaiagents.embedding import embedding
    ...
    def test_import_embedding_result(self):
        """Test importing EmbeddingResult from xoneaiagents.embedding."""
        from xoneaiagents.embedding import EmbeddingResult
...
class TestSimplifiedImports:
    ...
    def test_from_xoneaiagents_import_embedding_returns_function(self):
        """Test that 'from xoneaiagents import embedding' returns the function, not module."""
        from xoneaiagents import embedding
    ...
    def test_from_xoneaiagents_import_embeddings_returns_function(self):
        """Test that 'from xoneaiagents import embeddings' (plural) works as alias."""
        from xoneaiagents import embeddings
    ...
    def test_embedding_and_embeddings_are_same_function(self):
        ...
        from xoneaiagents import embedding, embeddings
        
        assert embedding is embeddings, "embedding and embeddings should be the same function"
    
    def test_from_xoneaiagents_import_aembedding(self):
        """Test that 'from xoneaiagents import aembedding' works."""
        from xoneaiagents import aembedding
        
        assert callable(aembedding)
    
    def test_from_xoneaiagents_import_aembeddings(self):
        """Test that 'from xoneaiagents import aembeddings' (plural) works as alias."""
        from xoneaiagents import aembeddings
        
        assert callable(aembeddings)
    
    def test_from_xoneaiagents_import_EmbeddingResult(self):
        """Test that 'from xoneaiagents import EmbeddingResult' works."""
        from xoneaiagents import EmbeddingResult
        
        # Should be a class
        assert isinstance(EmbeddingResult, type) or hasattr(EmbeddingResult, '__dataclass_fields__')
    
    def test_from_xoneaiagents_import_get_dimensions(self):
        """Test that 'from xoneaiagents import get_dimensions' works."""
        from xoneaiagents import get_dimensions
    ...
    def test_all_embedding_imports_together(self):
        ...
        from xoneaiagents import embedding, embeddings, aembedding, aembeddings, EmbeddingResult, get_dimensions
