...
class TestMiddlewareTypes:
    ...
    def test_invocation_context_exists(self):
        ...
        from xoneaiagents.hooks.middleware import InvocationContext
    ...
    def test_model_request_exists(self):
        ...
        from xoneaiagents.hooks.middleware import ModelRequest
    ...
    def test_model_response_exists(self):
        ...
        from xoneaiagents.hooks.middleware import ModelResponse
    ...
    def test_tool_request_exists(self):
        ...
        from xoneaiagents.hooks.middleware import ToolRequest
    ...
    def test_tool_response_exists(self):
        ...
        from xoneaiagents.hooks.middleware import ToolResponse
...
class TestMiddlewareDecorators:
    ...
    def test_before_model_decorator_exists(self):
        ...
        from xoneaiagents.hooks import before_model
    ...
    def test_after_model_decorator_exists(self):
        ...
        from xoneaiagents.hooks import after_model
    ...
    def test_wrap_model_call_decorator_exists(self):
        ...
        from xoneaiagents.hooks import wrap_model_call
    ...
    def test_before_tool_decorator_exists(self):
        ...
        from xoneaiagents.hooks import before_tool
    ...
    def test_after_tool_decorator_exists(self):
        ...
        from xoneaiagents.hooks import after_tool
    ...
    def test_wrap_tool_call_decorator_exists(self):
        ...
        from xoneaiagents.hooks import wrap_tool_call
...
class TestMiddlewareChaining:
    ...
    def test_wrap_model_call_chain_order(self):
        ...
        from xoneaiagents.hooks.middleware import MiddlewareChain
...
class TestAsyncMiddleware:
    ...
    async def test_async_wrap_model_call(self):
        ...
        from xoneaiagents.hooks.middleware import AsyncMiddlewareChain
