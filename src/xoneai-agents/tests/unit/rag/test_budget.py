...
class TestTokenBudget:
    ...
    def test_import_token_budget(self):
        ...
        from xoneaiagents.rag.budget import TokenBudget
...
class TestModelContextWindows:
    ...
    def test_get_model_context_window(self):
        ...
        from xoneaiagents.rag.budget import get_model_context_window
...
class TestBudgetEnforcement:
    ...
    def test_budget_enforcer_protocol(self):
        ...
        from xoneaiagents.rag.budget import BudgetEnforcerProtocol
    ...
    def test_default_budget_enforcer(self):
        ...
        from xoneaiagents.rag.budget import DefaultBudgetEnforcer, TokenBudget
