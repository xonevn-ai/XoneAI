...
import pytest
from xoneaiagents.rag.retrieval_config import (
    RetrievalConfig,
    RetrievalPolicy,
    CitationsMode,
...
class TestConfigConversion:
    ...
    def test_to_knowledge_config(self):
        ...
        assert knowledge_config["vector_store"]["config"]["path"] == ".xone/test"
...
class TestLegacyConfigMigration:
    ...
    def test_create_from_knowledge_config(self):
        ...
        assert config.persist_path == ".xone/custom"
