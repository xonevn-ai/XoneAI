...
class TestImportPerformance:
    ...
    def test_rag_module_import_time(self):
        ...
        modules_to_clear = [k for k in sys.modules.keys() if 'xoneaiagents.rag' in k]
        for mod in modules_to_clear:
            del sys.modules[mod]
        
        start = time.time()
        from xoneaiagents.rag import RAG, RAGConfig, RAGResult
    ...
    def test_no_heavy_deps_on_import(self):
        ...
        # Import RAG
        from xoneaiagents.rag import RAG, RAGConfig, Citation
    ...
    def test_lazy_loading_works(self):
        ...
        from xoneaiagents.rag import __getattr__, _LAZY_IMPORTS
...
class TestProtocolCompliance:
    ...
    def test_rag_protocol_compliance(self):
        ...
        from xoneaiagents.rag.protocols import RAGProtocol
        from xoneaiagents.rag.pipeline import RAG
    ...
    def test_context_builder_protocol(self):
        ...
        from xoneaiagents.rag.protocols import ContextBuilderProtocol
        from xoneaiagents.rag.context import DefaultContextBuilder
    ...
    def test_citation_formatter_protocol(self):
        ...
        from xoneaiagents.rag.protocols import CitationFormatterProtocol
        from xoneaiagents.rag.pipeline import DefaultCitationFormatter
...
class TestMainPackageExports:
    ...
    def test_rag_in_all(self):
        ...
        assert hasattr(xoneaiagents, 'RAG'), "RAG not accessible from xoneaiagents"
        assert hasattr(xoneaiagents, 'RAGConfig'), "RAGConfig not accessible"
        assert hasattr(xoneaiagents, 'RAGResult'), "RAGResult not accessible"
    
    def test_rag_accessible_from_main(self):
        """Test that RAG classes are accessible from main package."""
        from xoneaiagents import RAG, RAGConfig, RAGResult
