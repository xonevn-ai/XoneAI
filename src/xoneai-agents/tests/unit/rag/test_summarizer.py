...
class TestHierarchicalSummarizer:
    ...
    def test_summary_node_dataclass(self):
        ...
        from xoneaiagents.rag.summarizer import SummaryNode
    ...
    def test_hierarchy_result_dataclass(self):
        ...
        from xoneaiagents.rag.summarizer import HierarchyResult
...
class TestEstimateTokensSummarizer:
    ...
    def test_estimate_tokens(self):
        ...
        from xoneaiagents.rag.summarizer import estimate_tokens
