...
from xoneaiagents.knowledge.protocols import ScopeRequiredError
...
class TestMem0AdapterLazyLoading:
    ...
    def test_mem0_not_imported_at_module_level(self):
        ...
        from xoneaiagents.knowledge.adapters import mem0_adapter
    ...
    def test_adapter_class_importable(self):
        ...
        from xoneaiagents.knowledge.adapters import Mem0Adapter
...
class TestMem0AdapterNormalization:
    ...
    def test_normalize_mem0_item_with_none_metadata(self):
        ...
        from xoneaiagents.knowledge.adapters.mem0_adapter import Mem0Adapter
