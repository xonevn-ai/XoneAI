...
Tests IndexResult, CorpusStats, incremental indexing, and .xoneignore support.
"""
...
class TestIndexResult:
    ...
    def test_import_index_result(self):
        ...
        from xoneaiagents.knowledge.indexing import IndexResult
...
class TestIgnoreMatcher:
    """Tests for .xoneignore pattern matching."""
    
    def test_import_ignore_matcher(self):
        """IgnoreMatcher should be importable."""
        from xoneaiagents.knowledge.indexing import IgnoreMatcher
    ...
    def test_from_file(self):
        """IgnoreMatcher should load patterns from .xoneignore file."""
        from xoneaiagents.knowledge.indexing import IgnoreMatcher
        
        with tempfile.TemporaryDirectory() as tmpdir:
            ignore_file = os.path.join(tmpdir, ".xoneignore")
    ...
    def test_from_directory(self):
        """IgnoreMatcher should auto-detect .xoneignore in directory."""
        from xoneaiagents.knowledge.indexing import IgnoreMatcher
...
class TestFileTracker:
    ...
    def test_import_file_tracker(self):
        ...
        from xoneaiagents.knowledge.indexing import FileTracker
    ...
    def test_persist_and_load(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            state_file = os.path.join(tmpdir, ".xone_index_state.json")
            test_file = os.path.join(tmpdir, "test.txt")
            with open(test_file, "w") as f:
                f.write("Hello World")
