...
- XoneAIAgents has been REMOVED entirely
"""
import pytest
import warnings
...
class TestAgentManagerRename:
    ...
    def test_agent_manager_importable(self):
        """AgentManager should be importable from xoneaiagents."""
        from xoneaiagents import AgentManager
    ...
    def test_agents_is_silent_alias_v4(self):
        ...
        import sys
        modules_to_remove = [k for k in sys.modules.keys() if 'xoneaiagents' in k]
    ...
    def test_agent_manager_in_all(self):
        ...
        import xoneaiagents
        assert 'AgentManager' in xoneaiagents.__all__
...
class TestAgentManagerFunctionality:
    ...
    def test_agent_manager_instantiation(self):
        ...
        from xoneaiagents import AgentManager, Agent
    ...
    def test_agents_alias_instantiation(self):
        ...
        from xoneaiagents import Agents, Agent
...
class TestBackwardCompatibility:
    ...
    def test_from_agents_import_pattern(self):
        ...
        from xoneaiagents.agents import Agents
        assert Agents is not None
    ...
    def test_xone_ai_agents_removed_v4(self):
        """XoneAIAgents has been removed in v4 - should raise ImportError."""
