...
class TestApprovalRequest:
    def test_minimal_construction(self):
        from xoneaiagents.approval.protocols import ApprovalRequest
...
class TestApprovalDecision:
    def test_approved(self):
        from xoneaiagents.approval.protocols import ApprovalDecision
...
class TestApprovalProtocol:
    def test_protocol_structural_subtyping(self):
        ...
        from xoneaiagents.approval.protocols import ApprovalProtocol, ApprovalRequest, ApprovalDecision
    ...
    def test_non_conforming_class_fails(self):
        from xoneaiagents.approval.protocols import ApprovalProtocol
...
class TestAutoApproveBackend:
    def test_always_approves(self):
        from xoneaiagents.approval.backends import AutoApproveBackend
        from xoneaiagents.approval.protocols import ApprovalRequest
...
class TestConsoleBackend:
    def test_approved_via_mock(self):
        from xoneaiagents.approval.backends import ConsoleBackend
        from xoneaiagents.approval.protocols import ApprovalRequest
...
class TestApprovalRegistry:
    def test_default_backend_is_console(self):
        from xoneaiagents.approval.registry import ApprovalRegistry
        from xoneaiagents.approval.backends import ConsoleBackend
    ...
    def test_per_agent_backend(self):
        from xoneaiagents.approval.registry import ApprovalRegistry
        from xoneaiagents.approval.backends import AutoApproveBackend, ConsoleBackend
        reg = ApprovalRegistry()
    ...
    def test_approve_sync_env_auto_approve(self):
        from xoneaiagents.approval.registry import ApprovalRegistry
        reg = ApprovalRegistry()
        with patch.dict(os.environ, {"XONEAI_AUTO_APPROVE": "true"}):
...
class TestBackwardCompat:
    ...
    def test_import_set_approval_callback(self):
        from xoneaiagents.approval import set_approval_callback, get_approval_callback
        assert callable(set_approval_callback)

    def test_import_require_approval(self):
        from xoneaiagents.approval import require_approval
    ...
    def test_import_request_approval(self):
        from xoneaiagents.approval import request_approval
    ...
    def test_import_default_dangerous_tools(self):
        from xoneaiagents.approval import DEFAULT_DANGEROUS_TOOLS
    ...
    def test_import_new_protocol(self):
        from xoneaiagents.approval import ApprovalProtocol, ApprovalRequest
        assert ApprovalProtocol is not None
        assert ApprovalRequest is not None

    def test_import_new_backends(self):
        from xoneaiagents.approval import AutoApproveBackend, ConsoleBackend
        assert AutoApproveBackend is not None
        assert ConsoleBackend is not None

    def test_import_registry(self):
        from xoneaiagents.approval import get_approval_registry
    ...
    def test_set_callback_routes_to_registry(self):
        ...
        from xoneaiagents.approval import set_approval_callback, get_approval_registry
        from xoneaiagents.approval.protocols import ApprovalDecision as AD
...
class TestAgentApprovalParam:
    ...
    def test_approval_custom_protocol_backend(self):
        ...
        from xoneaiagents import Agent
        from xoneaiagents.approval.protocols import ApprovalRequest, ApprovalDecision
