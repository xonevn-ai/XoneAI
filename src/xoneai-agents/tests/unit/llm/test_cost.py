...
class TestCostModule:
    """Tests for xoneaiagents.llm._cost module."""
    
    def setup_method(self):
        """Reset module state before each test."""
        # Clear any cached litellm module
        import xoneaiagents.llm._cost as cost_module
        cost_module._litellm_module = None
        cost_module._litellm_import_attempted = False
        
        # Clear environment variables
        os.environ.pop('XONEAI_TRACK_COST', None)
        os.environ.pop('XONEAI_SAVE_OUTPUT', None)
    
    def test_is_cost_tracking_disabled_by_default(self):
        """Cost tracking should be disabled by default."""
        from xoneaiagents.llm._cost import is_cost_tracking_enabled
        
        assert is_cost_tracking_enabled() is False
    
    def test_is_cost_tracking_enabled_with_env_var(self):
        """Cost tracking should be enabled with XONEAI_TRACK_COST=true."""
        os.environ['XONEAI_TRACK_COST'] = 'true'
    ...
    def test_is_cost_tracking_enabled_with_save_output(self):
        """Cost tracking should be enabled with XONEAI_SAVE_OUTPUT=true."""
        os.environ['XONEAI_SAVE_OUTPUT'] = 'true'
    ...
    def test_calculate_cost_returns_none_when_disabled(self):
        ...
        from xoneaiagents.llm._cost import calculate_cost
    ...
    def test_calculate_cost_with_force_flag(self):
        ...
        # Mock litellm
        with patch('xoneaiagents.llm._cost._get_litellm') as mock_get_litellm:
    ...
    def test_enable_cost_tracking(self):
        ...
        from xoneaiagents.llm._cost import enable_cost_tracking, is_cost_tracking_enabled
        ...
        assert is_cost_tracking_enabled() is True
        assert os.environ.get('XONEAI_TRACK_COST') == 'true'
    
    def test_disable_cost_tracking(self):
        """disable_cost_tracking should remove environment variable."""
        from xoneaiagents.llm._cost import disable_cost_tracking, is_cost_tracking_enabled
