...
class TestLoggingPlugin:
    ...
    def test_logging_plugin_info(self):
        ...
        from xoneaiagents.plugins.builtin import LoggingPlugin
...
class TestMetricsPlugin:
    ...
    def test_metrics_plugin_info(self):
        ...
        from xoneaiagents.plugins.builtin import MetricsPlugin
...
class TestPluginSDK:
    ...
    def test_sdk_exports(self):
        ...
        from xoneaiagents.plugins.sdk import Plugin, PluginHook, PluginInfo, FunctionPlugin
    ...
    def test_function_plugin(self):
        ...
        from xoneaiagents.plugins.sdk import FunctionPlugin, PluginHook
...
class TestPluginManagerIntegration:
    ...
    def test_execute_hook_with_builtin_plugins(self):
        ...
        from xoneaiagents.plugins import PluginManager, PluginHook
        from xoneaiagents.plugins.builtin import MetricsPlugin
