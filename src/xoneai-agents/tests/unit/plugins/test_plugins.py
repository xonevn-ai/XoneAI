...
from xoneaiagents.plugins.plugin import (
    Plugin,
    PluginHook,
    PluginInfo,
    FunctionPlugin,
)
from xoneaiagents.plugins.manager import (
    PluginManager,
    get_plugin_manager,
)
...
class TestLoadFromDirectory:
    ...
    def test_load_plugin_file(self):
        ...
        from xoneaiagents.plugins.manager import PluginManager
        
        # Create a plugin file
        plugin_code = '''
from xoneaiagents.plugins.plugin import Plugin, PluginInfo
