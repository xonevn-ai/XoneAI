...
class TestPathCentralization:
    ...
    def test_plugins_discovery_uses_paths_module(self):
        ...
        from xoneaiagents.paths import get_plugins_dir, get_project_data_dir
    ...
    def test_skills_discovery_uses_paths_module(self):
        ...
        from xoneaiagents.skills.discovery import get_default_skill_dirs
    ...
    def test_paths_module_returns_xoneai_dir(self):
        """paths.py should return ~/.xoneai/ as default."""
        from xoneaiagents.paths import get_data_dir, DEFAULT_DIR_NAME
        
        assert DEFAULT_DIR_NAME == ".xoneai"
        
        # Without env override, should use .xoneai
        data_dir = get_data_dir()
        assert data_dir.name in [".xoneai", ".xone"]  # .xone for legacy
...
class TestHookUnification:
    ...
    def test_plugin_hook_is_hook_event_alias(self):
        ...
        from xoneaiagents.plugins import PluginHook
...
class TestPluginType:
    ...
    def test_plugin_type_enum_exists(self):
        ...
        from xoneaiagents.plugins import PluginType
...
class TestAsyncHookExecution:
    ...
    async def test_async_execute_hook_exists(self):
        ...
        from xoneaiagents.plugins import PluginManager
    ...
    async def test_async_execute_hook_works(self):
        ...
        from xoneaiagents.plugins import PluginManager, Plugin, PluginInfo
        from xoneaiagents.hooks import HookEvent
...
class TestBackwardCompatibility:
    ...
    def test_legacy_paths_fallback(self):
        """Legacy ~/.xone/ path should work with warning."""
        from xoneaiagents.paths import get_data_dir, LEGACY_DIR_NAME
        
        assert LEGACY_DIR_NAME == ".xone"
    
    def test_plugin_info_still_works(self):
        """PluginInfo should still work with PluginHook."""
        from xoneaiagents.plugins import PluginInfo, PluginHook
