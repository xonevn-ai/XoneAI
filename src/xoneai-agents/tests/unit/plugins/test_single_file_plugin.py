...
class TestPluginHeaderParser:
    ...
    def test_parse_basic_header(self):
        ...
        from xoneaiagents.plugins.parser import parse_plugin_header
...
'''
    ...
    def test_parse_header_missing_name_raises(self):
        ...
        from xoneaiagents.plugins.parser import parse_plugin_header, PluginParseError
...
class TestPluginDiscovery:
    ...
    def test_discover_plugins_empty_dir(self):
        ...
        from xoneaiagents.plugins.discovery import discover_plugins
...
from xoneaiagents import tool
from xoneaiagents.hooks import add_hook, HookResult
...
class TestPluginIntegration:
    ...
    def test_agent_can_use_plugin_tool(self):
        ...
        from xoneaiagents.plugins.discovery import load_plugin
        from xoneaiagents.tools.registry import get_registry
...
class TestPluginMetadata:
    ...
    def test_plugin_metadata_creation(self):
        ...
        from xoneaiagents.plugins.parser import PluginMetadata
