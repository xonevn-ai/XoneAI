...
class TestPluginProtocol:
    ...
    def test_protocol_is_runtime_checkable(self):
        ...
        from xoneaiagents.plugins.protocols import PluginProtocol
...
class TestToolPluginProtocol:
    ...
    def test_tool_plugin_protocol(self):
        ...
        from xoneaiagents.plugins.protocols import ToolPluginProtocol
...
class TestHookPluginProtocol:
    ...
    def test_hook_plugin_protocol(self):
        ...
        from xoneaiagents.plugins.protocols import HookPluginProtocol
...
class TestAgentPluginProtocol:
    ...
    def test_agent_plugin_protocol(self):
        ...
        from xoneaiagents.plugins.protocols import AgentPluginProtocol
...
class TestLLMPluginProtocol:
    ...
    def test_llm_plugin_protocol(self):
        ...
        from xoneaiagents.plugins.protocols import LLMPluginProtocol
