...
from xoneaiagents.bots import BotMessage, BotUser, BotChannel
...
class TestMessageHookMixin:
    ...
    def test_import_mixin(self):
        ...
        from xoneai.bots._protocol_mixin import MessageHookMixin
    ...
    def test_fire_message_sending_cancel(self):
        ...
        from xoneai.bots._protocol_mixin import MessageHookMixin
        from xoneaiagents.hooks import HookRegistry, HookRunner
...
class TestGatewayStreamRelay:
    ...
    def test_process_agent_message_streams_tokens(self):
        ...
        from xoneaiagents.gateway import EventType
