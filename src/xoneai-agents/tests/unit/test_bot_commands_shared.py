...
class TestFormatStatus:
    ...
    def test_import(self):
        from xoneai.bots._commands import format_status
...
class TestFormatHelp:
    ...
    def test_import(self):
        from xoneai.bots._commands import format_help
...
class TestDRYConsistency:
    ...
    def test_same_output_all_platforms(self):
        from xoneai.bots._commands import format_status, format_help
        agent = MockAgent()
