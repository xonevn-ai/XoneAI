...
class TestBotWithMockAdapter:
    ...
    def setup_method(self):
        from xoneai.bots._registry import register_platform, _custom_platforms
...
class TestRealAgentInBot:
    """Tests with a real xoneaiagents.Agent inside Bot."""
...
class TestAgentFlowInBotOS:
    ...
    def test_agent_flow_in_bot(self):
        from xoneai.bots import Bot
        from xoneaiagents import Agent, AgentFlow, Task
...
class TestPlatformExtensibility:
    ...
    def teardown_method(self):
        from xoneai.bots._registry import _custom_platforms
    ...
    def test_register_and_use_custom_platform(self):
        from xoneai.bots._registry import register_platform, resolve_adapter
    ...
    def test_resolve_unknown_platform_raises(self):
        from xoneai.bots._registry import resolve_adapter
...
class TestSmoke:
    ...
    def test_all_import_paths(self):
        ...
        from xoneaiagents.bots.protocols import BotOSProtocol
        from xoneaiagents.bots.config import BotOSConfig
        from xoneaiagents.bots import BotOSProtocol as P2
        from xoneaiagents.bots import BotOSConfig as C2
        from xoneaiagents import BotOSProtocol as P3
        from xoneaiagents import BotOSConfig as C3
        from xoneai.bots import Bot, BotOS
        from xoneai.bots._registry import (
    ...
    def test_protocol_identity(self):
        ...
        from xoneaiagents.bots.protocols import BotOSProtocol as A
        from xoneaiagents import BotOSProtocol as B
        assert A is B

    def test_config_identity(self):
        from xoneaiagents.bots.config import BotOSConfig as A
        from xoneaiagents import BotOSConfig as B
        assert A is B
    ...
    def test_builtin_platforms_count(self):
        from xoneai.bots._registry import list_platforms
