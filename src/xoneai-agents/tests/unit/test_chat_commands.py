...
from xoneaiagents.bots import BotMessage, MessageType
...
class TestChatCommandProtocol:
    ...
    def test_import(self):
        ...
        from xoneaiagents.bots import ChatCommandProtocol
        assert ChatCommandProtocol is not None

    def test_runtime_checkable(self):
        """Test ChatCommandProtocol is runtime_checkable."""
        from xoneaiagents.bots import ChatCommandProtocol, ChatCommandInfo
