...
class TestDRYAutonomyMixin:
    ...
    def test_autonomy_mixin_has_no_run_autonomous(self):
        ...
        from xoneaiagents.agent.autonomy import AutonomyMixin
    ...
    def test_autonomy_module_exports_helper_classes(self):
        ...
        from xoneaiagents.agent.autonomy import (
            AutonomyConfig,
            AutonomyResult,
            AutonomyStage,
            AutonomySignal,
...
class TestConfigFidelity:
    ...
    def test_level_suggest_does_not_set_auto_approve(self):
        ...
        os.environ.pop("XONEAI_AUTO_APPROVE", None)
        ...
        assert os.environ.get("XONEAI_AUTO_APPROVE", "").lower() not in ("true", "1", "yes")
...
class TestApprovalUnification:
    ...
    def test_cli_autonomy_mode_derives_from_sdk(self):
        ...
        try:
            from xoneai.cli.features.autonomy_mode import AutonomyMode
            from xoneaiagents.config.feature_configs import AutonomyLevel
            ...
            pytest.skip("xoneai wrapper not installed")

    def test_cli_autonomy_manager_bridges_to_sdk(self):
        """CLI AutonomyManager.set_mode(FULL_AUTO) must set XONEAI_AUTO_APPROVE."""
        try:
            from xoneai.cli.features.autonomy_mode import AutonomyManager, AutonomyMode
            ...
            assert os.environ.get("XONEAI_AUTO_APPROVE", "").lower() in ("true", "1", "yes")

            mgr.set_mode(AutonomyMode.SUGGEST)
            assert os.environ.get("XONEAI_AUTO_APPROVE", "") == ""
    ...
    def test_approval_registry_env_check(self):
        """SDK ApprovalRegistry.is_env_auto_approve() must read XONEAI_AUTO_APPROVE."""
...
class TestInteractiveFixes:
    ...
    def test_async_tui_config_autonomy_default_true(self):
        ...
        try:
            from xoneai.cli.interactive.async_tui import AsyncTUIConfig
    ...
    def test_auto_toggle_preserves_agent_state(self):
        ...
        try:
            from xoneai.cli.interactive.async_tui import AsyncTUI, AsyncTUIConfig
    ...
    def test_interactive_config_autonomy_field_exists(self):
        ...
        try:
            from xoneai.cli.interactive.config import InteractiveConfig
...
class TestIntegrationSmoke:
    ...
    def test_autonomy_exports_available(self):
        ...
        from xoneaiagents import AutonomyConfig, AutonomyLevel
        from xoneaiagents.agent.autonomy import (
    ...
    def test_doom_loop_tracker_standalone(self):
        ...
        from xoneaiagents.agent.autonomy import DoomLoopTracker
    ...
    def test_autonomy_trigger_stages(self):
        ...
        from xoneaiagents.agent.autonomy import AutonomyTrigger, AutonomyStage
