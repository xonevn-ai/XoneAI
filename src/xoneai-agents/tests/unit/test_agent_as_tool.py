...
class TestAgentAsTool:
    ...
    def test_as_tool_returns_handoff(self):
        ...
        from xoneaiagents.agent.handoff import Handoff, HandoffConfig, ContextPolicy
...
class TestAgentAsToolIntegration:
    ...
    def test_as_tool_on_real_agent(self):
        ...
        from xoneaiagents.agent.handoff import Handoff, ContextPolicy
    ...
    def test_as_tool_in_tools_list(self):
        ...
        from xoneaiagents import Agent
        from xoneaiagents.agent.handoff import Handoff
