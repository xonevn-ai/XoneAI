...
class TestContextMonitor:
    ...
    def test_monitor_disabled_by_default(self):
        ...
        from xoneaiagents.context.monitor import ContextMonitor
    ...
    def test_snapshot_writes_file(self):
        ...
        from xoneaiagents.context.monitor import ContextMonitor
        from xoneaiagents.context.models import ContextLedger, BudgetAllocation
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert "XONEAI CONTEXT SNAPSHOT" in content
...
class TestRedaction:
    ...
    def test_redact_api_key(self):
        ...
        from xoneaiagents.context.monitor import redact_sensitive
...
class TestFormatting:
    ...
    def test_format_human_snapshot(self):
        ...
        from xoneaiagents.context.monitor import format_human_snapshot
        from xoneaiagents.context.models import ContextSnapshot, ContextLedger, BudgetAllocation
        ...
        assert "XONEAI CONTEXT SNAPSHOT" in result
    ...
    def test_format_json_snapshot(self):
        """Test JSON format."""
        from xoneaiagents.context.monitor import format_json_snapshot
        from xoneaiagents.context.models import ContextSnapshot, ContextLedger, BudgetAllocation
        import json
...
class TestMultiAgentMonitor:
    ...
    def test_get_agent_monitor(self):
        ...
        from xoneaiagents.context.monitor import MultiAgentMonitor
