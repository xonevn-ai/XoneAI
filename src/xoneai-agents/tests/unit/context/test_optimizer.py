...
class TestOptimizers:
    ...
    def test_truncate_optimizer_no_change_needed(self):
        ...
        from xoneaiagents.context.optimizer import TruncateOptimizer
    ...
    def test_sliding_window_optimizer(self):
        ...
        from xoneaiagents.context.optimizer import SlidingWindowOptimizer
    ...
    def test_prune_tools_optimizer(self):
        ...
        from xoneaiagents.context.optimizer import PruneToolsOptimizer
    ...
    def test_non_destructive_optimizer(self):
        ...
        from xoneaiagents.context.optimizer import NonDestructiveOptimizer
    ...
    def test_summarize_optimizer(self):
        ...
        from xoneaiagents.context.optimizer import SummarizeOptimizer
    ...
    def test_smart_optimizer_combines_strategies(self):
        ...
        from xoneaiagents.context.optimizer import SmartOptimizer
    ...
    def test_get_optimizer_factory(self):
        ...
        from xoneaiagents.context.optimizer import get_optimizer
        from xoneaiagents.context.models import OptimizerStrategy
    ...
    def test_get_effective_history(self):
        ...
        from xoneaiagents.context.optimizer import get_effective_history
...
class TestOptimizationResult:
    ...
    def test_reduction_percent(self):
        ...
        from xoneaiagents.context.models import OptimizationResult
