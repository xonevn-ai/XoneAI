...
class TestLLMSummarizeOptimizer:
    ...
    def test_llm_summarize_optimizer_class(self):
        ...
        from xoneaiagents.context.optimizer import LLMSummarizeOptimizer
...
class TestContextConfigLLMSummarize:
    ...
    def test_manager_config_has_llm_summarize_field(self):
        ...
        from xoneaiagents.context.manager import ManagerConfig
...
class TestDeduplicationLogging:
    ...
    def test_deduplication_removes_duplicates(self):
        ...
        from xoneaiagents.context.manager import ContextManager
