...
from xoneaiagents.context.manager import (
    ContextManager,
...
class TestManagerConfig:
    ...
    def test_config_from_env(self):
        ...
        with patch.dict('os.environ', {
            'XONEAI_CONTEXT_AUTO_COMPACT': 'false',
            'XONEAI_CONTEXT_THRESHOLD': '0.7',
            'XONEAI_CONTEXT_STRATEGY': 'truncate',
            'XONEAI_CONTEXT_MONITOR': 'true',
        }):
