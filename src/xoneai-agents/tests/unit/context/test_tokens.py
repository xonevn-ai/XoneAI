...
class TestTokenEstimation:
    ...
    def test_estimate_tokens_heuristic_empty(self):
        ...
        from xoneaiagents.context.tokens import estimate_tokens_heuristic
    ...
    def test_estimate_message_tokens_simple(self):
        ...
        from xoneaiagents.context.tokens import estimate_message_tokens
    ...
    def test_estimate_tool_schema_tokens(self):
        ...
        from xoneaiagents.context.tokens import estimate_tool_schema_tokens
    ...
    def test_token_estimator_impl(self):
        ...
        from xoneaiagents.context.tokens import TokenEstimatorImpl
    ...
    def test_get_estimator(self):
        ...
        from xoneaiagents.context.tokens import get_estimator
...
class TestFormatPercent:
    ...
    def test_format_percent_zero(self):
        """Test zero value."""
        from xoneaiagents.context import format_percent
