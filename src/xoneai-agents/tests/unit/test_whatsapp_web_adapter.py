...
class TestAdapterImport:
    ...
    def test_default_creds_dir(self):
        """Default creds dir is ~/.xoneai/whatsapp."""
        from xoneai.bots._whatsapp_web_adapter import DEFAULT_CREDS_DIR
        assert ".xoneai" in DEFAULT_CREDS_DIR
...
class TestAdapterConstruction:
    ...
    def test_default_construction(self):
        ...
        assert ".xoneai" in adapter.creds_dir
