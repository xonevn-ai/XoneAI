...
class TestBotOSProtocolExists:
    ...
    def test_import_from_bots_package(self):
        from xoneaiagents.bots import BotOSProtocol
        assert BotOSProtocol is not None

    def test_import_from_top_level(self):
        from xoneaiagents import BotOSProtocol
        assert BotOSProtocol is not None
...
class TestBotOSConfigExists:
    ...
    def test_import_from_bots_package(self):
        from xoneaiagents.bots import BotOSConfig
        assert BotOSConfig is not None

    def test_import_from_top_level(self):
        from xoneaiagents import BotOSConfig
        assert BotOSConfig is not None

    def test_default_values(self):
        from xoneaiagents.bots.config import BotOSConfig
        cfg = BotOSConfig()
        assert cfg.name == "XoneAI BotOS"
...
class TestPlatformRegistry:
    ...
    def test_registry_import(self):
        from xoneai.bots._registry import get_platform_registry
    ...
    def test_register_custom_platform(self):
        from xoneai.bots._registry import get_platform_registry, register_platform
        class CustomBot:
            pass
