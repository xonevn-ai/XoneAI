...
class TestOAuthCallbackServer:
    ...
    def test_default_port(self):
        ...
        from xoneaiagents.mcp.mcp_oauth_callback import OAUTH_CALLBACK_PORT
        assert OAUTH_CALLBACK_PORT == 19876
    
    def test_default_path(self):
        """Default callback path is /mcp/oauth/callback."""
        from xoneaiagents.mcp.mcp_oauth_callback import OAUTH_CALLBACK_PATH
        assert OAUTH_CALLBACK_PATH == "/mcp/oauth/callback"
    
    def test_get_redirect_url(self):
        """get_redirect_url returns the full callback URL."""
        from xoneaiagents.mcp.mcp_oauth_callback import get_redirect_url
...
class TestOAuthCallbackHandler:
    ...
    def handler(self):
        ...
        from xoneaiagents.mcp.mcp_oauth_callback import OAuthCallbackHandler
...
class TestGenerateState:
    ...
    def test_generate_state_returns_string(self):
        ...
        from xoneaiagents.mcp.mcp_oauth_callback import generate_state
...
class TestGenerateCodeVerifier:
    ...
    def test_generate_code_verifier_returns_string(self):
        ...
        from xoneaiagents.mcp.mcp_oauth_callback import generate_code_verifier
...
class TestGenerateCodeChallenge:
    ...
    def test_generate_code_challenge_returns_string(self):
        ...
        from xoneaiagents.mcp.mcp_oauth_callback import generate_code_challenge
