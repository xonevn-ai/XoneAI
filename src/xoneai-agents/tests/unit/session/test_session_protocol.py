...
class TestSessionStoreProtocolExists:
    ...
    def test_import_protocol(self):
        ...
        from xoneaiagents.session.protocols import SessionStoreProtocol
    ...
    def test_import_from_session_package(self):
        ...
        from xoneaiagents.session import SessionStoreProtocol
        assert SessionStoreProtocol is not None
...
class TestDefaultSessionStoreConformance:
    ...
    def test_isinstance_check(self):
        ...
        from xoneaiagents.session.protocols import SessionStoreProtocol
        from xoneaiagents.session.store import DefaultSessionStore
...
class TestHierarchicalSessionStoreConformance:
    ...
    def test_isinstance_check(self):
        ...
        from xoneaiagents.session.protocols import SessionStoreProtocol
        from xoneaiagents.session.hierarchy import HierarchicalSessionStore
...
class TestSessionExports:
    ...
    def test_hierarchy_exports(self):
        ...
        from xoneaiagents.session import HierarchicalSessionStore
    ...
    def test_hierarchy_store_getter(self):
        ...
        from xoneaiagents.session import get_hierarchical_session_store
    ...
    def test_session_snapshot_export(self):
        ...
        from xoneaiagents.session import SessionSnapshot
    ...
    def test_extended_session_data_export(self):
        ...
        from xoneaiagents.session import ExtendedSessionData
