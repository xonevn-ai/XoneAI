...
from xoneaiagents.config.feature_configs import LearnConfig, LearnScope, MemoryConfig
from xoneaiagents.memory.learn.stores import (
    PersonaStore,
    InsightStore,
    ThreadStore,
    PatternStore,
...
from xoneaiagents.memory.learn.manager import LearnManager
...
class TestNoCortexParam:
    ...
    def test_no_cortex_module_in_agents(self):
        """xoneaiagents should not have cortex module."""
        import importlib.util
        
        spec = importlib.util.find_spec("xoneaiagents.cortex")
        assert spec is None, "xoneaiagents.cortex module should not exist"
