...
import pytest
from xoneaiagents import Workflow, WorkflowContext, StepResult
from xoneaiagents.workflows import loop, Loop, parallel, route
...
class TestConditionalBranching:
    ...
    def test_if_pattern_creation(self):
        ...
        from xoneaiagents.workflows import if_, If
    ...
    def test_if_true_branch(self):
        ...
        from xoneaiagents import Workflow, WorkflowContext, StepResult
        from xoneaiagents.workflows import if_
    ...
    def test_if_inside_loop(self):
        ...
        # Reimport all classes fresh to avoid module cache pollution
        from xoneaiagents import Workflow, WorkflowContext, StepResult
        from xoneaiagents.workflows import if_, loop
...
class TestYAMLParsing:
    ...
    def test_parse_nested_loop_yaml(self):
        ...
        from xoneaiagents.workflows import Loop
        import tempfile
        import os
...
"""
    ...
    def test_parse_if_yaml(self):
        ...
        from xoneaiagents.workflows.yaml_parser import YAMLWorkflowParser
        from xoneaiagents.workflows import If
        import tempfile
        import os
