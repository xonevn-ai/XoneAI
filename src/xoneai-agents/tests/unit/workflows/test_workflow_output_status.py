...
class TestWorkflowOutputDRY:
    ...
    def test_workflow_output_presets_is_output_presets(self):
        ...
        from xoneaiagents.config.presets import OUTPUT_PRESETS, WORKFLOW_OUTPUT_PRESETS
...
class TestWorkflowOutputStatusEnablement:
    ...
    def test_workflow_status_enables_status_output(self):
        ...
        from xoneaiagents.output.status import disable_status_output, is_status_output_enabled
        from xoneaiagents.output.trace import disable_trace_output
    ...
    def test_workflow_trace_enables_trace_output(self):
        ...
        from xoneaiagents.output.status import disable_status_output
        from xoneaiagents.output.trace import disable_trace_output, is_trace_output_enabled
...
class TestYAMLOutputParsing:
    ...
    def test_yaml_parser_parses_output_field(self):
        ...
        from xoneaiagents.workflows.yaml_parser import YAMLWorkflowParser
