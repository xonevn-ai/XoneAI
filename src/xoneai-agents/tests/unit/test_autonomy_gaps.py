...
class TestCompletionDetection:
    ...
    @patch("xoneaiagents.agent.agent.Agent.chat")
    @patch("xoneaiagents.agent.agent.Agent.get_recommended_stage", return_value="heuristic")
...
class TestDoomLoopTrackerDelegation:
    ...
    def test_tracker_has_delegate(self):
        ...
        from xoneaiagents.escalation.doom_loop import DoomLoopDetector
...
class TestEscalationExports:
    ...
    def test_escalation_stage_importable(self):
        from xoneaiagents import EscalationStage
...
class TestAutonomySignalDeprecation:
    ...
    def test_autonomy_signal_still_works(self):
        ...
        from xoneaiagents.agent.autonomy import AutonomySignal
...
class TestDeescalation:
    ...
    @patch("xoneaiagents.agent.agent.Agent.chat")
    @patch("xoneaiagents.agent.agent.Agent.get_recommended_stage", return_value="planned")
...
class TestCLILoopParity:
    ...
    def test_loop_command_has_observe_flag(self):
        ...
        from xoneai.cli.commands.loop import loop_main
        import inspect
