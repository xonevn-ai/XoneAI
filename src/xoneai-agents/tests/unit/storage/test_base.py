...
from xoneaiagents.storage.base import (
    BaseJSONStore,
    FileLock,
    list_json_sessions,
...
class TestProtocolCompliance:
    ...
    def test_session_info_protocol_compliance(self):
        ...
        from xoneaiagents.storage.protocols import SessionInfoProtocol
    ...
    def test_json_store_protocol_compliance(self):
        ...
        from xoneaiagents.storage.protocols import JSONStoreProtocol
