...
from xoneaiagents.permissions import (
    PermissionManager,
    PermissionRule,
    PermissionAction,
    PermissionResult,
...
from xoneaiagents.permissions.rules import PersistentApproval
...
class TestPermissionMode:
    ...
    def test_mode_values(self):
        ...
        from xoneaiagents.permissions.rules import PermissionMode
