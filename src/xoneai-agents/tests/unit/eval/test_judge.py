...
class TestJudgeProtocol:
    ...
    def test_judge_protocol_exists(self):
        ...
        from xoneaiagents.eval.protocols import JudgeProtocol
...
class TestJudgeResult:
    ...
    def test_judge_result_exists(self):
        ...
        from xoneaiagents.eval.results import JudgeResult
...
class TestJudgeClass:
    ...
    @patch('xoneaiagents.eval.judge.Judge._get_litellm')
...
class TestJudgeConfig:
    ...
    def test_judge_config_exists(self):
        ...
        from xoneaiagents.eval import JudgeConfig
...
class TestBackwardCompatibility:
    ...
    def test_accuracy_evaluator_still_works(self):
        ...
        from xoneaiagents.eval import AccuracyEvaluator
...
class TestLazyLoading:
    ...
    def test_import_does_not_load_litellm(self):
        ...
        import xoneaiagents.eval  # noqa: F401
