...
from xoneaiagents.eval.grader import BaseLLMGrader, GradeResult
...
REASONING: Invalid"""
    ...
    def test_grade_success(self):
        ...
        import xoneaiagents.eval.grader as grader_module
...
class TestProtocolCompliance:
    ...
    def test_grader_protocol_compliance(self):
        ...
        from xoneaiagents.eval.protocols import GraderProtocol
    ...
    def test_grade_result_protocol_compliance(self):
        ...
        from xoneaiagents.eval.protocols import GradeResultProtocol
