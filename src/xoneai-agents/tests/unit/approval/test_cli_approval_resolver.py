"""Tests for xoneai.cli.features.approval — resolve_approval_backend."""

import os
import sys
import pytest

# Ensure xoneai wrapper package is importable
...
class TestValidBackends:
    ...
    def test_valid_backends_list(self):
        from xoneai.cli.features.approval import VALID_BACKENDS
