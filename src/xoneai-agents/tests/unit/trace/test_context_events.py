...
class TestContextEventType:
    ...
    def test_context_event_types_exist(self):
        ...
        from xoneaiagents.trace.context_events import ContextEventType
...
class TestGlobalEmitterRegistry:
    ...
    def test_get_context_emitter_returns_noop_by_default(self):
        ...
        from xoneaiagents.trace.context_events import (
    ...
    def test_context_emitter_noop_when_not_set(self):
        ...
        from xoneaiagents.trace.context_events import get_context_emitter
...
class TestContextEvent:
    ...
    def test_context_event_creation_minimal(self):
        ...
        from xoneaiagents.trace.context_events import ContextEvent, ContextEventType
...
class TestContextTraceSink:
    ...
    def test_context_noop_sink(self):
        ...
        from xoneaiagents.trace.context_events import ContextNoOpSink, ContextEvent, ContextEventType
    ...
    def test_context_list_sink(self):
        ...
        from xoneaiagents.trace.context_events import ContextListSink, ContextEvent, ContextEventType
...
"""
        subprocess.run(
            ...
            capture_output=True,
            text=True,
            cwd="/Users/xonevn/xoneai-package/src/xoneai-agents",
        )
        
        # Now measure context_events import (should add minimal overhead)
        code = """
import time
import xoneaiagents  # Pre-import base
start = time.perf_counter()
from xoneaiagents.trace.context_events import ContextEvent, ContextEventType
elapsed = (time.perf_counter() - start) * 1000
print(f"{elapsed:.1f}")
