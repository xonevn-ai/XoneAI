...
class TestActionEvent:
    ...
    def test_action_event_creation_minimal(self):
        ...
        from xoneaiagents.trace.protocol import ActionEvent
    ...
    def test_action_event_types(self):
        ...
        from xoneaiagents.trace.protocol import ActionEvent, ActionEventType
...
class TestRedaction:
    ...
    def test_redact_api_key(self):
        ...
        from xoneaiagents.trace.redact import redact_dict
...
class TestTraceSink:
    ...
    def test_noop_sink(self):
        ...
        from xoneaiagents.trace.protocol import NoOpSink, ActionEvent
    ...
    def test_list_sink(self):
        ...
        from xoneaiagents.trace.protocol import ListSink, ActionEvent
...
class TestTraceEmitter:
    ...
    def test_emitter_with_noop_sink(self):
        ...
        from xoneaiagents.trace.protocol import TraceEmitter, NoOpSink
    ...
    def test_emitter_with_list_sink(self):
        ...
        from xoneaiagents.trace.protocol import TraceEmitter, ListSink
...
class TestActionTraceConfig:
    ...
    def test_config_defaults(self):
        ...
        from xoneaiagents.trace.protocol import ActionTraceConfig
...
class TestPerformance:
    ...
    def test_noop_sink_overhead(self):
        ...
        from xoneaiagents.trace.protocol import TraceEmitter, NoOpSink, ActionEvent
