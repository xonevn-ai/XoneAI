"""
Tests for Protocol definitions in xoneaiagents.
...
class TestAgentProtocol:
    ...
    def test_protocol_is_importable(self):
        ...
        from xoneaiagents.agent.protocols import AgentProtocol
...
class TestMemoryProtocol:
    ...
    def test_memory_implements_protocol(self):
        ...
        from xoneaiagents.memory.memory import Memory
...
class TestToolProtocol:
    ...
    def test_protocol_is_importable(self):
        ...
        from xoneaiagents.tools.protocols.tool_protocol import ToolProtocol
