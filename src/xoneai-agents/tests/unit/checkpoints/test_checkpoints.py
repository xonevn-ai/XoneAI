...
from xoneaiagents.checkpoints.types import (
    CheckpointConfig, Checkpoint, CheckpointDiff, FileDiff,
    CheckpointResult, CheckpointEvent
)
from xoneaiagents.checkpoints.service import CheckpointService
...
class TestCheckpointConfig:
    ...
    def test_config_default_storage(self):
        ...
        config = CheckpointConfig(workspace_dir="/tmp/test")
        # Uses centralized paths module - .xoneai/checkpoints
        assert ".xoneai/checkpoints" in config.storage_dir or "checkpoints" in config.storage_dir
...
class TestCheckpointService:
    ...
    def temp_workspace(self):
        ...
        workspace = tempfile.mkdtemp(prefix="xone_test_")
        yield workspace
        # Cleanup
    ...
    def temp_storage(self):
        ...
        storage = tempfile.mkdtemp(prefix="xone_checkpoints_")
        yield storage
        # Cleanup
