"""
Tests for XoneAI Robustness Improvements.
...
class TestIncludeWorkflow:
    ...
    def test_include_with_recipe(self):
        ...
        from xoneaiagents.workflows import include
    ...
    def test_include_with_workflow(self):
        ...
        from xoneaiagents.workflows import include, Workflow
...
class TestExportsAndImports:
    ...
    def test_when_exported_from_workflows(self):
        """when should be exported from xoneaiagents.workflows."""
        from xoneaiagents.workflows import when
        assert callable(when)
    
    def test_when_in_workflows_all(self):
        """when should be in workflows __all__."""
        import xoneaiagents.workflows as workflows_module
