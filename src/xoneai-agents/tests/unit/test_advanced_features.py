"""
Tests for advanced features in XoneAI.
...
# Check if xoneai wrapper is installed (for tests that depend on CLI features)
_XONEAI_WRAPPER_INSTALLED = importlib.util.find_spec("xoneai") is not None
requires_wrapper = pytest.mark.skipif(
    not _XONEAI_WRAPPER_INSTALLED,
    reason="xoneai wrapper package not installed"
)
...
class TestAutoSummarization:
    ...
    def test_old_summarization_params_rejected(self):
        ...
        from xoneaiagents.agent import Agent
    ...
    def test_token_tracking_for_summarization(self):
        ...
        from xoneaiagents.agent.summarization import SummarizationManager
...
class TestMessageQueue:
    ...
    def test_queue_creation(self):
        ...
        from xoneaiagents.agent.message_queue import AgentMessageQueue
...
class TestMCPDisabledTools:
    ...
    def test_mcp_disabled_tools_param(self):
        ...
        from xoneaiagents.mcp import MCP
    ...
    def test_disabled_tools_filtering(self):
        ...
        from xoneaiagents.mcp.mcp_utils import filter_disabled_tools
...
class TestPermissionAllowlist:
    ...
    def test_allowlist_creation(self):
        ...
        from xoneaiagents.approval import PermissionAllowlist
...
class TestBackgroundJobManagement:
    ...
    def test_job_manager_creation(self):
        ...
        from xoneaiagents.background.job_manager import BackgroundJobManager
    ...
    def test_job_status_tracking(self):
        ...
        from xoneaiagents.background.job_manager import BackgroundJobManager, JobStatus
...
class TestSafeBashExecution:
    ...
    def test_banned_commands_list(self):
        ...
        from xoneai.cli.features.safe_shell import BANNED_COMMANDS
    ...
    def test_command_validation(self):
        ...
        from xoneai.cli.features.safe_shell import validate_command
    ...
    def test_safe_execute(self):
        ...
        from xoneai.cli.features.safe_shell import safe_execute
...
class TestFileHistory:
    ...
    def test_history_creation(self):
        ...
        from xoneai.cli.features.file_history import FileHistoryManager
...
class TestLSPDiagnostics:
    ...
    def test_diagnostics_hook_exists(self):
        ...
        from xoneai.cli.features.lsp_diagnostics import DiagnosticsHook
...
class TestHierarchicalConfig:
    ...
    def test_config_precedence(self):
        ...
        from xoneai.cli.features.config_hierarchy import HierarchicalConfig
    ...
    def test_config_loading(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            project_config = os.path.join(tmpdir, ".xone.json")
    ...
    def test_config_schema_validation(self):
        ...
        from xoneai.cli.features.config_hierarchy import HierarchicalConfig, ConfigValidationError
...
class TestCLIModes:
    ...
    def test_compact_mode_flag(self):
        ...
        from xoneai.cli.features.output_modes import OutputMode
    ...
    def test_verbose_mode_flag(self):
        ...
        from xoneai.cli.features.output_modes import OutputMode, get_default_mode
        
        assert get_default_mode() == OutputMode.VERBOSE
        
    def test_logs_command_tail(self):
        """Test logs command with tail option."""
        from xoneai.cli.features.logs import LogsHandler
...
class TestGitAttribution:
    ...
    def test_attribution_trailer_generation(self):
        ...
        from xoneai.cli.features.git_attribution import AttributionManager
        
        manager = AttributionManager(model="gpt-4o")
        
        trailer = manager.generate_trailer(style="assisted-by")
        assert "Assisted-by:" in trailer or "XoneAI" in trailer
        
    def test_attribution_styles(self):
        """Test different attribution styles."""
        from xoneai.cli.features.git_attribution import AttributionManager, AttributionStyle
    ...
    def test_add_attribution_to_message(self):
        ...
        assert "Assisted-by:" in attributed or "XoneAI" in attributed
...
class TestSourcegraphTool:
    ...
    Note: sourcegraph_tools has been moved to xoneai-tools package.
    These tests are skipped as the tool is no longer in core SDK.
    """
    
    @pytest.mark.skip(reason="sourcegraph_tools moved to xoneai-tools package")
...
class TestEnhancedDownloadTool:
    ...
    def test_download_tool_exists(self):
        ...
        from xoneaiagents.tools.file_tools import FileTools
    ...
    def test_download_requires_approval(self):
        ...
        from xoneaiagents.tools.file_tools import FileTools
        from xoneaiagents.approval import is_approval_required
