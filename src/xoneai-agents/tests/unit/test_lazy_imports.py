"""
Tests for lazy import behavior in xoneaiagents.
...
def clear_modules():
    """Clear all xoneai, litellm, and requests related modules from cache."""
    to_remove = [m for m in list(sys.modules.keys()) 
                 if 'xone' in m or 'litellm' in m or m == 'requests' or m.startswith('requests.')]
...
class TestLazyImports:
    ...
    def test_litellm_not_loaded_on_import(self):
        """litellm should NOT be loaded when importing xoneaiagents."""
    ...
    def test_requests_not_loaded_on_import(self):
        """requests should NOT be loaded when importing xoneaiagents."""
        import xoneaiagents  # noqa: F401
    ...
    def test_chromadb_not_loaded_on_import(self):
        """chromadb should NOT be loaded when importing xoneaiagents."""
    ...
    def test_knowledge_available_via_getattr(self):
        ...
        Knowledge = xoneaiagents.Knowledge
    ...
    def test_tools_loaded_eagerly(self):
        ...
        assert hasattr(xoneaiagents, 'Tools')
        assert xoneaiagents.Tools is not None
    
    def test_all_exports_accessible(self):
        """All items in __all__ should be accessible."""
        import xoneaiagents
        
        for name in xoneaiagents.__all__:
            # Some items may be None if optional deps not installed
            try:
                _ = getattr(xoneaiagents, name)
...
class TestLitePackage:
    ...
    def test_lite_import_fast(self):
        ...
        from xoneaiagents.lite import LiteAgent  # noqa: F401
    ...
    def test_lite_agent_no_litellm(self):
        ...
        from xoneaiagents.lite import LiteAgent
...
class TestTelemetryConfig:
    ...
    def setup_method(self):
        ...
        self._orig_env = {}
        for key in ['XONEAI_TELEMETRY_ENABLED', 'XONEAI_TELEMETRY_DISABLED', 
                    'DO_NOT_TRACK', 'XONEAI_DISABLE_TELEMETRY']:
    ...
    def test_telemetry_disabled_by_default(self):
        ...
        from xoneaiagents._config import TELEMETRY_ENABLED
    ...
    def test_telemetry_enabled_via_env(self):
        ...
        clear_modules()
        from xoneaiagents._config import _get_telemetry_enabled
