...
class TestTaskState:
    ...
    def test_task_state_submitted(self):
        ...
        from xoneaiagents.ui.a2a.types import TaskState
...
class TestRole:
    ...
    def test_role_user(self):
        ...
        from xoneaiagents.ui.a2a.types import Role
...
class TestPart:
    ...
    def test_text_part_creation(self):
        ...
        from xoneaiagents.ui.a2a.types import TextPart
        part = TextPart(text="Hello, world!")
        assert part.text == "Hello, world!"
    
    def test_file_part_with_uri(self):
        """Test FilePart with URI."""
        from xoneaiagents.ui.a2a.types import FilePart
        part = FilePart(
    ...
    def test_data_part_creation(self):
        ...
        from xoneaiagents.ui.a2a.types import DataPart
...
class TestMessage:
    ...
    def test_message_creation(self):
        ...
        from xoneaiagents.ui.a2a.types import Message, Role, TextPart
        msg = Message(
            message_id="msg-123",
            role=Role.USER,
...
class TestTaskStatus:
    ...
    def test_task_status_creation(self):
        ...
        from xoneaiagents.ui.a2a.types import TaskStatus, TaskState
        status = TaskStatus(state=TaskState.WORKING)
        assert status.state == TaskState.WORKING
    
    def test_task_status_with_message(self):
        """Test TaskStatus with message."""
        from xoneaiagents.ui.a2a.types import TaskStatus, TaskState, Message, Role, TextPart
        msg = Message(
            message_id="msg-1",
            role=Role.AGENT,
...
class TestTask:
    ...
    def test_task_creation(self):
        ...
        from xoneaiagents.ui.a2a.types import Task, TaskStatus, TaskState
        task = Task(
            id="task-123",
    ...
    def test_task_with_artifacts(self):
        ...
        from xoneaiagents.ui.a2a.types import Task, TaskStatus, TaskState, Artifact, TextPart
        artifact = Artifact(
            artifact_id="art-1",
    ...
    def test_task_with_history(self):
        ...
        from xoneaiagents.ui.a2a.types import Task, TaskStatus, TaskState, Message, Role, TextPart
...
class TestArtifact:
    ...
    def test_artifact_creation(self):
        ...
        from xoneaiagents.ui.a2a.types import Artifact, TextPart
        artifact = Artifact(
            artifact_id="art-123",
...
class TestAgentSkill:
    ...
    def test_agent_skill_creation(self):
        ...
        from xoneaiagents.ui.a2a.types import AgentSkill
        skill = AgentSkill(
            id="search",
            name="Web Search",
...
class TestAgentCapabilities:
    ...
    def test_capabilities_creation(self):
        ...
        from xoneaiagents.ui.a2a.types import AgentCapabilities
...
class TestAgentCard:
    ...
    def test_agent_card_creation(self):
        ...
        from xoneaiagents.ui.a2a.types import AgentCard, AgentCapabilities
        card = AgentCard(
            name="Research Agent",
    ...
    def test_agent_card_with_skills(self):
        ...
        from xoneaiagents.ui.a2a.types import AgentCard, AgentCapabilities, AgentSkill
...
class TestSendMessageRequest:
    ...
    def test_send_message_request_creation(self):
        ...
        from xoneaiagents.ui.a2a.types import SendMessageRequest, Message, Role, TextPart
        msg = Message(
            message_id="msg-1",
            role=Role.USER,
            parts=[TextPart(text="Hello")]
    ...
    def test_send_message_request_with_config(self):
        ...
        from xoneaiagents.ui.a2a.types import SendMessageRequest, Message, Role, TextPart, MessageConfig
        msg = Message(
            message_id="msg-2",
            role=Role.USER,
...
class TestStreamingEvents:
    ...
    def test_task_status_update_event(self):
        ...
        from xoneaiagents.ui.a2a.types import TaskStatusUpdateEvent, TaskStatus, TaskState
    ...
    def test_task_artifact_update_event(self):
        ...
        from xoneaiagents.ui.a2a.types import TaskArtifactUpdateEvent, Artifact, TextPart
        artifact = Artifact(
            artifact_id="art-1",
