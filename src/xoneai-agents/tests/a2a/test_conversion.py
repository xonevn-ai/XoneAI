...
class TestA2AToXoneAI:
    """Tests for converting A2A messages to XoneAI format."""
    
    def test_convert_user_message(self):
        """Test converting A2A user message to XoneAI format."""
        from xoneaiagents.ui.a2a.conversion import a2a_to_xoneai_messages
        ...
        result = a2a_to_xoneai_messages([a2a_msg])
    ...
    def test_convert_agent_message(self):
        """Test converting A2A agent message to XoneAI format."""
        from xoneaiagents.ui.a2a.conversion import a2a_to_xoneai_messages
        from xoneaiagents.ui.a2a.types import Message, Role, TextPart
    ...
    def test_convert_conversation_history(self):
        ...
        result = a2a_to_xoneai_messages(messages)
...
class TestXoneAIToA2A:
    """Tests for converting XoneAI responses to A2A format."""
    
    def test_convert_string_response(self):
        """Test converting string response to A2A Message."""
        from xoneaiagents.ui.a2a.conversion import xoneai_to_a2a_message
        
        response = "This is the agent's response."
        
        result = xoneai_to_a2a_message(response)
    ...
    def test_convert_response_with_context(self):
        ...
        result = xoneai_to_a2a_message(response, context_id="ctx-123")
    ...
    def test_convert_response_with_task(self):
        ...
        result = xoneai_to_a2a_message(response, task_id="task-456")
...
class TestArtifactConversion:
    ...
    def test_create_artifact_from_response(self):
        ...
        from xoneaiagents.ui.a2a.conversion import create_artifact
...
class TestExtractUserInput:
    ...
    def test_extract_from_single_message(self):
        ...
        from xoneaiagents.ui.a2a.conversion import extract_user_input
        from xoneaiagents.ui.a2a.types import Message, Role, TextPart
