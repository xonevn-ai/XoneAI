...
class TestA2AEventEncoder:
    ...
    def test_encode_event(self):
        ...
        from xoneaiagents.ui.a2a.streaming import A2AEventEncoder
...
class TestCreateEvents:
    ...
    def test_create_status_event(self):
        ...
        from xoneaiagents.ui.a2a.streaming import create_status_event
    ...
    def test_create_artifact_event(self):
        ...
        from xoneaiagents.ui.a2a.streaming import create_artifact_event
