"""
Integration tests for XoneAI Memory System.
...
from xoneaiagents.memory import FileMemory, RulesManager
...
"""
        xone_content = """---
description: XoneAI project rules
activation: always
priority: 100
---
...
"""
        ...
        (Path(tmpdir) / "XONE.md").write_text(xone_content)
        ...
        xone_rule = rules_manager.get_rule_by_name("xone")
        ...
        assert xone_rule is not None, "XONE.md not loaded"
        ...
        print(f"Xone rule: {xone_rule.description}")
...
def test_agent_with_rules():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        # Create XONE.md in workspace
        xone_rules = """# Project Rules
- Always respond in a friendly manner
- Use bullet points for lists
- Keep responses concise
"""
        (Path(tmpdir) / "XONE.md").write_text(xone_rules)
...
def run_all_tests():
    ...
    print("\n" + "="*60)
    print("XONEAI MEMORY SYSTEM - INTEGRATION TESTS")
    print("="*60)
