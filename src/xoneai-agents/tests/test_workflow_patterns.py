...
import tempfile
import os
from xoneaiagents import Workflow, WorkflowContext, StepResult, Pipeline
from xoneaiagents.workflows import (
...
class TestBackwardCompatibility:
    ...
    def test_import_from_memory_workflows(self):
        """Test imports from xoneaiagents.memory.workflows still work."""
        from xoneaiagents.memory.workflows import (
    ...
    def test_import_from_memory_module(self):
        """Test imports from xoneaiagents.memory still work."""
        from xoneaiagents.memory import Workflow, Pipeline, route, parallel
    ...
    def test_step_input_output_aliases(self):
        ...
        from xoneaiagents.workflows import StepInput, StepOutput
...
"""
        with tempfile.TemporaryDirectory() as tmpdir:
            workflows_dir = os.path.join(tmpdir, ".xoneai", "workflows")
