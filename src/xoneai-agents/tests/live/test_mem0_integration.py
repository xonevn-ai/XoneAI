...
class TestMem0IntegrationLive:
    ...
    def test_knowledge_search_with_mem0_metadata_none(self):
        ...
        temp_dir = tempfile.mkdtemp(prefix='xone_mem0_test_')
        try:
    ...
    def test_agent_chat_with_knowledge_no_crash(self):
        ...
        temp_dir = tempfile.mkdtemp(prefix='xone_agent_test_')
        try:
            test_file = os.path.join(temp_dir, 'test.txt')
            with open(test_file, 'w') as f:
    ...
    def test_rag_context_builder_with_mem0_results(self):
        ...
        from xoneaiagents.rag.context import build_context, deduplicate_chunks
...
class TestImportPerformance:
    ...
    def test_core_import_does_not_load_mem0(self):
        """Test that importing xoneaiagents doesn't load mem0."""
        ...
        if 'xoneaiagents' in sys.modules:
            importlib.reload(sys.modules['xoneaiagents'])
        else:
            import xoneaiagents
    ...
    def test_knowledge_import_does_not_load_mem0(self):
        ...
        from xoneaiagents import Knowledge  # noqa: F401
