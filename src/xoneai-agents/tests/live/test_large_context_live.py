...
Environment Variables:
    XONEAI_LIVE_TESTS=1  - Enable live tests
    OPENAI_API_KEY          - Required for LLM calls

Usage:
    # Run all live tests
    XONEAI_LIVE_TESTS=1 pytest tests/live/test_large_context_live.py -v
    
    # Run specific test
    XONEAI_LIVE_TESTS=1 pytest tests/live/test_large_context_live.py::test_agent_retrieves_unique_code -v
"""
...
# Skip all tests if XONEAI_LIVE_TESTS is not set
pytestmark = pytest.mark.skipif(
    os.environ.get("XONEAI_LIVE_TESTS", "").lower() not in ("1", "true", "yes"),
...
def temp_knowledge_dir():
    ...
    temp_dir = tempfile.mkdtemp(prefix='xone_live_test_')
...
class TestTokenBudgeting:
    ...
    def test_token_budget_calculation(self):
        ...
        from xoneaiagents.rag import TokenBudget
...
class TestStrategySelection:
    ...
    def test_strategy_selection_by_corpus_size(self):
        ...
        from xoneaiagents.rag import select_strategy, RetrievalStrategy
        from xoneaiagents.knowledge.indexing import CorpusStats
...
class TestContextCompression:
    ...
    def test_compression_preserves_query_relevant_content(self):
        ...
        from xoneaiagents.rag import ContextCompressor
...
class TestSmartRetriever:
    ...
    def test_retriever_initialization(self, temp_knowledge_dir):
        ...
        from xoneaiagents.rag import SmartRetriever
