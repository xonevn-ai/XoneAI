...
def test_knowledge_dir():
    ...
    temp_dir = tempfile.mkdtemp(prefix="xone_test_")
    ...
    3. XoneAI is an AI agents framework.
    
    ## Details
    
    Paris is known for the Eiffel Tower.
    Python was created by Guido van Rossum.
    XoneAI supports multi-agent workflows.
    """
...
class TestLiveRetrieval:
    ...
    def test_retrieval_config_policy_auto(self, test_knowledge_dir):
        ...
        from xoneaiagents import Agent
        from xoneaiagents.rag.retrieval_config import RetrievalConfig, RetrievalPolicy
        ...
        response = agent.chat("What is XoneAI?")
...
class TestLiveExports:
    ...
    def test_retrieval_config_creation(self):
        ...
        from xoneaiagents import RetrievalConfig, RetrievalPolicy, CitationsMode
