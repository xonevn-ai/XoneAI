...
class TestA2UIExtension:
    ...
    def test_a2ui_mime_type(self):
        ...
        from xoneaiagents.ui.a2ui.extension import A2UI_MIME_TYPE
        
        assert A2UI_MIME_TYPE == "application/json+a2ui"

    def test_a2ui_extension_uri(self):
        """Test A2UI extension URI constant."""
        from xoneaiagents.ui.a2ui.extension import A2UI_EXTENSION_URI
    ...
    def test_create_a2ui_part(self):
        ...
        from xoneaiagents.ui.a2ui.extension import create_a2ui_part, A2UI_MIME_TYPE
    ...
    def test_is_a2ui_part_true(self):
        ...
        from xoneaiagents.ui.a2ui.extension import create_a2ui_part, is_a2ui_part
    ...
    def test_is_a2ui_part_false(self):
        ...
        from xoneaiagents.ui.a2ui.extension import is_a2ui_part
        from xoneaiagents.ui.a2ui.types import A2UIDataPart
    ...
    def test_get_a2ui_agent_extension(self):
        ...
        from xoneaiagents.ui.a2ui.extension import get_a2ui_agent_extension
    ...
    def test_standard_catalog_id(self):
        ...
        from xoneaiagents.ui.a2ui.extension import STANDARD_CATALOG_ID
