...
class TestSessionIdValidation:
    ...
    def test_valid_session_id_ascii(self):
        ...
        from xoneaiagents.mcp.mcp_session import is_valid_session_id
...
class TestSessionManager:
    ...
    def test_session_manager_creation(self):
        ...
        from xoneaiagents.mcp.mcp_session import SessionManager
...
class TestSessionFromResponse:
    ...
    def test_extract_session_id_from_headers(self):
        ...
        from xoneaiagents.mcp.mcp_session import extract_session_id
...
class TestSessionExpiration:
    ...
    def test_is_session_expired_404(self):
        ...
        from xoneaiagents.mcp.mcp_session import is_session_expired
...
class TestProtocolVersion:
    ...
    def test_valid_protocol_versions(self):
        ...
        from xoneaiagents.mcp.mcp_session import is_valid_protocol_version
