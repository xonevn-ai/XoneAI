"""
Example demonstrating telemetry usage in XoneAI Agents.
...
from xoneaiagents.tools import DuckDuckGoSearchTool
...
def advanced_telemetry_example():
    ...
    telemetry = enable_telemetry(
        backend="opentelemetry",
        service_name="xoneai-production",
...
if __name__ == "__main__":
    print("XoneAI Agents Telemetry Examples")
    print("===================================")
