...
class TestQueryRewriterImports:
    ...
    def test_import_from_package(self):
        ...
        from xoneaiagents import QueryRewriterAgent, RewriteStrategy, RewriteResult
    ...
    def test_import_from_agent_module(self):
        ...
        from xoneaiagents.agent import QueryRewriterAgent, RewriteStrategy, RewriteResult
        assert QueryRewriterAgent is not None
        assert RewriteStrategy is not None
        assert RewriteResult is not None
...
class TestRewriteStrategy:
    ...
    def test_strategy_values(self):
        ...
        from xoneaiagents import RewriteStrategy
...
class TestRewriteResult:
    ...
    def test_result_creation(self):
        ...
        from xoneaiagents import RewriteResult, RewriteStrategy
...
class TestQueryRewriterAgentInit:
    ...
    def test_default_initialization(self):
        ...
        from xoneaiagents import QueryRewriterAgent
...
class TestRewriteWithMockedLLM:
    ...
    @patch.object(__import__('xoneaiagents.agent.query_rewriter_agent', fromlist=['QueryRewriterAgent']).QueryRewriterAgent, '_call_agent')
