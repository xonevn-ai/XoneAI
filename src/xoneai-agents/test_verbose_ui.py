"""Test script with forced verbose mode to verify XoneAI's unique output UI."""
import sys
...
print("=" * 70)
print("TESTING XONEAI UNIQUE VERBOSE OUTPUT UI")
print("=" * 70)
...
for name, color in XONE_COLORS.items():
