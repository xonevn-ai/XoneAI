#!/usr/bin/env python3
"""
MongoDB Knowledge Example for XoneAI Agents

This example demonstrates how to use MongoDB as a knowledge store for XoneAI agents.
...
if __name__ == "__main__":
    print("MongoDB Knowledge Example for XoneAI Agents")
    print("=" * 50)
