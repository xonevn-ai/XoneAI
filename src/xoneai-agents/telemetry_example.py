...
import os
from xoneaiagents.telemetry import get_telemetry, disable_telemetry, enable_telemetry
...
os.environ['XONEAI_TELEMETRY_DISABLED'] = 'true'

# Need to create a new instance to pick up the environment change
from importlib import reload
import xoneaiagents.telemetry.telemetry as telemetry_module
reload(telemetry_module)

from xoneaiagents.telemetry import get_telemetry as get_new_telemetry
new_telemetry = get_new_telemetry()
print(f"Telemetry enabled with env var: {new_telemetry.enabled}")

# Clean up
del os.environ['XONEAI_TELEMETRY_DISABLED']

# Example 5: Backward compatibility with TelemetryCollector
print("\n=== Example 5: Backward Compatibility ===")
from xoneaiagents.telemetry.telemetry import TelemetryCollector
...
print("  - XONEAI_TELEMETRY_DISABLED=true")
print("  - XONEAI_DISABLE_TELEMETRY=true")
