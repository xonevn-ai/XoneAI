#!/usr/bin/env python3
"""
MongoDB Tools Example for XoneAI Agents

This example demonstrates how to use MongoDB tools with XoneAI agents.
    ...
    try:
        ...
        result = mongo_client.insert_document(
            "demo_collection",
            {
                ...
                "description": "Demonstration of MongoDB tools with XoneAI",
                "category": "database",
                "tags": ["mongodb", "xoneai", "tools", "demo"]
            },
...
if __name__ == "__main__":
    print("MongoDB Tools Example for XoneAI Agents")
    print("=" * 50)
