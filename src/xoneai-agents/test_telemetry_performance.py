...
def test_optimized_telemetry():
    ...
    try:
        ...
        from xoneaiagents.telemetry import get_telemetry, enable_performance_mode, disable_performance_mode
        ...
        from xoneaiagents.telemetry.integration import _get_telemetry_queue, _queue_telemetry_event
        ...
        # Clean up
        from xoneaiagents.telemetry import cleanup_telemetry_resources
...
def main():
    ...
    print("🚀 XoneAI Telemetry Performance Test")
    print("=" * 50)
