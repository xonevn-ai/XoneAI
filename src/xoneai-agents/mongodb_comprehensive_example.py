#!/usr/bin/env python3
"""
Comprehensive MongoDB Integration Example for XoneAI Agents

This example demonstrates a complete MongoDB integration with XoneAI agents,
...
from xoneaiagents.tools import mongodb_tools
...
if __name__ == "__main__":
    ...
    print("=" * 50)
    print("This example demonstrates complete MongoDB integration with XoneAI")
    print("Features:")
