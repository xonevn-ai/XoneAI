...
Exposes XoneAI Agents via the A2A (Agent2Agent) protocol.
"""

import logging
from typing import List, Optional, TYPE_CHECKING

from xoneaiagents.ui.a2a.types import AgentCard
from xoneaiagents.ui.a2a.agent_card import generate_agent_card
from xoneaiagents.ui.a2a.task_store import TaskStore
...
class A2A:
    """
    A2A Interface for XoneAI Agents.
    
    Exposes a XoneAI Agent or Agents workflow via the A2A protocol,
    enabling agent-to-agent communication with other A2A-compatible systems.
    
    Usage:
        from xoneaiagents import Agent
        from xoneaiagents.ui.a2a import A2A
    ...
    def __init__(
        ...
        if description:
            ...
            self.description = "XoneAI Agent via A2A"
