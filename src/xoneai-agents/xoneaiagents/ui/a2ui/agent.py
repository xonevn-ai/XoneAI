...
Provides A2UIAgent wrapper for generating A2UI responses from XoneAI agents.
"""
...
class A2UIAgent:
    """
    A2UI wrapper for XoneAI agents.
    
    Provides methods to generate A2UI responses from agent interactions.
    
    Example:
        >>> from xoneaiagents import Agent
        >>> from xoneaiagents.ui.a2ui import A2UIAgent
        >>> 
    ...
    def __init__(
        ...
        Args:
            agent: The XoneAI Agent to wrap
