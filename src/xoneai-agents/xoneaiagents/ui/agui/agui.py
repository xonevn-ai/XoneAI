...
Exposes XoneAI Agents via the AG-UI protocol.
"""
...
from xoneaiagents.ui.agui.types import (
    BaseEvent,
    RunAgentInput,
)
from xoneaiagents.ui.agui.conversion import (
    agui_messages_to_xoneai,
    validate_state,
    extract_user_input,
)
from xoneaiagents.ui.agui.streaming import (
...
class AGUI:
    """
    AG-UI Interface for XoneAI Agents.
    
    Exposes a XoneAI Agent or Agents workflow via the AG-UI protocol,
    ...
    Args:
        agent: Single XoneAI Agent instance
    ...
    def __init__(
        ...
        if description:
            ...
            self.description = "XoneAI Agent via AG-UI"
        ...
        try:
            ...
            if self.agent:
                async for event in async_stream_agent_response(
                    ...
                    messages=agui_messages_to_xoneai(messages),
                ):
                    yield event
