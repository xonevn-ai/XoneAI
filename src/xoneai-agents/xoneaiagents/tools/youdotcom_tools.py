...
Usage:
    from xoneaiagents.tools import ydc_search, ydc_news, ydc_contents
    ...
    from xoneaiagents.tools import YouTools
    you = YouTools()
...
# Alias for simple usage: from xoneaiagents.tools import ydc
ydc = ydc_search
