...
Welcome to the XoneAI Tools directory! This guide will help you understand how our tools work and how to create new ones, whether you're a beginner or an experienced programmer.
...
XoneAI now supports a plugin system for creating and distributing tools. External developers can create pip-installable tool packages!

### Quick Start

```python
from xoneaiagents import BaseTool, tool, Agent
...
weather = "xoneai_weather.tools:WeatherTool"
```

**4. Users install and use:**
```bash
pip install xoneai-weather
```
...
**Usage:**
```python
from xoneaiagents.tools import get_stock_price, get_stock_info
...
2. **Create Your Tool File**:
   ...
   - Place it in the `xoneaiagents/tools` directory
