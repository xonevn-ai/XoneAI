...
class MentionsParser:
    ...
    def __init__(
        ...
        Args:
            ...
            max_file_chars: Maximum characters to include from files.
                           ...
                           Can be overridden via XONE_MAX_FILE_CHARS env var.
        """
        ...
        if max_file_chars is not None:
            ...
            env_val = os.environ.get('XONE_MAX_FILE_CHARS')
    ...
    def _get_docs_manager(self):
        ...
        if self._docs_manager is None:
            try:
                from xoneaiagents.memory.docs_manager import DocsManager
    ...
    def _get_rules_manager(self):
        ...
        if self._rules_manager is None:
            try:
                from xoneaiagents.memory.rules_manager import RulesManager
        ...
        try:
            ...
            if self.max_file_chars > 0 and len(content) > self.max_file_chars:
                ...
                self._log(
                    ...
                    f"Set XONE_MAX_FILE_CHARS=0 for no limit.",
                    logging.WARNING
                )
    ...
    def _process_web_mention(self, query: str) -> Optional[str]:
        ...
        try:
            ...
            from xoneaiagents.tools import duckduckgo_search
    ...
    def _process_url_mention(self, url: str) -> Optional[str]:
        ...
        try:
            ...
            req = urllib.request.Request(
                url,
                headers={'User-Agent': 'Mozilla/5.0 (compatible; XoneAI/1.0)'}
            )
