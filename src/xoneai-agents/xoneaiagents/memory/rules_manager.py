"""
Rules Manager for XoneAI Agents.
...
class RulesManager:
    ...
    - Global rules (~/.xoneai/rules/)
    - Workspace rules (.xoneai/rules/)
    - Subdirectory rules (subdir/.xoneai/rules/)
    ...
    ROOT_INSTRUCTION_FILES = [
        ...
        "XONE.md",       # XoneAI native instructions
        "XONE.local.md", # XoneAI local overrides (gitignored)
    ]
    ...
    def __init__(
        ...
        Args:
            ...
            global_rules_path: Path to global rules (default: ~/.xoneai/rules)
            verbose: Verbosity level
        """
        self.workspace_path = Path(workspace_path) if workspace_path else Path.cwd()
        self.global_rules_path = Path(global_rules_path) if global_rules_path else Path.home() / ".xoneai" / "rules"
    ...
    def _load_root_instruction_file(self, file_path: Path) -> Optional[Rule]:
        ...
        try:
            ...
            descriptions = {
                ...
                "xone": "XoneAI native instructions",
                "xone_local": "XoneAI local overrides",
            }
    ...
    def _load_all_rules(self):
        ...
        # 4. Load workspace rules from .xoneai/rules/
