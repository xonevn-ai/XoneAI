...
class Memory:
    ...
    def __init__(self, config: Dict[str, Any], verbose: int = 0):
        ...
        # Create .xoneai directory if it doesn't exist
        os.makedirs(".xoneai", exist_ok=True)

        # Short-term DB
        self.short_db = self.cfg.get("short_db", ".xoneai/short_term.db")
        self._init_stm()

        # Long-term DB
        self.long_db = self.cfg.get("long_db", ".xoneai/long_term.db")
        self._init_ltm()
    ...
    def _init_mongodb(self):
        ...
        try:
            ...
            self.database_name = mongo_cfg.get("database", "xoneai")
    ...
    def store_long_term(
        ...
        if self.use_rag and hasattr(self, "chroma_col"):
            try:
                from xoneaiagents.embedding import embedding as get_embedding
