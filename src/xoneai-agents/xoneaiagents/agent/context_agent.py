...
class ContextAgent(Agent):
    ...
    This follows the exact principles from the PRD template but adapted for XoneAI architecture.
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.output_dir = Path(".xoneai/prp")  # Save in .xoneai/prp folder
    ...
    def _get_filtered_files(self, project_path: str, pattern: str, max_files: int) -> List[str]:
        ...
        try:
            ...
            exclude_patterns = [
                ...
                '.venv', 'venv', 'dist', 'build', '.xoneai', '.chroma_db',
...
"""
        ...
        if self.debug_mode:
            ...
            # Non-debug mode: Save ONLY the final comprehensive PRP directly in .xoneai/prp
