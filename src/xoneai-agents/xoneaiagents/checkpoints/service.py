"""
Checkpoint Service for XoneAI Agents.
...
class CheckpointService:
    ...
    Example:
        service = CheckpointService(
            ...
            storage_dir="~/.xoneai/checkpoints"
        )
    ...
    async def _init_shadow_git(self) -> bool:
        ...
        try:
            ...
            # Configure git
            await self._run_git("config", "user.name", "XoneAI Checkpoints")
            await self._run_git("config", "user.email", "checkpoints@ai.xone.vn")
