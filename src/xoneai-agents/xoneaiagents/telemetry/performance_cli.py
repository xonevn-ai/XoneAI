"""
Performance Monitoring CLI for XoneAI
...
Usage:
    python -m xoneaiagents.telemetry.performance_cli [command] [options]
    
Or import and use programmatically:
    from xoneaiagents.telemetry.performance_cli import PerformanceCLI
    cli = PerformanceCLI()
...
class PerformanceCLI:
    ...
    def show_performance_report(self, detailed: bool = False) -> None:
        ...
        print("📊 XoneAI Performance Monitoring Report")
        print("=" * 60)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="XoneAI Performance Monitoring CLI",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python -m xoneaiagents.telemetry.performance_cli report
  python -m xoneaiagents.telemetry.performance_cli functions
  python -m xoneaiagents.telemetry.performance_cli apis
  python -m xoneaiagents.telemetry.performance_cli slowest-functions 5
  python -m xoneaiagents.telemetry.performance_cli flow
  python -m xoneaiagents.telemetry.performance_cli analyze-flow
  python -m xoneaiagents.telemetry.performance_cli trends
        """
    )
