...
This document provides detailed analysis of the performance impact when PostHog telemetry is enabled by default in XoneAI Agents.
...
| `XONEAI_DISABLE_TELEMETRY=true` | Complete disable |
| `XONEAI_PERFORMANCE_MODE=true` | Enable but don't post events |
...
from xoneaiagents import get_telemetry
...
from xoneaiagents import cleanup_telemetry_resources
...
1. Enable performance mode: `export XONEAI_PERFORMANCE_MODE=true`
2. Or disable telemetry: `export XONEAI_DISABLE_TELEMETRY=true`
