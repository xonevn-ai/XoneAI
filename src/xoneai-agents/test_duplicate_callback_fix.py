...
from xoneaiagents import register_display_callback
...
def test_single_display_no_tools():
    ...
    try:
        ...
        from xoneaiagents.main import sync_display_callbacks
...
def test_single_display_with_self_reflection():
    ...
    try:
        with patch('xoneaiagents.main.display_self_reflection'):
            with patch('litellm.completion') as mock_completion:
