...
def clear_xoneai_modules():
    """Clear all xoneai modules from sys.modules"""
    to_remove = []
    for mod in sys.modules.keys():
        if mod.startswith('xoneaiagents'):
...
def test_normal_mode():
    ...
    try:
        ...
        should_suppress = xoneaiagents._should_suppress_warnings()
