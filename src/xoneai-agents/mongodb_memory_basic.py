...
from xoneaiagents.agent import ContextAgent
import pymongo

context_agent = ContextAgent(llm="gpt-4o-mini", auto_analyze=False)

context_output = context_agent.start("https://github.com/xonevn-ai/XoneAI/ Need to add Authentication")
...
implementation_system = AgentTeam(
...
try:
    ...
    search_terms = ["authentication", "security", "implementation", "requirements", "XoneAI"]
