#!/usr/bin/env python3
"""
Import time benchmark for xoneaiagents.

This benchmark measures the import time of the xoneaiagents package
...
def clear_modules():
    """Clear all xoneai and litellm related modules from cache."""
    to_remove = [m for m in sys.modules.keys() 
                 if 'xone' in m or 'litellm' in m]
...
def check_lazy_imports() -> dict:
    """
    Check that heavy dependencies are NOT loaded after importing xoneaiagents.
...
def main():
    ...
    print("=" * 60)
    print("XoneAI Agents Import Time Benchmark")
    print("=" * 60)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='XoneAI Agents Import Time Benchmark')
