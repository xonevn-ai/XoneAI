"""
XoneAI Performance Monitoring Demo

This example demonstrates how to use XoneAI's comprehensive performance monitoring
...
from xoneaiagents.telemetry import (
...
print("=" * 80)
print("XONEAI PERFORMANCE MONITORING DEMONSTRATION")
print("=" * 80)
...
research_agent = Agent(
    ...
    tools=[duckduckgo],
    output="silent"  # Reduce output for cleaner demo
)
...
print("python -m xoneaiagents.telemetry.performance_cli report")
print()
print("# Show function statistics")  
print("python -m xoneaiagents.telemetry.performance_cli functions")
print()
print("# Show API call statistics")
print("python -m xoneaiagents.telemetry.performance_cli apis")
print()
print("# Show slowest functions")
print("python -m xoneaiagents.telemetry.performance_cli slowest-functions 5")
print()
print("# Analyze function flow") 
print("python -m xoneaiagents.telemetry.performance_cli analyze-flow")
print()
print("# Show execution flow visualization")
print("python -m xoneaiagents.telemetry.performance_cli flow --format text")
print()
print("# Export all data to JSON")
print("python -m xoneaiagents.telemetry.performance_cli export --format json --output performance_data.json")

# Example 7: Integration with Existing Code
print("\n\n🔧 EXAMPLE 7: Easy Integration with Existing Code")  
print("-" * 50)
print("To integrate performance monitoring into your existing XoneAI code:")
print()
print("1. Import the performance monitoring tools:")
print("   from xoneaiagents.telemetry import monitor_function, track_api_call")
print()
...
print("   from xoneaiagents.telemetry import get_performance_report")
