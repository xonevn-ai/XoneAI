...
## Overview
These optimizations improve the performance of the XoneAI LLM class, particularly when running examples like `gemini-basic.py`. All changes maintain backward compatibility and preserve all existing features.
