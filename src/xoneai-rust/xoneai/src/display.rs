//! Display and callback system for XoneAI
//!
...
//!
//! ```rust,ignore
//! use xoneai::display::{register_display_callback, display_interaction, DisplayType};
//!
...
/// XoneAI color palette for consistent UI
#[derive(Debug, Clone)]
...
/// Default XoneAI color palette
pub static XONE_COLORS: Lazy<ColorPalette> = Lazy::new(|| ColorPalette {
    agent: "#86A789",
    agent_text: "#D2E3C8",
    task: "#FF9B9B",
    task_text: "#FFE5E5",
...
mod tests {
    ...
    fn test_color_palette() {
        assert_eq!(XONE_COLORS.agent, "#86A789");
        assert_eq!(XONE_COLORS.error, "#E57373");
    }
