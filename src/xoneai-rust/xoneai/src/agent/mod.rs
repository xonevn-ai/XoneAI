//! Agent module for XoneAI
//!
//! This module provides the core Agent struct and builder pattern.
//! Agents are the primary execution unit in XoneAI.
//!
//! # Example
//!
//! ```rust,ignore
//! use xoneai_core::Agent;
//!
//! let agent = Agent::new()
//!     .name("assistant")
...
///
/// Agents are the primary execution unit in XoneAI. They combine:
