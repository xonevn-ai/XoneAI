//! XoneAI Core - High-performance, agentic AI framework for Rust
//!
...
//! # Architecture
//!
//! XoneAI follows an agent-centric design with these core components:
//!
...
pub use display::{
    ...
    // Constants
    XONE_COLORS, WORKING_FRAMES, WORKING_PHASES,
};
...
pub use parity::{
    ...
    XoneConfig, PluginsConfig, DefaultsConfig, ManagerConfig, 
    ...
    ParityApprovalDecision, ParityRiskLevel, FlowDisplay, XoneColors,
...
// Re-export the tool macro from xoneai-derive
pub use xoneai_derive::tool;
