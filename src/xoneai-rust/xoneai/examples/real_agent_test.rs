...
use xoneai::{Agent, AgentTeam, Process, Tool, ToolRegistry};
...
impl Tool for CalculatorTool {
    ...
    async fn execute(&self, args: Value) -> xoneai::Result<Value> {
...
async fn main() {
    println!("╔══════════════════════════════════════════════════════════════╗");
    println!("║      XoneAI Rust SDK - Real Agent Integration Tests       ║");
    println!("╚══════════════════════════════════════════════════════════════╝\n");
