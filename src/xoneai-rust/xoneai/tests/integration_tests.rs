//! Integration tests for XoneAI Rust SDK
//!
...
fn test_session_data() {
    use xoneai::{SessionData, SessionMessage};
...
fn test_in_memory_session_store() {
    use xoneai::{InMemorySessionStore, SessionData, SessionMessage, SessionStore};
...
#[test]
fn test_session_api() {
    use xoneai::{InMemorySessionStore, Session, SessionStore};
    use std::sync::Arc;
...
fn test_hook_event_types() {
    use xoneai::{HookDecision, HookEvent};
...
fn test_hook_registry() {
    use xoneai::{HookEvent, HookInput, HookRegistry, HookResult};
...
#[test]
fn test_hook_runner() {
    use xoneai::{HookEvent, HookRegistry, HookResult, HookRunner};
...
fn test_task_creation() {
    use xoneai::{Task, TaskStatus, TaskType};
...
fn test_task_status_transitions() {
    use xoneai::{Task, TaskOutput, TaskStatus};
