...
//!
//! Run with: cargo run -p xoneai --example config_example

use xoneai::{Agent, ExecutionConfig, MemoryConfig, OutputConfig};

#[tokio::main]
async fn main() -> anyhow::Result<()> {
    println!("=== XoneAI Configuration Examples ===\n");
    ...
    println!(
        "   - JSON mode: {}, file: {:?}",
        output_json.mode, output_json.file
    );
