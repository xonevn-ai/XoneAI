...
//!
//! Run with: cargo run -p xoneai --example workflow_patterns

use xoneai::{Agent, AgentTeam, Process, StepResult, WorkflowContext};

#[tokio::main]
async fn main() -> anyhow::Result<()> {
    println!("=== XoneAI Workflow Patterns ===\n");
    ...
    println!(
        ...
        success.agent, success.success
    );
    println!(
        "   Failure: agent={}, success={}, error={:?}",
        failure.agent, failure.success, failure.error
    );
