# XoneAI Concept Examples

This directory contains examples demonstrating core concepts of the XoneAI package.
...
> **Note**: These examples assume you have installed the `xoneai` package from npm. If you're running these examples from within the package source code, the imports will automatically use the local package code.
...
```typescript
import { Agent, Task, XoneAIAgents } from 'xoneai';
