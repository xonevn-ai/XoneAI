# XoneAI Tool Registration Examples

This document demonstrates the three different ways to register tool functions in XoneAI.
...
import { registerFunction } from 'xoneai';
...
XoneAI can use remote tools exposed via the Model Context Protocol over Server-Sent Events.

1. Start the Python SSE server in another terminal:
```bash
python ../../xoneai-agents/tests/mcp-sse-direct-server.py --host 127.0.0.1 --port 8080
```
