 ...
 */
export function superagentGuard(config?: GuardConfig): XoneTool<GuardInput, GuardResult> {
  return {
    name: 'guard',
 ...
 */
export function superagentRedact(config?: RedactConfig): XoneTool<RedactInput, RedactResult> {
  return {
    name: 'redact',
 ...
 */
export function superagentVerify(config?: VerifyConfig): XoneTool<VerifyInput, VerifyResult> {
  return {
    name: 'verify',
 ...
 */
export function createSuperagentGuardTool(config?: GuardConfig): XoneTool<unknown, unknown> {
  return superagentGuard(config) as XoneTool<unknown, unknown>;
}

export function createSuperagentRedactTool(config?: RedactConfig): XoneTool<unknown, unknown> {
  return superagentRedact(config) as XoneTool<unknown, unknown>;
}

export function createSuperagentVerifyTool(config?: VerifyConfig): XoneTool<unknown, unknown> {
  return superagentVerify(config) as XoneTool<unknown, unknown>;
}
