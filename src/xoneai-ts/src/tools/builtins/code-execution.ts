 ...
 */
export function codeExecution(config?: CodeExecutionConfig): XoneTool<CodeExecutionInput, CodeExecutionOutput> {
 ...
 */
export function createCodeExecutionTool(config?: CodeExecutionConfig): XoneTool<unknown, unknown> {
  return codeExecution(config) as XoneTool<unknown, unknown>;
}
