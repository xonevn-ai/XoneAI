 ...
 */
export function airweaveSearch(config?: AirweaveSearchConfig): XoneTool<AirweaveSearchInput, AirweaveSearchResult> {
  return {
    name: 'airweaveSearch',
 ...
 */
export function createAirweaveSearchTool(config?: AirweaveSearchConfig): XoneTool<unknown, unknown> {
  return airweaveSearch(config) as XoneTool<unknown, unknown>;
}
