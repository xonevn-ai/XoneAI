 ...
 */
export function parallelSearch(config?: ParallelSearchConfig): XoneTool<ParallelSearchInput, ParallelSearchResult> {
  return {
    name: 'parallelSearch',
 ...
 */
export function createParallelSearchTool(config?: ParallelSearchConfig): XoneTool<unknown, unknown> {
  return parallelSearch(config) as XoneTool<unknown, unknown>;
}
