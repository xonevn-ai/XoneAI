 ...
 */
export function bedrockCodeInterpreter(config?: CodeInterpreterConfig): XoneTool<CodeInterpreterInput, CodeInterpreterResult> {
  return {
 ...
 */
export function bedrockBrowserNavigate(config?: BrowserConfig): XoneTool<BrowserNavigateInput, BrowserResult> {
  return {
 ...
 */
export function bedrockBrowserClick(config?: BrowserConfig): XoneTool<BrowserClickInput, BrowserResult> {
  return {
 ...
 */
export function bedrockBrowserFill(config?: BrowserConfig): XoneTool<BrowserFillInput, BrowserResult> {
  return {
 ...
 */
export function createBedrockCodeInterpreterTool(config?: CodeInterpreterConfig): XoneTool<unknown, unknown> {
  return bedrockCodeInterpreter(config) as XoneTool<unknown, unknown>;
}

export function createBedrockBrowserNavigateTool(config?: BrowserConfig): XoneTool<unknown, unknown> {
  return bedrockBrowserNavigate(config) as XoneTool<unknown, unknown>;
}

export function createBedrockBrowserClickTool(config?: BrowserConfig): XoneTool<unknown, unknown> {
  return bedrockBrowserClick(config) as XoneTool<unknown, unknown>;
}

export function createBedrockBrowserFillTool(config?: BrowserConfig): XoneTool<unknown, unknown> {
  return bedrockBrowserFill(config) as XoneTool<unknown, unknown>;
}
