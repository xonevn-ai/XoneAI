...
import type { ToolMetadata, XoneTool, ToolExecutionContext } from '../registry/types';
...
): XoneTool<ValyuSearchInput, ValyuSearchResult> {
  return {
    name,
    description,
    parameters: {
 ...
 */
export function valyuWebSearch(config?: ValyuSearchConfig): XoneTool<ValyuSearchInput, ValyuSearchResult> {
 ...
 */
export function valyuFinanceSearch(config?: ValyuSearchConfig): XoneTool<ValyuSearchInput, ValyuSearchResult> {
  return createValyuTool(
    'valyuFinanceSearch',
 ...
 */
export function valyuPaperSearch(config?: ValyuSearchConfig): XoneTool<ValyuSearchInput, ValyuSearchResult> {
  return createValyuTool(
    'valyuPaperSearch',
 ...
 */
export function valyuBioSearch(config?: ValyuSearchConfig): XoneTool<ValyuSearchInput, ValyuSearchResult> {
  return createValyuTool(
    'valyuBioSearch',
 ...
 */
export function valyuPatentSearch(config?: ValyuSearchConfig): XoneTool<ValyuSearchInput, ValyuSearchResult> {
  return createValyuTool(
    'valyuPatentSearch',
 ...
 */
export function valyuSecSearch(config?: ValyuSearchConfig): XoneTool<ValyuSearchInput, ValyuSearchResult> {
  return createValyuTool(
    'valyuSecSearch',
 ...
 */
export function valyuEconomicsSearch(config?: ValyuSearchConfig): XoneTool<ValyuSearchInput, ValyuSearchResult> {
  return createValyuTool(
 ...
 */
export function valyuCompanyResearch(config?: ValyuSearchConfig): XoneTool<ValyuSearchInput, ValyuSearchResult> {
  return createValyuTool(
 ...
 */
export function createValyuWebSearchTool(config?: ValyuSearchConfig): XoneTool<unknown, unknown> {
  return valyuWebSearch(config) as XoneTool<unknown, unknown>;
}

export function createValyuFinanceSearchTool(config?: ValyuSearchConfig): XoneTool<unknown, unknown> {
  return valyuFinanceSearch(config) as XoneTool<unknown, unknown>;
}

export function createValyuPaperSearchTool(config?: ValyuSearchConfig): XoneTool<unknown, unknown> {
  return valyuPaperSearch(config) as XoneTool<unknown, unknown>;
}

export function createValyuBioSearchTool(config?: ValyuSearchConfig): XoneTool<unknown, unknown> {
  return valyuBioSearch(config) as XoneTool<unknown, unknown>;
}

export function createValyuPatentSearchTool(config?: ValyuSearchConfig): XoneTool<unknown, unknown> {
  return valyuPatentSearch(config) as XoneTool<unknown, unknown>;
}

export function createValyuSecSearchTool(config?: ValyuSearchConfig): XoneTool<unknown, unknown> {
  return valyuSecSearch(config) as XoneTool<unknown, unknown>;
}

export function createValyuEconomicsSearchTool(config?: ValyuSearchConfig): XoneTool<unknown, unknown> {
  return valyuEconomicsSearch(config) as XoneTool<unknown, unknown>;
}

export function createValyuCompanyResearchTool(config?: ValyuSearchConfig): XoneTool<unknown, unknown> {
  return valyuCompanyResearch(config) as XoneTool<unknown, unknown>;
}
