 ...
 */
export function perplexitySearch(config?: PerplexitySearchConfig): XoneTool<PerplexitySearchInput, PerplexitySearchResult> {
  return {
 ...
 */
export function createPerplexitySearchTool(config?: PerplexitySearchConfig): XoneTool<unknown, unknown> {
  return perplexitySearch(config) as XoneTool<unknown, unknown>;
}
