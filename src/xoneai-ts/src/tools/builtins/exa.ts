 ...
 */
export function exaSearch(config?: ExaSearchConfig): XoneTool<ExaSearchInput, ExaSearchResult> {
  return {
    name: 'webSearch',
 ...
 */
export function createExaSearchTool(config?: ExaSearchConfig): XoneTool<unknown, unknown> {
  return exaSearch(config) as XoneTool<unknown, unknown>;
}
