 ...
 */
export function firecrawlScrape(config?: FirecrawlScrapeConfig): XoneTool<FirecrawlScrapeInput, FirecrawlScrapeResult> {
  return {
 ...
 */
export function firecrawlCrawl(config?: FirecrawlCrawlConfig): XoneTool<FirecrawlCrawlInput, FirecrawlCrawlResult> {
  return {
    name: 'firecrawlCrawl',
 ...
 */
export function createFirecrawlScrapeTool(config?: FirecrawlScrapeConfig): XoneTool<unknown, unknown> {
  return firecrawlScrape(config) as XoneTool<unknown, unknown>;
}

export function createFirecrawlCrawlTool(config?: FirecrawlCrawlConfig): XoneTool<unknown, unknown> {
  return firecrawlCrawl(config) as XoneTool<unknown, unknown>;
}
