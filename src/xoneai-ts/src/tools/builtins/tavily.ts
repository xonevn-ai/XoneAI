 ...
 * Returns a XoneTool that can be used with agents or directly
 */
export function tavilySearch(config?: TavilySearchConfig): XoneTool<TavilySearchInput, TavilySearchResult> {
 ...
 */
export function tavilyExtract(config?: TavilyExtractConfig): XoneTool<TavilyExtractInput, TavilyExtractResult> {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  let cachedTool: any = null;
 ...
 */
export function tavilyCrawl(config?: TavilyCrawlConfig): XoneTool<TavilyCrawlInput, TavilyCrawlResult> {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  let cachedTool: any = null;
 ...
 */
export function createTavilySearchTool(config?: TavilySearchConfig): XoneTool<unknown, unknown> {
  return tavilySearch(config) as XoneTool<unknown, unknown>;
}

export function createTavilyExtractTool(config?: TavilyExtractConfig): XoneTool<unknown, unknown> {
  return tavilyExtract(config) as XoneTool<unknown, unknown>;
}

export function createTavilyCrawlTool(config?: TavilyCrawlConfig): XoneTool<unknown, unknown> {
  return tavilyCrawl(config) as XoneTool<unknown, unknown>;
}
