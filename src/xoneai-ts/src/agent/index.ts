/**
 * Agent Module - Core agent classes for XoneAI
 * 
 * The primary exports are:
 * - Agent: Single agent with instructions, tools, and optional persistence
 * - Agents: Multi-agent orchestration (alias for XoneAIAgents)
...
export { Agent, AgentTeam, XoneAIAgents, Agents } from './simple';
export type { SimpleAgentConfig, AgentTeamConfig, XoneAIAgentsConfig } from './simple';
