/**
 * Parity Module for XoneAI TypeScript SDK
 * 
 ...
 * Python parity: xoneaiagents/agent/audio_agent.py
 */
 ...
 * Python parity: xoneaiagents/agent/code_agent.py
 */
 ...
 * Python parity: xoneaiagents/agent/ocr_agent.py
 */
 ...
 * Python parity: xoneaiagents/agent/vision_agent.py
 */
 ...
 * Python parity: xoneaiagents/agent/video_agent.py
 */
 ...
 * Python parity: xoneaiagents/agent/realtime_agent.py
 */
 ...
 * Python parity: xoneaiagents/agent/embedding_agent.py
 */
 ...
 * Python parity: xoneaiagents/agent/agent.py
 */
 ...
 * Python parity: xoneaiagents/agent/deep_research.py
 */
 ...
 * Python parity: xoneaiagents/llm
 */
 ...
 * Python parity: xoneaiagents/agent/handoff.py
 */
 ...
 * Python parity: xoneaiagents/workflows/workflows.py
 */
export class Loop {
  private agents: any[];
 ...
 * Python parity: xoneaiagents/knowledge/chunking.py
 */
 ...
 * Python parity: xoneaiagents/knowledge/knowledge.py
 */
 ...
 * Python parity: xoneaiagents/session/session.py
 */
 ...
 * Python parity: xoneaiagents/context/fast.py
 */
 ...
 * Python parity: xoneaiagents/rag/rag.py
 */
 ...
 * Python parity: xoneaiagents/guardrails/guardrails.py
 */
 ...
 * Python parity: xoneaiagents/mcp/mcp.py
 */
export class MCP {
 ...
 * Python parity: xoneaiagents/agents/agents.py
 */
 ...
 * Python parity: xoneaiagents/telemetry/telemetry.py
 */
...
/**
 * Plan - Execution plan.
 * Python parity: xoneaiagents/planning/planning.py
 */
export class Plan {
  id: string;
  steps: PlanStep[];
 ...
 * Python parity: xoneaiagents/skills/loader.py
 */
 ...
 * Python parity: xoneaiagents/telemetry
 */
 ...
 * Python parity: xoneaiagents/main.py
 */
...
/**
 * Plugin class.
 * Python parity: xoneaiagents/plugins
 */
export class Plugin {
  name: string;
  version: string;
 ...
 * Python parity: xoneaiagents/trace
 */
 ...
 * Python parity: xoneaiagents/conditions
 */
 ...
 * Python parity: xoneaiagents/embedding
 */
 ...
 * Python parity: xoneaiagents/flow_display
 */
 ...
 * Python parity: xoneaiagents/llm/failover.py
 */
 ...
 * Python parity: xoneaiagents/task/task.py
 */
export class Task {
  name: string;
  description: string;
 ...
 * Python parity: xoneaiagents/config/presets.py
 */
 ...
 * Python parity: xoneaiagents/memory
 */
 ...
 * Python parity: xoneaiagents/config
 */
 ...
 * Python parity: xoneaiagents/config/param_resolver.py
 */
 ...
 * Python parity: xoneaiagents/config/resolvers.py
 */
 ...
 * Python parity: xoneaiagents/ui/agui
 */
export class AGUI {
...
export function get_default_plugin_dirs(): string[] {
  return ['./plugins', './xoneai_plugins', '~/.xoneai/plugins'];
}
...
/**
 * Evaluate condition.
 * Python parity: xoneaiagents/conditions/evaluator.py
 */
 ...
 * Python parity: xoneaiagents/embedding/dimensions.py
 */
...
/**
 * Track workflow execution.
 * Python parity: xoneaiagents/flow_display.py
 */
