/**
 * Configuration Module for XoneAI TypeScript SDK
 * 
 * Python parity with xoneaiagents/config module
 * 
 * Provides:
 ...
 * Python parity: xoneaiagents/config/feature_configs.py:40-47
 */
 ...
 * Python parity: xoneaiagents/config/feature_configs.py
 */
 ...
 * Python parity: xoneaiagents/config/feature_configs.py:117-180
 */
 ...
 * Python parity: xoneaiagents/config/feature_configs.py:60-114
 */
...
/**
 * Xone configuration (main config).
 * Python parity: xoneaiagents/config/feature_configs.py
 */
...
// ============================================================================
// Presets (Python parity with xoneaiagents/config/presets.py)
// ============================================================================

/**
 * Memory presets.
 * Python parity: xoneaiagents/config/presets.py:18-33
 */
...
/**
 * Memory URL schemes.
 * Python parity: xoneaiagents/config/presets.py:35-43
 */
...
/**
 * Output presets.
 * Python parity: xoneaiagents/config/presets.py:60-185
 */
...
/**
 * Execution presets.
 * Python parity: xoneaiagents/config/presets.py:198-223
 */
...
/**
 * Web presets.
 * Python parity: xoneaiagents/config/presets.py:230-240
 */
...
/**
 * Planning presets.
 * Python parity: xoneaiagents/config/presets.py:247-251
 */
...
/**
 * Reflection presets.
 * Python parity: xoneaiagents/config/presets.py:258-262
 */
...
/**
 * Guardrail presets.
 * Python parity: xoneaiagents/config/presets.py:269-273
 */
...
/**
 * Context presets.
 * Python parity: xoneaiagents/config/presets.py:280-284
 */
...
/**
 * Autonomy presets.
 * Python parity: xoneaiagents/config/presets.py:291-295
 */
...
/**
 * Caching presets.
 * Python parity: xoneaiagents/config/presets.py:302-306
 */
 ...
 * Python parity: xoneaiagents/config/presets.py:313-317
 */
 ...
 * Python parity: xoneaiagents/config/presets.py:324-329
 */
...
/**
 * Knowledge presets.
 * Python parity: xoneaiagents/config/presets.py:355-357
 */
...
// ============================================================================
// Resolver Functions (Python parity with xoneaiagents/config/param_resolver.py)
// ============================================================================
...
// ============================================================================
// Parse Utilities (Python parity with xoneaiagents/config/parse_utils.py)
// ============================================================================

/**
 * Detect URL scheme from a connection string.
 * Python parity: xoneaiagents/config/parse_utils.py
 */
...
export function get_config_path(): string {
  return get_config('XONEAI_CONFIG_PATH', '.xone/config.json') ?? '.xone/config.json';
}
