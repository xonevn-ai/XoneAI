/**
 * Session - Unified session management for XoneAI
 * 
 * Python parity with xoneaiagents/session/api.py
...
/**
 * A unified session management class for XoneAI.
 * 
 * Provides:
