...
export class SkillManager {
  ...
  private setupDiscoveryPaths(options: SkillDiscoveryOptions): void {
    ...
    if (options.includeProject !== false) {
      this.discoveryPaths.push('./.xone/skills');
    ...
    if (options.includeUser !== false) {
      ...
      if (home) {
        this.discoveryPaths.push(path.join(home, '.xone/skills'));
      }
    }

    if (options.includeSystem) {
      this.discoveryPaths.push('/etc/xone/skills');
    }
  }
 ...
 * Python parity with xoneaiagents/skills/models.py SkillProperties.
 */
 ...
 * Python parity with xoneaiagents/skills/loader.py SkillLoader.
 */
