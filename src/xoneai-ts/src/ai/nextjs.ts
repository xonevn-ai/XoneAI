 ...
 * ```typescript
 * import { createRouteHandler } from 'xoneai/ai';
 * import { streamText } from 'xoneai/ai';
 * 
 ...
 * ```typescript
 * import { createPagesHandler } from 'xoneai/ai';
 * import { streamText } from 'xoneai/ai';
 * 
 ...
 * ```
 * 
 * The xoneai package focuses on server-side functionality.
