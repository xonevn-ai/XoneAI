/**
 * Protocols Module for XoneAI TypeScript SDK
 * 
 * Python parity with xoneaiagents protocols
 * 
 * Provides:
...
/**
 * A2A Task state.
 * Python parity: xoneaiagents/ui/a2a/types.py
 */
 ...
 * Python parity: xoneaiagents/ui/a2a/a2a.py
 */
export class A2A {
 ...
 * Python parity: xoneaiagents/ui/agui/agui.py
 */
export class AGUI {
  private config: {
    name: string;
 ...
 * Python parity: xoneaiagents/agents/auto_rag_agent.py
 */
 ...
 * Python parity: xoneaiagents/tools
 */
export class Tools {
 ...
 * Python parity: xoneaiagents.obs
 */
 ...
 * Python parity: xoneaiagents.workflows
 */
