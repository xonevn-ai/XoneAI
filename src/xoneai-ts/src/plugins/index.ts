/**
 * Plugin Module for XoneAI TypeScript SDK
 * 
 * Python parity with xoneaiagents/plugins module
 * 
 * Provides:
...
/**
 * Plugin hook points.
 * Python parity: xoneaiagents/plugins/plugin.py
 */
...
/**
 * Plugin metadata.
 * Python parity: xoneaiagents/plugins/parser.py
 */
 ...
 * Python parity: xoneaiagents/plugins/protocols.py
 */
 ...
 * Python parity: xoneaiagents/plugins/manager.py
 */
 ...
 * Python parity: xoneaiagents/plugins/discovery.py
 */
export function getDefaultPluginDirs(): string[] {
  const dirs: string[] = [];

  // Project-level
  dirs.push('./.xone/plugins');
  dirs.push('./.xoneai/plugins');

  // User-level (would use os.homedir() in Node.js)
  if (typeof process !== 'undefined' && process.env?.HOME) {
    dirs.push(`${process.env.HOME}/.xone/plugins`);
    dirs.push(`${process.env.HOME}/.xoneai/plugins`);
  }
...
import { Plugin, PluginHook, PluginType } from 'xoneai';
 ...
 * Python parity: xoneaiagents/plugins/__init__.py
 */
