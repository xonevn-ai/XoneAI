...
export class TelemetryCollector {
  ...
  private checkEnabled(): boolean {
    const disabled = process.env.XONEAI_TELEMETRY_DISABLED === 'true' ||
      process.env.XONEAI_DISABLE_TELEMETRY === 'true' ||
 ...
 * ```typescript
 * import { AgentTelemetry } from 'xoneai';
 * 
 ...
 * Python parity with xoneaiagents/telemetry/telemetry.py MinimalTelemetry.
 */
 ...
 * Python parity with xoneaiagents/telemetry enable_performance_mode.
 */
 ...
 * Python parity with xoneaiagents/telemetry disable_performance_mode.
 */
 ...
 * Python parity with xoneaiagents/telemetry cleanup_telemetry_resources.
 */
