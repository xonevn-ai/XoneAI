/**
 * HooksManager - Cascade Hooks System for XoneAI TypeScript
 * 
 ...
 * @example
 * ```typescript
 * import { HooksManager, createHooksManager } from 'xoneai';
 * 
    ...
    async loadConfig(configPath?: string): Promise<void> {
        try {
            ...
            const filePath = configPath ??
                path.join(this.config.workspacePath, '.xone', 'hooks.json');
