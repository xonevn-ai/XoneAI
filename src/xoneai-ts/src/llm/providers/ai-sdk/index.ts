/**
 * AI SDK Integration for xoneai-ts
 * 
 ...
 * @example Basic usage
 * ```typescript
 * import { createAISDKBackend, registerAISDKProviders } from 'xoneai';
 * 
...
/**
 * Register AI SDK providers with the xoneai-ts provider registry
 ...
 * @example
 * ```typescript
 * import { registerAISDKProviders, createProvider } from 'xoneai';
 * 
