 ...
 * AI SDK Adapter
 * 
 * Converts between xoneai-ts message/tool formats and AI SDK formats.
 * Handles prompt construction, tool definitions, and result parsing.
 */

import type { Message, ToolDefinition, ToolCall, GenerateTextResult, TokenUsage as XoneTokenUsage } from '../types';
import type { 
  AISDKToolDefinition, 
  AISDKToolCall, 
  AISDKToolResult,
...
/**
 * Convert xoneai-ts messages to AI SDK prompt format
 */
...
/**
 * Convert xoneai-ts tool definitions to AI SDK format
...
/**
 * Convert AI SDK tool call to xoneai-ts format
 */
...
/**
 * Convert xoneai-ts tool result to AI SDK format
 */
...
/**
 * Convert AI SDK generate result to xoneai-ts format
 */
export function fromAISDKResult(result: {
  ...
  const usage: XoneTokenUsage = result.usage ? {
  ...
  // Map finish reason to xoneai-ts format
...
/**
 * Map AI SDK finish reason to xoneai-ts provider format
...
/**
 * Convert AI SDK stream chunk to xoneai-ts format
 */
...
/**
 * Map xoneai-ts tool choice to AI SDK format
 */
