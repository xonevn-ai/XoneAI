/**
 * XoneAI CLI Specification - TypeScript Runtime
...
export const ENV_VARS = {
  XONEAI_MODEL: 'XONEAI_MODEL',
  XONEAI_PROFILE: 'XONEAI_PROFILE',
  XONEAI_VERBOSE: 'XONEAI_VERBOSE',
  XONEAI_CONFIG: 'XONEAI_CONFIG',
  XONEAI_DB: 'XONEAI_DB',
...
export const CONFIG_FILES = ['.xoneai.yaml', '.xoneai.json'] as const;
