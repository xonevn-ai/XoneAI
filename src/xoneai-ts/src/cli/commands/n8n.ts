...
function showHelp(isJson: boolean): void {
  const help = {
    ...
    examples: [
      'xoneai-ts n8n trigger my-webhook \'{"data": "test"}\'',
      'xoneai-ts n8n trigger webhook-id --base-url https://n8n.example.com',
      'xoneai-ts n8n export my-workflow',
      'xoneai-ts n8n export workflow --steps "Process:agent,Validate:condition"'
    ]
  };
