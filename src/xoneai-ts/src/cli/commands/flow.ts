...
function showHelp(isJson: boolean): void {
  const help = {
    ...
    examples: [
      'xoneai-ts flow show "Input,Process,Output"',
      'xoneai-ts flow show "Start:start,Agent:agent,End:end"',
      'xoneai-ts flow show --boxes',
      'xoneai-ts flow dot "Step1,Step2,Step3" > workflow.dot'
    ]
  };
