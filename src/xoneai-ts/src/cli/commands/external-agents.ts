...
function showHelp(isJson: boolean): void {
  const help = {
    ...
    examples: [
      'xoneai-ts external-agents list',
      'xoneai-ts external-agents check claude',
      'xoneai-ts external-agents run claude "Explain this code"',
      'xoneai-ts external-agents run gemini "Refactor this function" --cwd ./src'
    ]
  };
