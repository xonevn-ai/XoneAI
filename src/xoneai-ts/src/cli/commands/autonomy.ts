...
function showHelp(isJson: boolean): void {
  const help = {
    ...
    examples: [
      'xoneai-ts autonomy status',
      'xoneai-ts autonomy set suggest',
      'xoneai-ts autonomy set auto_edit',
      'xoneai-ts autonomy set full_auto',
      'xoneai-ts autonomy policies suggest',
      'xoneai-ts autonomy reset'
    ]
  };
