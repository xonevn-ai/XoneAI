...
function showHelp(isJson: boolean): void {
  const help = {
    ...
    examples: [
      'xoneai-ts fast-context query "What is the main topic?"',
      'xoneai-ts fast-context query "summarize" --sources "text1,text2,text3"',
      'xoneai-ts fast-context query "find relevant" --max-tokens 2000',
      'xoneai-ts fast-context stats',
      'xoneai-ts fast-context clear'
    ]
  };
