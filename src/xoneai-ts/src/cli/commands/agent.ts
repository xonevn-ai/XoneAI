 ...
 * 
 * Usage:
 *   xoneai-ts agent chat "Hello, how are you?"
 *   xoneai-ts agent run --instructions "You are helpful" "Tell me a joke"
 */
  ...
  switch (subcommand) {
    ...
    default:
      ...
      if (options.json || options.output === 'json') {
        ...
        await pretty.error('Usage: xoneai-ts agent [chat|run] <prompt>');
