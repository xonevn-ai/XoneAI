...
function showHelp(isJson: boolean): void {
  const help = {
    ...
    examples: [
      'xoneai-ts checkpoints create my-checkpoint',
      'xoneai-ts checkpoints create --state \'{"key": "value"}\'',
      'xoneai-ts checkpoints list',
      'xoneai-ts checkpoints restore <id>',
      'xoneai-ts checkpoints restore  # restores latest',
      'xoneai-ts checkpoints export <id> > checkpoint.json',
      'xoneai-ts checkpoints import \'{"name": "imported"}\'',
      'xoneai-ts checkpoints delete <id>'
    ]
  };
