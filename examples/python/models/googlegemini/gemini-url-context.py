...
through XoneAI. The URL Context tool allows the model to fetch and analyze
...
def main():
    ...
    url_tasks = [
        ...
        {
            "url": "https://github.com/xonevn-ai/XoneAI",
            "task": "Analyze this GitHub repository and explain what XoneAI does"
        },
        {
    ...
    for i, item in enumerate(url_tasks, 1):
        ...
        try:
            ...
            # In XoneAI, this would need to be accessed through the LLM response
