...
This example demonstrates how to use various AWS Bedrock models with XoneAI agents.

Requirements:
    pip install xoneaiagents boto3
...
def main():
    """
    Example of using AWS Bedrock models with XoneAI agents
    """
