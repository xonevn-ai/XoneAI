...
from xoneaiagents.sandbox import SecurityPolicy
...
if __name__ == "__main__":
    ...
    print("  xoneai sandbox run \"print('Hello, World!')\"")
    print("  xoneai sandbox run --file script.py")
    print("  xoneai sandbox shell")
