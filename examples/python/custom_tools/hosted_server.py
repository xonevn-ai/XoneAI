"""
Hosted MCP Server implementation for XoneAI Agents.
...
Note: This is an example implementation. To use it, ensure you have installed:
  pip install xoneaiagents[mcp] starlette>=0.27.0
"""
...
try:
    ...
    raise ImportError(
        ...
        "Please install with: pip install xoneaiagents[mcp] starlette>=0.27.0"
    )
