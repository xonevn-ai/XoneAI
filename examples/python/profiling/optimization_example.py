"""
Performance Optimization Example for XoneAI
...
def demo_lite_mode():
    ...
    print("  export XONEAI_LITE_MODE=1")
    print("  export XONEAI_SKIP_TYPE_VALIDATION=1")
...
def main():
    """Run all demos."""
    print("=" * 60)
    print("XoneAI Performance Optimization Demo")
    print("=" * 60)
