...
with XoneAI agents to create and utilize complex relationships 
between pieces of information.

Requirements:
    pip install "xoneaiagents[graph]"
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("   pip install \"xoneaiagents[graph]\"")
