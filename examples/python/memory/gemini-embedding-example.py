#!/usr/bin/env python3
"""
Example: Using Gemini Embedding Models with XoneAI Memory

This example demonstrates how to configure XoneAI to use Google's Gemini
...
Prerequisites:
1. Install xoneaiagents with memory support:
   pip install "xoneaiagents[memory]"

2. Set your Google API key:
   export GOOGLE_API_KEY='your-api-key'

3. Ensure litellm is installed (comes with xoneaiagents)
"""
