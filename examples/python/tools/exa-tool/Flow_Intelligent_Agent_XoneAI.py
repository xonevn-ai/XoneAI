# # -*- coding: utf-8 -*-
# """Flow_Intelligent_Agent_XoneAI.ipynb
...
# [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/DhivyaBharathy-web/XoneAI/blob/main/examples/cookbooks/Flow_Intelligent_Agent_XoneAI.ipynb)

# ## Tools
# - `xoneaiagents` – Intelligent Agent framework
...
# pip install xoneaiagents duckduckgo-search pyyaml openai
