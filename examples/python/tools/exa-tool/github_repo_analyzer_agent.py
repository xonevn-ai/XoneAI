...
#     https://colab.research.google.com/github/DhivyaBharathy-web/XoneAI/blob/main/examples/cookbooks/github_repo_analyzer_agent.ipynb

# # 🤖 GitHub Repo Analyzer Agent
# AI agent powered by XoneAI and OpenAI to analyze GitHub repositories using GitHub API.

# [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/DhivyaBharathy-web/XoneAI/blob/main/examples/cookbooks/github_repo_analyzer_agent.ipynb)

# # 📦 Install dependencies
# """

# !pip install xoneaiagents openai requests

# """# Tools Used

# 🧠 xoneaiagents – Smart AI agent
