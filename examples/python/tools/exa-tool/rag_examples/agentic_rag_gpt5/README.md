...
An agentic RAG application built with the XoneAI Agents framework, featuring GPT-5 and built-in vector search for efficient knowledge retrieval and question answering.
...
- **"What is XoneAI?"** - Learn about the XoneAI Agents framework
- **"Teams in XoneAI"** - Understand how teams work in XoneAI
...
- **`Agent`**: XoneAI Agents framework for intelligent Q&A
...
- **Storage**: Local storage managed by XoneAI Agents
- **Search**: Automatic similarity search

### Model Configuration
- **LLM**: OpenAI GPT-5-nano
- **Embeddings**: Automatic handling by XoneAI Agents
...
### Default Knowledge
- Starts with XoneAI documentation: `https://docs.xoneai.com/introduction/agents.md`
...
- Check if XoneAI Agents is properly installed
...
**Built with ❤️ using XoneAI Agents and GPT-5**
