...
# This notebook demonstrates a News and Podcast Aggregator Agent built with `xoneaiagents`.  
...
# [![Open in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Dhivya-Bharathy/XoneAI/blob/main/examples/cookbooks/SocialMedia_Content_Agents/News_And_Podcast_Aggregator_Agent.ipynb)
# 
...
get_ipython().system('pip install xoneaiagents pydantic')
...
# Set up the OpenAI API key for xoneaiagents
