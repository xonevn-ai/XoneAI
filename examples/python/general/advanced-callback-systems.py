...
This example demonstrates callback systems using XoneAI's built-in
callback functionality for monitoring agent interactions and tool usage.
"""

from xoneaiagents import Agent, Task, AgentTeam
from xoneaiagents.display_callback import register_display_callback
...
# Register callbacks with XoneAI's callback system
