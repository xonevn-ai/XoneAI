#!/usr/bin/env python3
"""
Human Approval Example for XoneAI Agents
...
sys.path.append(os.path.join(os.path.dirname(__file__), '..', '..', '..', 'src', 'xoneai-agents'))

from xoneaiagents import Agent, Task, AgentTeam
from xoneaiagents.tools import python_tools, file_tools, shell_tools
from xoneaiagents.main import register_approval_callback
...
def main():
    ...
    print("🤖 XoneAI Human Approval System Demo")
    print("=" * 50)
