...
Demonstrates how to use XoneAI's code editing tools with SEARCH/REPLACE diffs.
"""
...
# Write a file
print("\nWriting test file:")
code_write_file("test_output.txt", "Hello from XoneAI Code Tools!")
