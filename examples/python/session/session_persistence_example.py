...
Requirements:
    - xoneaiagents package installed
...
def example_basic_persistence():
    ...
    print(f"\n✅ Session saved to: ~/.xone/sessions/{session_id}.json")
...
def main():
    ...
    print("=" * 60)
    print("\nSession files are stored in: ~/.xone/sessions/")
    print("You can inspect them with: cat ~/.xone/sessions/<session_id>.json")
