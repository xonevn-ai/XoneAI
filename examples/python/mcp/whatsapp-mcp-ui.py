from xoneaiagents import Agent, AgentTeam, MCP
import gradio as gr
...
def search_airbnb(query):
    ...
    whatsapp_agent = Agent(
        instructions="""Send AirBnb Search Result to 'Daniel Do'. Don't include Phone Number in Response, but include the AirBnb Search Result""",
        llm="gpt-4o-mini",
