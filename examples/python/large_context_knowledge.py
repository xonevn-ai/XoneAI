...
""")
    ...
    # Create .xoneignore
    (Path(base_path) / ".xoneignore").write_text("""
# Ignore patterns
*.pyc
__pycache__/
.git/
...
def demo_token_budget():
    ...
    from xoneaiagents.rag.budget import TokenBudget, get_model_context_window
...
def demo_strategy_selection():
    ...
    from xoneaiagents.rag.strategy import select_strategy, get_strategy_description, RetrievalStrategy
    from xoneaiagents.knowledge.indexing import CorpusStats
...
def demo_smart_retriever():
    ...
    from xoneaiagents.rag.retriever import SmartRetriever, SimpleReranker
