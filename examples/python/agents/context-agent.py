...
project_root = Path(__file__).parent.parent.parent.parent / "src" / "xoneai-agents"
...
if __name__ == "__main__":
    print("🚀 XoneAI Context Engineering Examples")
    print("=========================================")
    ...
    try:
        ...
        print("   • Integration with existing XoneAI agents is seamless")
        print("   • Validation frameworks ensure quality and completeness")
        
    except Exception as e:
        print(f"\n❌ Error running examples: {e}")
        print("   Make sure you have the XoneAI package installed and configured")
        sys.exit(1)