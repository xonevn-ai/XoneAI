...
from xoneai.auto import AutoGenerator, WorkflowAutoGenerator
import os
import tempfile
...
xoneai workflow auto "Research and write a report" --pattern sequential
...
# With output file
xoneai workflow auto "Customer support routing" --pattern routing --output support.yaml
""")
...
print("=" * 60)
print("\nDocumentation: https://docs.xone.ai/features/autoagents")
print("CLI Reference: https://docs.xone.ai/nocode/auto")
