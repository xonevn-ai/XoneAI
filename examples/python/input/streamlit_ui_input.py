"""
Streamlit UI Input Example for XoneAI

This example demonstrates how to create a web-based UI for dynamic user input
using Streamlit, making it easy for users to interact with XoneAI agents.
...
st.set_page_config(
    page_title="XoneAI Dynamic Input",
    page_icon="🤖",
    layout="wide"
)

st.title("🤖 XoneAI Dynamic Input Interface")
st.markdown("---")
...
# Footer
st.markdown("---")
st.markdown("Built with ❤️ using XoneAI and Streamlit")