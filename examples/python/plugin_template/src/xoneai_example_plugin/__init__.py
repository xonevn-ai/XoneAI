"""XoneAI Example Plugin - Demonstrates how to create tool plugins.

This package shows how external developers can create pip-installable
tool plugins for XoneAI Agents.
...
Usage after installation:
    ...
    # Or import directly
    from xoneai_example_plugin import GreetTool, MathTool
    agent = Agent(tools=[GreetTool(), MathTool()])
"""

from typing import Dict, Any
from xoneaiagents import BaseTool, tool
