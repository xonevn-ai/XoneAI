# XoneAI Example Plugin

This is a template for creating tool plugins for XoneAI Agents.
...
pip install xoneai-example-plugin
```
...
from xoneai_example_plugin import GreetTool, MathTool, reverse_text
