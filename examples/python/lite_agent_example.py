#!/usr/bin/env python3
"""
Example: Using XoneAI Agents Lite Package
...
def example_openai_adapter():
    ...
    from xoneaiagents.lite import LiteAgent, create_openai_llm_fn
...
def example_anthropic_adapter():
    ...
    from xoneaiagents.lite import LiteAgent, create_anthropic_llm_fn
...
if __name__ == "__main__":
    print("=" * 60)
    print("XoneAI Agents Lite Examples")
    print("=" * 60)
