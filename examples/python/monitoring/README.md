# XoneAI Performance Monitoring Examples

This directory contains 10 comprehensive examples demonstrating how to integrate performance monitoring with XoneAI agents. Each example builds upon the basic pattern while showcasing different aspects of the monitoring system.
...
from xoneaiagents.telemetry import monitor_function, track_api_call
...
1. **Install XoneAI with performance monitoring support:**
   ```bash
...
- [XoneAI Documentation](https://docs.xoneai.com)
- [Performance Monitoring Guide](../../../src/xoneai-agents/xoneaiagents/telemetry/README.md)
- [API Reference](../../../src/xoneai-agents/xoneaiagents/telemetry/__init__.py)
...
**Note:** Performance monitoring is optional and can be disabled by setting `XONEAI_TELEMETRY_DISABLED=true` if needed.