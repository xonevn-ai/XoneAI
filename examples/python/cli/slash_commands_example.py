"""
Slash Commands Example for XoneAI CLI.

Demonstrates interactive slash commands like /help, /cost, /model.
Docs: https://docs.xone.ai/cli/slash-commands
"""

from xoneai.cli.features import SlashCommandHandler
from xoneai.cli.features.slash_commands import SlashCommand, CommandKind
