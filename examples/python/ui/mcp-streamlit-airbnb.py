...
if st.session_state.agent_initialized and st.session_state.agent:
    ...
    with st.expander("ℹ️ About this Application"):
        ...
        tools with XoneAI Agents in a Streamlit environment.
...
st.markdown(
    ...
    <div style='text-align: center; color: gray;'>
        Built with XoneAI Agents + MCP • 
        <a href='https://github.com/xonevn-ai/XoneAI' target='_blank'>GitHub</a> • 
        <a href='https://docs.xoneai.com' target='_blank'>Documentation</a>
    </div>
    """, 
