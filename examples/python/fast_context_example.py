...
def example_file_indexer():
    ...
    from xoneaiagents.context.fast.indexer import FileIndexer
...
def example_symbol_indexer():
    ...
    from xoneaiagents.context.fast.indexer import SymbolIndexer, SymbolType
...
def example_context_injector():
    ...
    from xoneaiagents.context.fast import FastContext
    from xoneaiagents.context.fast.context_injector import (
        ContextInjector,
        InjectionConfig
    )
