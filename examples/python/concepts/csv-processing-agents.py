...
from xoneaiagents.tools import read_csv, write_csv
...
def method_1_simple_loop():
    """
    The easiest way to process CSV files with XoneAI agents.
...
if __name__ == "__main__":
    print("CSV Processing with XoneAI Agents - Multiple Methods Demo")
    print("=" * 70)
    ...
    try:
        ...
        print("- xoneaiagents package installed (pip install xoneaiagents)")
