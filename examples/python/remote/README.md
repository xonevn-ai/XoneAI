...
This directory contains examples demonstrating XoneAI's remote agent connectivity feature, which allows you to connect to agents running on different servers, similar to Google ADK's agent connectivity pattern.
...
The remote connectivity feature integrates seamlessly with existing XoneAI code:
