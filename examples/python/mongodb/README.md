# MongoDB Integration Examples for XoneAI Agents

This directory contains comprehensive examples demonstrating how to integrate MongoDB with XoneAI agents for memory, knowledge, and data operations.

## Features

MongoDB integration with XoneAI provides:
...
```bash
# Install XoneAI with MongoDB support
pip install 'xoneaiagents[mongodb]'
```
...
- **Python 3.10+**: Required for XoneAI
...
Demonstrates using MongoDB as a memory provider for XoneAI agents.
...
These examples are provided under the same license as XoneAI.