...
from xoneai.cli.features.benchmark import BenchmarkHandler, BenchmarkReport
...
def run_agent_benchmark():
    """Benchmark XoneAI Agent specifically."""
    print("=" * 60)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="XoneAI Benchmark Example")
    parser.add_argument(
        "--mode",
