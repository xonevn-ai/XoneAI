#!/usr/bin/env python3
"""
Basic Doctor Example - Programmatic health checks for XoneAI
...
# Add the xoneai path for development
sys.path.insert(0, '/Users/xonevn/xoneai-package/src/xoneai')

from xoneai.cli.features.doctor import DoctorEngine
from xoneai.cli.features.doctor.models import DoctorConfig, CheckCategory
from xoneai.cli.features.doctor.registry import get_registry
from xoneai.cli.features.doctor.checks import register_all_checks
from xoneai.cli.features.doctor.formatters import get_formatter
...
if __name__ == "__main__":
    print("XoneAI Doctor - Programmatic Usage Examples\n")
