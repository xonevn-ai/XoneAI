...
Demonstrates using the xoneai endpoints CLI to interact with any XoneAI server.
...
def run_cli(args: list) -> tuple:
    """Run xoneai endpoints CLI command."""
    cmd = ["python3", "-m", "xoneai.cli.main", "endpoints"] + args
...
def main():
    print("=" * 60)
    print("XoneAI Unified Endpoints Client Example")
    print("=" * 60)
    ...
    if code == 0:
        ...
        print("  xoneai serve unified --port 8765")
        print("  xoneai serve agents --file agents.yaml --port 8765")
        print("  xoneai serve a2a --port 8765")
        return 1
    else:
