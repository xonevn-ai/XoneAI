...
def main():
    ...
    try:
        ...
        print("Error: xoneaiagents[mcp] not installed")
        print("Install with: pip install 'xoneaiagents[mcp]'")
    ...
    # Create MCP server
    server = ToolsMCPServer(name="xoneai-tools")
...
def run_manual_server():
    ...
    app = FastAPI(title="XoneAI Tools MCP Server")
