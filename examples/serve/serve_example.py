...
- Set XONEAI_API_KEY for authentication
...
def main():
    ...
    print("=" * 60)
    print("XoneAI Recipe Server Example")
    print("=" * 60)
    ...
    if not check_health():
        ...
        print(f"  export XONEAI_API_KEY={API_KEY}")
        print("  xoneai recipe serve --config serve.yaml")
        sys.exit(1)
