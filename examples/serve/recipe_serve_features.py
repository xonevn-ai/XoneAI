#!/usr/bin/env python3
"""
XoneAI Recipe Server Advanced Features Example
...
# Configuration
SERVER_URL = os.environ.get("XONEAI_ENDPOINTS_URL", "http://localhost:8765")
API_KEY = os.environ.get("XONEAI_API_KEY", "test-api-key")
...
# Reload Registry
from xoneai.recipe.core import reload_registry
reload_registry()
...
""")
    ...
    try:
        from xoneai.recipe.serve import create_rate_limiter, MetricsCollector, get_openapi_spec
        from xoneai.recipe.core import get_template_search_paths, reload_registry
...
def main():
    ...
    print("=" * 60)
    print("XoneAI Recipe Server Advanced Features")
    print("=" * 60)
