...
Usage:
    ...
    # Test with curl:
    curl http://localhost:8765/__xoneai__/discovery
...
def main():
    ...
    try:
        ...
        print("Install with: pip install xoneaiagents fastapi uvicorn")
        sys.exit(1)
    ...
    # Discovery endpoint
    @app.get("/__xoneai__/discovery")
    async def discovery():
        return {
            "schema_version": "1.0.0",
            "server_name": "xoneai-unified",
            "providers": [
    ...
    async def agent_card():
        return {
            "name": "XoneAI Unified",
            "description": "Unified XoneAI server with multiple agents",
    ...
    print("\nEndpoints:")
    print("  GET  /__xoneai__/discovery - Discovery document")
