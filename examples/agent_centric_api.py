...
Demonstrates the consolidated feature parameters for XoneAI Agents.
...
def example_url_parsing():
    ...
    agent = Agent(
        ...
        memory="postgresql://postgres:password@localhost:5432/xoneai",
    )
...
if __name__ == "__main__":
    print("=" * 60)
    print("XoneAI Agent-Centric API Examples")
    print("=" * 60)
