...
def main():
    print("=" * 60)
    print("XoneAI Performance Benchmark")
    print("=" * 60)
    ...
    from xoneai.cli.main import XoneAI as XoneAI2
    current, peak = tracemalloc.get_traced_memory()
    tracemalloc.stop()
    ...
    heavy_modules = ['litellm', 'instructor', 'xoneai.auto']
