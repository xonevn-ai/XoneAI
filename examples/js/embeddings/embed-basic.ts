...
import { Agent } from '../../../src/xoneai-ts/dist/agent/simple';
import { embed, embedMany, cosineSimilarity } from '../../../src/xoneai-ts/dist/llm/embeddings';
...
async function main() {
  ...
  const result = await embed('XoneAI is an AI agent framework');
