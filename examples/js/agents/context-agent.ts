...
import { ContextAgent, createContextAgent, KnowledgeBase } from 'xoneai';
...
async function main() {
  ...
  await kb.add({
    id: 'doc3',
    content: 'XoneAI is a framework for building AI agents in TypeScript and Python.',
    metadata: { topic: 'xoneai' }
  });
