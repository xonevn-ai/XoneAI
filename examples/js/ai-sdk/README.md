...
Examples demonstrating the AI SDK integration in XoneAI TypeScript.

## Prerequisites

```bash
npm install xoneai ai @ai-sdk/openai @ai-sdk/anthropic @ai-sdk/google zod
```
...
- [AI SDK Documentation](https://docs.xoneai.com/docs/js/ai-sdk)
- [AI SDK CLI](https://docs.xoneai.com/docs/js/ai-sdk-cli)
