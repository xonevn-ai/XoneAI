 ...
 * 
 * Prerequisites:
 *   npm install xoneai @tavily/ai-sdk
 *   export TAVILY_API_KEY=your-api-key
 *   export OPENAI_API_KEY=your-api-key
 */

// For local development, use relative imports
// For production, use: import { Agent, tavilySearch } from 'xoneai-ts'
import { Agent } from '../../../src/xoneai-ts/src';
import { tavilySearch, tavilyExtract, tavilyCrawl } from '../../../src/xoneai-ts/src/tools/builtins';
