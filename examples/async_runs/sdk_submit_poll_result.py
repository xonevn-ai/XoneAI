...
This example demonstrates how to use the XoneAI Jobs SDK to:
...
# Configuration
API_URL = os.getenv("XONEAI_BASE_URL", "http://127.0.0.1:8005")
...
def main():
    print("=" * 60)
    print("XoneAI Async Jobs SDK Example")
    print("=" * 60)
    ...
    try:
        ...
        print("  Start the server with: python -m uvicorn xoneai.jobs.server:create_app --port 8005 --factory")
        return
