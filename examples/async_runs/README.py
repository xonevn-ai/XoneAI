...
This directory contains examples for the XoneAI Async Jobs API.
...
2. Start the jobs server:
   ...
   cd /path/to/xoneai-package/src/xoneai
...
- XONEAI_BASE_URL: API server URL (default: http://127.0.0.1:8005)
"""
