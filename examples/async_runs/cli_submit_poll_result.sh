...
#
# This example demonstrates how to use the XoneAI CLI to:
...
API_URL="${XONEAI_BASE_URL:-http://127.0.0.1:8005}"

echo "============================================================"
echo "XoneAI Async Jobs CLI Example"
echo "============================================================"
...
if ! curl -s "$API_URL/health" > /dev/null 2>&1; then
    ...
    echo "  Start the server with: python -m uvicorn xoneai.jobs.server:create_app --port 8005 --factory"
    exit 1
fi
