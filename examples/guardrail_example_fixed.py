#!/usr/bin/env python3
"""
Fixed example demonstrating proper guardrail usage with XoneAI Agents.
This addresses the issues reported in issue #875.
"""

from xoneaiagents import Agent, Task, GuardrailResult, AgentTeam, TaskOutput
