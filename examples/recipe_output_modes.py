...
CLI Usage:
    xoneai recipe run my-recipe --output status
    xoneai recipe run my-recipe --output trace
    xoneai recipe run my-recipe -v  # alias for --output verbose
"""
...
if __name__ == "__main__":
    ...
    print("Create one with: xoneai recipe init my-recipe")
    print()
