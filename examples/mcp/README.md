...
xoneai mcp list-tools --limit 10
xoneai mcp list-tools --cursor <cursor> --json

# Search tools
xoneai mcp tools search "query"
xoneai mcp tools search --category memory
xoneai mcp tools search --read-only
xoneai mcp tools search --json

# Get tool info
xoneai mcp tools info <tool-name>
xoneai mcp tools info <tool-name> --json
...
```python
from xoneai.mcp_server.registry import MCPToolRegistry
...
```python
from xoneai.mcp_server.registry import MCPToolDefinition
