...
Environment variables:
    OPENAI_API_KEY or XONEAI_OPENAI_API_KEY - Required for agent example
    XONEAI_RUN_INTEGRATION - Set to "1" to run integration tests
"""
...
def run_example(name: str, script: str, requires_api_key: bool = False) -> bool:
    ...
    if requires_api_key:
        api_key = os.environ.get("OPENAI_API_KEY") or os.environ.get("XONEAI_OPENAI_API_KEY")
        run_integration = os.environ.get("XONEAI_RUN_INTEGRATION") == "1"
        ...
        if not run_integration:
            ...
            print("   Set XONEAI_RUN_INTEGRATION=1 to run")
            return True
...
def main():
    print("XoneAI Template Catalog - Example Runner")
    print("=" * 50)
