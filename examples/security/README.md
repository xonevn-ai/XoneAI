...
This example demonstrates XoneAI security features including SBOM generation, lockfile validation, dependency auditing, and PII redaction.
...
xoneai recipe sbom ./my-recipe --format cyclonedx -o sbom.json

# Generate SPDX SBOM
xoneai recipe sbom ./my-recipe --format spdx -o sbom.json
```
...
```bash
# Audit dependencies
xoneai recipe audit ./my-recipe

# Strict audit (fail on issues)
xoneai recipe audit ./my-recipe --strict
```
...
xoneai recipe validate ./my-recipe --require-lockfile
```
