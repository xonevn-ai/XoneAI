...
This directory contains examples for using XoneAI with the Agent Client Protocol (ACP).

## What is ACP?

The Agent Client Protocol (ACP) is a standardized JSON-RPC 2.0 protocol that allows code editors and IDEs to communicate with AI coding agents. It enables seamless integration between XoneAI and editors like:
...
# Allow file writes
xoneai acp --allow-write

# Use a specific model
xoneai acp -m gpt-4o

# Resume last session
xoneai acp --resume --last
```
