...
from xoneai.cli.features.compare import (
    CompareHandler,
    CompareResult,
    ModeResult,
    get_mode_config,
...
print("""
# Basic comparison
xoneai "What is AI?" --compare "basic,tools"

# Compare with specific model
xoneai "Explain quantum computing" --compare "basic,planning,research" --model gpt-4o

# Save results to file
xoneai "Latest tech news" --compare "basic,tools,web_search" --compare-output results.json

# Verbose output
xoneai "Write a poem" --compare "basic,planning" --verbose
""")
