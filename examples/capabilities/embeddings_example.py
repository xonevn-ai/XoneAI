...
Demonstrates text embedding generation using XoneAI capabilities.
Both `embed` and `embedding` work identically - use whichever you prefer.
"""

from xoneai import embed, embedding  # Both work from top-level
# Or: from xoneai.capabilities import embed, embedding
